...
namespace NewAge.Reports.Dinamicos
{
    public partial class Report_Pr_SolicitudRecibido : XtraReport
    {
        ...
        public string GenerateReport(int documentoID, int numeroDoc, bool isPreliminar, byte tipoReporte)
        {
            try
            {
                this.lblReportName.Text = documentoID == AppDocuments.Solicitud ? "Solicitud de Proveedores" : "Recibido de Proveedores";
                ...
                if (documentoID == AppDocuments.Solicitud)
                    ...
                    data = _moduloProveedores.ReportesProveedores_Recibidos(DateTime.Now, string.Empty, false, numeroDoc, false);
