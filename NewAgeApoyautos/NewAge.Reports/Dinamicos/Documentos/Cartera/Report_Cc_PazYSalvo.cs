...
{
    public partial class Report_Cc_PazYSalvo : XtraReport
    {
        ...
        public Report_Cc_PazYSalvo()
        {
          //  this.InitializeComponent();
        }

        public Report_Cc_PazYSalvo(DTO_glEmpresa emp)
        {
            this.InitializeComponent();
            this._empresa = emp;
        }
        ...
        public Report_Cc_PazYSalvo(string loggerConn, SqlConnection conn, SqlTransaction tx, DTO_glEmpresa emp, int userID, ExportFormatType formatType, int? numDoc = null)
        {
            InitializeComponent();
