...
{
    public partial class Report_Cc_CierreOferta : ReportBase
    {
        public Report_Cc_CierreOferta()
        {

        }

        public Report_Cc_CierreOferta(string loggerConn, SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, ExportFormatType formatType)
