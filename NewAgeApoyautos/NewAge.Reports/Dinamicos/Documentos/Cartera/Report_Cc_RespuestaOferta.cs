...
{
    public partial class Report_Cc_RespuestaOferta : ReportBase
    {
        public Report_Cc_RespuestaOferta()
        {

        }

        public Report_Cc_RespuestaOferta(string loggerConn, SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, ExportFormatType formatType)
