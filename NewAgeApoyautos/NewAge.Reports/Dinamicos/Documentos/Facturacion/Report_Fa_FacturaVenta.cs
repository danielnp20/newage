...
{
    public partial class Report_Fa_FacturaVenta : XtraReport
    {
        #region Variables
        ...
        public Report_Fa_FacturaVenta()
        {
        }

        public Report_Fa_FacturaVenta(DTO_glEmpresa emp)
        {
            this.InitializeComponent();
            this._empresa = emp;
        }

        public Report_Fa_FacturaVenta(string loggerConn, SqlConnection conn, SqlTransaction tx, DTO_glEmpresa emp, int userID, ExportFormatType formatType, int? numDoc = null)
        {
            InitializeComponent();
