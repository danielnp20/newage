...
{
    public partial class ReportBaseLandScape : XtraReport
    {
        #region Variables
        ...
        public ReportBaseLandScape()
        {

        }

        public ReportBaseLandScape(DTO_glEmpresa emp)
        {
        ...
        public ReportBaseLandScape(string loggerConn, SqlConnection conn, SqlTransaction tx, DTO_glEmpresa emp, int userID, ExportFormatType formatType, int? numDoc = null)
        {
            InitializeComponent();
