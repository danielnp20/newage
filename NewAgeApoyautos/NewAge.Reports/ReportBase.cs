...
namespace NewAge.Reports
{
    public partial class ReportBase : XtraReport
    {
        ...
        public ReportBase(DTO_glEmpresa emp)
        {
        ...
        public ReportBase(string loggerConn, SqlConnection conn, SqlTransaction tx, DTO_glEmpresa emp, int userID, ExportFormatType formatType, int? numDoc = null)
        {
            this.InitializeComponent();
