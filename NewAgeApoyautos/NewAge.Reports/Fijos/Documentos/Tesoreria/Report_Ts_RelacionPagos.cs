...
{
    public partial class Report_Ts_RelacionPagos : ReportBase
    {
        #region Variables

        private string _mes;
        #endregion
        public Report_Ts_RelacionPagos()
        {

        }

        public Report_Ts_RelacionPagos(string loggerConn, SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, ExportFormatType formatType)
            : base(loggerConn, c, tx, empresa, userId, formatType)
        {
            ...
            this.lbl_Nit.Text = this._moduloGlobal.GetResource(LanguageTypes.Forms, "35084_Nit:");
        ...
        public string GenerateReport(DateTime fechaIni, DateTime fechaFin, string bancoID, string nit, string numCheque)
        {
            ...
            //List<DTO_RelacionPagosTotales> data = _moduloTesoreria.Report_Ts_RelacionPagos(fechaIni, fechaFin, bancoID, nit, numCheque);
            //if (data.Count > 0)
            //{
