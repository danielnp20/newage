...
{
    public partial class Report_Ts_ChequesGiradosTercero : ReportBase
    {
        #region Variables

        private string _mes;
        #endregion
        public Report_Ts_ChequesGiradosTercero()
        {

        }

        public Report_Ts_ChequesGiradosTercero(string loggerConn, SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, ExportFormatType formatType)
