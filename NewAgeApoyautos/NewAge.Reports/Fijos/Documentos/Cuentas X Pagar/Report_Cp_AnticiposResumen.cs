...
{
    public partial class Report_Cp_AnticiposResumen : ReportBase
    {
        #region Variables

        private string _mes;
        #endregion
        public Report_Cp_AnticiposResumen()
        {

        }

        public Report_Cp_AnticiposResumen(string loggerConn, SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, ExportFormatType formatType)
            : base(loggerConn, c, tx, empresa, userId, formatType)
        {
            this.lblReportName.Text = this._moduloGlobal.GetResource(LanguageTypes.Forms, "35074_lbl_AnticiposD");
