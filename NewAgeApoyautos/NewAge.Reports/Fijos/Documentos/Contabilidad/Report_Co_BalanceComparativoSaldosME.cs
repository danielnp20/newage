...
{
    public partial class Report_Co_BalanceComparativoSaldosME : ReportBase
    {
        public Report_Co_BalanceComparativoSaldosME()
        {

        }

        public Report_Co_BalanceComparativoSaldosME(string loggerConn, SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, ExportFormatType formatType)
