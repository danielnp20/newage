...
{
    public partial class Report_Co_SaldoCuentaProyecto : ReportBase
    {
        public Report_Co_SaldoCuentaProyecto()
        {

        }

        public Report_Co_SaldoCuentaProyecto(string loggerConn, SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, ExportFormatType formatType)
