...
{
    public partial class Report_Co_BalanceComparativoMtvosML : ReportBase
    {
        public Report_Co_BalanceComparativoMtvosML()
        {

        }

        public Report_Co_BalanceComparativoMtvosML(string loggerConn, SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, ExportFormatType formatType)
