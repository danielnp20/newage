...
{
    public partial class Report_Co_Comprobante : ReportBaseLandScape
    {
        public Report_Co_Comprobante()
        {

        }

        public Report_Co_Comprobante(string loggerConn, SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, ExportFormatType formatType)
