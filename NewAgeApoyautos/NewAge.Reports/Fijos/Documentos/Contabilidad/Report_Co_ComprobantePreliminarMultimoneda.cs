...
{
    public partial class Report_Co_ComprobantePreliminarMultimoneda : ReportBase
    {
        public Report_Co_ComprobantePreliminarMultimoneda()
        {

        }

        public Report_Co_ComprobantePreliminarMultimoneda(string loggerConn, SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, ExportFormatType formatType)
        ...
        /// </summary>
        public DTO_TxResult GenerateReport(int año, int mes, string comprobanteID, string libro, string comprobanteInicial, string comprobanteFinal)
        {
            try
            {
