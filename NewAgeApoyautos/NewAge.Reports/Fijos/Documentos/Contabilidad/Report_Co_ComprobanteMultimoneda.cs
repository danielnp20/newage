...
{
    public partial class Report_Co_ComprobanteDetalleMultimoneda : ReportBaseLandScape
    {
        public Report_Co_ComprobanteDetalleMultimoneda()
        {

        }

        public Report_Co_ComprobanteDetalleMultimoneda(string loggerConn, SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, ExportFormatType formatType)
        ...
        public DTO_TxResult GenerateReport(int año, int mes, string comprobanteID, string libro, string comprobanteInicial, string comprobanteFinal, bool porHoja)
        {
            try
            {
                ...
                this.xrTableCell32.CanShrink = false;
