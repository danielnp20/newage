...
{
    public partial class Report_Co_InventariosBalanceSinSaldo : ReportBase
    {
        public Report_Co_InventariosBalanceSinSaldo()
        {

        }

        public Report_Co_InventariosBalanceSinSaldo(string loggerConn, SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, ExportFormatType formatType)
            : base(loggerConn, c, tx, empresa, userId, formatType)
        {
            ...
            this.xrLblTitle.Text = this._moduloGlobal.GetResource(LanguageTypes.Forms, "35003_InventarioBalance");
        ...
        public string GenerateReport(int mesIni, int mesFin, string Libro, string cuentaIni, string cuentaFin, int _año)
        {
            ...
            List<DTO_ContabilidadTotal> data = _moduloContabilidad.ReportesContabilidad_InventarioBalance(mesIni, mesFin, Libro, cuentaIni, cuentaFin, _año);
