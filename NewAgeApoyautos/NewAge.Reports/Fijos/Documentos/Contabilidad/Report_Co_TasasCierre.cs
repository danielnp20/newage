...
{
    public partial class Report_Co_TasasCierre : ReportBase
    {
        /// <summary>
        /// Contructor por defecto
        /// </summary>
        public Report_Co_TasasCierre()
        {
        ...
        public Report_Co_TasasCierre(string loggerConn, SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, ExportFormatType formatType)
            : base(loggerConn, c, tx, empresa, userId, formatType)
        {
            this.lblReportName.Text = this._moduloGlobal.GetResource(LanguageTypes.Forms, "35036_TasasCierre");
            this.lblAño.Text = this._moduloGlobal.GetResource(LanguageTypes.Forms, "35000_Año");
            this.lblDesde.Text = this._moduloGlobal.GetResource(LanguageTypes.Forms, "35000_Mes");
