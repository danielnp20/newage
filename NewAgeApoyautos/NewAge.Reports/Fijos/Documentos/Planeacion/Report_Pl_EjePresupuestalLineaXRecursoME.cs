...
{
    public partial class Report_Pl_EjePresupuestalLineaXRecursoME : ReportBaseLandScape
    {

        /// <summary>
        /// Constructor por Defecto
        /// </summary>
        public Report_Pl_EjePresupuestalLineaXRecursoME()
        {
            InitializeComponent();
        }
        ...
        public Report_Pl_EjePresupuestalLineaXRecursoME(string loggerConn, SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, ExportFormatType formatType)
