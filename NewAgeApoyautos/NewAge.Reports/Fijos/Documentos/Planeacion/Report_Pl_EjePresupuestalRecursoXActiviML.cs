...
{
    public partial class Report_Pl_EjePresupuestalRecursoXActiviML : ReportBaseLandScape
    {

        /// <summary>
        /// Constructor por Defecto
        /// </summary>
        public Report_Pl_EjePresupuestalRecursoXActiviML()
        {
            InitializeComponent();
        }
        ...
        public Report_Pl_EjePresupuestalRecursoXActiviML(string loggerConn, SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, ExportFormatType formatType)
