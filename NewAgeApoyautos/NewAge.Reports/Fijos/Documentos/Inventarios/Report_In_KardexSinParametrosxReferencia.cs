...
{
    public partial class Report_In_KardexSinParametrosxReferencia : ReportBase
    {
        public Report_In_KardexSinParametrosxReferencia()
        {

        }

        public Report_In_KardexSinParametrosxReferencia(string loggerConn, SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, ExportFormatType formatType)
