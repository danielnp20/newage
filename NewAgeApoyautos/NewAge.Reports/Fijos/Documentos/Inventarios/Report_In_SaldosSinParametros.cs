...
{
    public partial class Report_In_SaldosSinParametros : ReportBase
    {
        public Report_In_SaldosSinParametros()
        {

        }

        public Report_In_SaldosSinParametros(string loggerConn, SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, ExportFormatType formatType)
