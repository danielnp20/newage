...
{
    public partial class Report_Ac_Saldos : ReportBase
    {
         public Report_Ac_Saldos()
        {

        }

         public Report_Ac_Saldos(string loggerConn, SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, ExportFormatType formatType)
