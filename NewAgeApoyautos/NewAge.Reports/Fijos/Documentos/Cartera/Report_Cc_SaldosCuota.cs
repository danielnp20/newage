...
{
    public partial class Report_Cc_SaldosCuota : ReportBaseLandScape
    {
        #region Variables
        #endregion
        public Report_Cc_SaldosCuota()
        {

        }

        public Report_Cc_SaldosCuota(string loggerConn, SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, ExportFormatType formatType)
            : base(loggerConn, c, tx, empresa, userId, formatType)
        {
            this.lblReportName.Text = this._moduloGlobal.GetResource(LanguageTypes.Forms, AppReports.ccReportesCartera.ToString() + "_SaldosCuota");            
        }
