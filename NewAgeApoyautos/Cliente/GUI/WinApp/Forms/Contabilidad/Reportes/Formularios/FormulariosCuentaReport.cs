...
{
    class FormulariosCuentaReport : BaseReport //XtraReport//
    {
        #region Variables
        ...
        /// <summary>
        /// Formularios Report por Cuenta Constructor 
        /// </summary>
        ...
        public FormulariosCuentaReport(List<DTO_FormulariosCuenta> formCuentaData, ArrayList fieldList, int year, int period, bool preInd, string declarType)
        {
            ...
            reportTableBand.DataSource = formCuentaData;
            ...
            columnWidth = (tableWidth - 200) / fieldList.Count - 1;
            #endregion
            ...
            periodTable.Padding = new DevExpress.XtraPrinting.PaddingInfo(0, 10, 0, 0);
            ...
            periodTableCell_Period.Padding = new DevExpress.XtraPrinting.PaddingInfo(10, 0, 0, 0);
