...
namespace NewAge.Cliente.GUI.WinApp.Forms
{
    public class Reporte_Balance : ReportParametersForm
    {
        ...
        protected override void Report_PDF()
        {
            ...
            if (this._tipoReport.Equals("DePrueba") || this._tipoReport.Equals("EstResultados"))
            {
        ...
        protected override void Report_XLS()
        {
            try
            {
                ...
                this._Query = this._bc.AdministrationModel.ReportesContabilidad_ReporteBalancePruebasXLS(this.año, this.LongitudCuenta, this.SaldoInicial, this.CuentaInicial,
                                               this.CuentaFinal, this.libro, this._tipoReport, this.Moneda, this.mesIni, this.mesFin, this.Combo1, this.Combo2);
        ...
        protected override void LoadReportMethod_PDF()
        {
            ...
            try
            {
                ...
                {
                    case "DePrueba":
                        reportName = this._bc.AdministrationModel.ReportesContabilidad_ReportBalancePruebas(this.año, this.LongitudCuenta, this.SaldoInicial, this.CuentaInicial, this.CuentaFinal, this.libro, this._tipoReport, this.Moneda, this.mesIni, this.mesFin, this.Combo1, this.Combo2);
