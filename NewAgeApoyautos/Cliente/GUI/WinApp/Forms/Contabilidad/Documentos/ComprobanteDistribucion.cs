...
namespace NewAge.Cliente.GUI.WinApp.Forms
{
    ...
    /// </summary>
    public partial class ComprobanteDistribucion : FormWithToolbar
    {
        #region Variables
        ...
        private DTO_coCompDistribuyeTabla _currentOrigen;
        private DTO_coCompDistribuyeTabla _currentDestino;
        private DTO_coCompDistribuyeExcluye _currentExcluye;
        private List<DTO_coCompDistribuyeTabla> _data;
        private List<DTO_coCompDistribuyeTabla> _dataOrigen;
        private List<DTO_coCompDistribuyeTabla> _dataDestino;
        private List<DTO_coCompDistribuyeExcluye> _dataExcluye;
        private List<DTO_coCompDistribuyeExcluye> _dataExcluyeGrilla;
        ...
        public ComprobanteDistribucion()
        {
            InitializeComponent();

            this.documentID = AppDocuments.ComprobanteDistribucion;
        ...
        private void AddGridsCols()
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-ComprobanteDistribucion.cs", "AddGridCols"));
            }
        }
        ...
        {
            decimal total = 0;
            foreach (DTO_coCompDistribuyeTabla det in this._dataDestino)
        ...
        private void LoadData()
        {
            ...
            {
                //Trae los datos
                this._data = _bc.AdministrationModel.ComprobanteDistribucion_GetDistribucion();
                this._dataExcluye = _bc.AdministrationModel.ComprobanteDistribucion_GetExclusiones();

                #region Carga la info de las grillas

                //Trae la info del cabezote
                List<int> indices = this._data.Select(x => x.Consecutivo.Value.Value).Distinct().ToList();
                this._dataOrigen = new List<DTO_coCompDistribuyeTabla>();
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-ComprobanteDistribucion.cs", "LoadData"));
            }
        }
        ...
        private void LoadDataDestino()
        {
            if (this._currentOrigen != null)
            {
                ...
                {
                    MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-ComprobanteDistribucion.cs", "LoadDatadestino"));
                }
            }
        }
        ...
        private void LoadDataExcluye()
        {
            if (this._currentOrigen != null)
            {
                ...
                {
                    MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-ComprobanteDistribucion.cs", "LoadDataExcluye"));
                }
            }
        }
        ...
        {
            DTO_coCompDistribuyeTabla det = new DTO_coCompDistribuyeTabla();
        ...
        {
            DTO_coCompDistribuyeExcluye det = new DTO_coCompDistribuyeExcluye();
        ...
        private bool ValidateRowOrigen(bool fromOrigen)
        {
            ...
            try
            {
                ...
                if (fila >= 0 && fila < this.gvOrigen.DataRowCount)
                {
                    ...
                    if (validRow)
                    {
                        List<DTO_coCompDistribuyeTabla> temp = this._dataOrigen.Where(x =>
            ...
            {
                validRow = false;
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-ComprobanteDistribucion.cs", "ValidateRow"));
            }
        ...
        private bool ValidateRowDestino()
        {
            ...
            try
            {
                ...
                if (fila >= 0 && fila < this.gvDestino.DataRowCount)
                {
                    ...
                    if (validRow)
                    {
                        List<DTO_coCompDistribuyeTabla> temp = this._dataDestino.Where(x =>
        ...
        private bool ValidateRowExcluye()
        {
            ...
            try
            {
                ...
                if (fila >= 0 && fila < this.gvExcluye.DataRowCount)
                {
                    ...
                    if (validRow)
                    {
                        List<DTO_coCompDistribuyeExcluye> temp = this._dataExcluye.Where(x =>
        ...
        protected virtual void Form_Enter(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-ComprobanteDistribucion.cs", "Form_Enter"));
            }
        }
        ...
        protected virtual void Form_Leave(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-ComprobanteDistribucion.cs", "Form_Leave"));
            }
        }
        ...
        protected virtual void Form_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-ComprobanteDistribucion.cs", "Form_Closing"));
            }
        }
        ...
        protected virtual void Form_FormClosed(object sender, FormClosedEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-ComprobanteDistribucion.cs", "Form_FormClosed"));
            }
        }
        ...
        private void editBtnGrid_ButtonClick(object sender, ButtonPressedEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-ComprobanteDistribucion.cs", "editBtnGrid_ButtonClick"));
            }
        }
        ...
        private void gcOrigen_EmbeddedNavigator_ButtonClick(object sender, NavigatorButtonClickEventArgs e)
        {
            ...
            else
            {
                    ...
                    if (e.Button.ButtonType == DevExpress.XtraEditors.NavigatorButtonType.Remove)
                    {
                        ...
                        if (MessageBox.Show(msgDelete, msgTitleDelete, MessageBoxButtons.YesNo) == DialogResult.Yes)
                        {
                            ...
                            else
                            {
                                ...
                                this._dataDestino = new List<DTO_coCompDistribuyeTabla>();
                                this.gcDestino.DataSource = this._dataDestino;
                                this.gcDestino.RefreshDataSource();

                                //Carga la info de exclusiones
                                this._dataExcluye = new List<DTO_coCompDistribuyeExcluye>();
                ...
                {
                    MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-ComprobanteDistribucion.cs", "gcOrigen_EnbeddedNavigator_ButtonClick"));
                }
            }
        }
        ...
        private void gcDestino_EmbeddedNavigator_ButtonClick(object sender, NavigatorButtonClickEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-ComprobanteDistribucion.cs", "gcDestino_EnbeddedNavigator_ButtonClick"));
            }
        }
        ...
        private void gvDestino_CellValueChanged(object sender, CellValueChangedEventArgs e)
        {
            ...
            if (fieldName == "PorcentajeID")
            {
                ...
                if (validField)
                {
                    ...
                    decimal newVal = Convert.ToDecimal(colVal);
        ...
        private void gvDestino_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-ComprobanteDistribucion.cs", "gcDestino_FocusedRowChanged"));
            }
        }
        ...
        private void gcExcluye_EmbeddedNavigator_ButtonClick(object sender, NavigatorButtonClickEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-ComprobanteDistribucion.cs", "gcExcluye_EmbeddedNavigator_ButtonClick"));
            }
        }
        ...
        private void gvExcluye_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-ComprobanteDistribucion.cs", "gcExcluye_FocusedRowChanged"));
            }
        }
        ...
        public override void TBSave()
        {
            try
            {
                ...
                {
                    DTO_TxResult result = _bc.AdministrationModel.ComprobanteDistribucion_Update(this.documentID, this._data, this._dataExcluye);
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-ComprobanteDistribucion.cs", "TBSave"));
            }
        }
