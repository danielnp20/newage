            ...
            try
            {
                if (this.pasteRet.Success)
                {
                    ...
                    if (validList)
                    {
                        ...
                        this.result = _bc.AdministrationModel.RecaudosMasivos_Validar(this.documentID, this.periodo, this.centroPagoID, this.pagaduria.ID.Value,
        ...
        private void PagarThread()
        {
            try
            {
                ...
                this.result = _bc.AdministrationModel.RecaudosMasivos_Pagar(this.documentID, this._actFlujo.ID.Value, this.periodo, 
                    this.dtFecha.DateTime, this.dtFechaAplica.DateTime, this.valorPagaduria, this.centroPagoID, null, this.data);
