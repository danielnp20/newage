...
namespace NewAge.Cliente.GUI.WinApp.Forms
{
    ...
    public partial class ControlCartera : ControlForm 
    {
        ...
        protected override void SetInitParameters()
        {
            ...
            _bc.InitMasterUC(this.ctrl_093, AppMasters.coDocumento, false, true, true, false);
            _bc.InitMasterUC(this.ctrl_094, AppMasters.coDocumento, false, true, true, false);
            _bc.InitMasterUC(this.ctrl_100, AppMasters.cpConceptoCXP, false, true, true, false);           
            ...
            _bc.InitMasterUC(this.ctrl_524, AppMasters.coPlanCuenta, false, true, true, false);
            _bc.InitMasterUC(this.ctrl_525, AppMasters.coPlanCuenta, false, true, true, false);
            ...
            _bc.InitMasterUC(this.ctrl_530, AppMasters.coPlanCuenta, false, true, true, false);
            ...
            _bc.InitMasterUC(this.ctrl_108, AppMasters.coTercero, false, true, true, false);
            _bc.InitMasterUC(this.ctrl_400, AppMasters.faFacturaTipo, false, true, true, false);
            _bc.InitMasterUC(this.ctrl_401, AppMasters.faServicios, false, true, true, false);
            _bc.InitMasterUC(this.ctrl_402, AppMasters.glPrefijo, false, true, true, false);
            _bc.InitMasterUC(this.ctrl_410, AppMasters.faFacturaTipo, false, true, true, false);
            _bc.InitMasterUC(this.ctrl_411, AppMasters.faServicios, false, true, true, false);
            _bc.InitMasterUC(this.ctrl_412, AppMasters.glPrefijo, false, true, true, false);
            _bc.InitMasterUC(this.ctrl_420, AppMasters.faFacturaTipo, false, true, true, false);
            _bc.InitMasterUC(this.ctrl_421, AppMasters.faServicios, false, true, true, false);
            _bc.InitMasterUC(this.ctrl_422, AppMasters.glPrefijo, false, true, true, false);
