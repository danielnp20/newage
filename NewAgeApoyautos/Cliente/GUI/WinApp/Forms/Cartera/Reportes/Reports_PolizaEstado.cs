...
{
    public class Reports_PolizaEstado : ParametersCarteraForm
    {
        ...
        {
            this.documentReportID = AppReports.ccPolizaEstado;
            base.InitReport();
        }
        ...
        protected override void LoadReportMethod_PDF()
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp", "Reports_PolizaEstado.cs-LoadReportMethod"));
                throw;
            }
            finally
            {
