    ...
    public partial class QueryLibranza : FormWithToolbar
    {
        ...
        private void AddGridCols()
        {
            try
            {
                ...
                fechaConsigna.Caption = _bc.GetResource(LanguageTypes.Forms, this._documentID + "_FechaConsigna");
        ...
        private void GetValues(DTO_ccCreditoDocu credito)
        {
            try
            {
                ...
                this.masterGestionCobranza.Value = credito.CobranzaGestionID.Value;
