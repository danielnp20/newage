        ...
        public override void TBPrint()
        {
            try
            {
                if(this.cobrosJuridicosTemp.Count > 0)
                {
                    ...
                    string reportName = this._bc.AdministrationModel.Report_Cc_CobroJuridicoHistoria(this.documentID,cred.NumeroDoc.Value.Value,this.cmbClaseDeuda.EditValue == "1"? true: false);
