...
{
    public partial class DigitacionCreditoFinanciera : FormWithToolbar
    {
        #region Variables
        ...
        private DTO_ccPolizaEstado _poliza = null;
        ...
        private int _solicitudRenovacion = 0;
        ...
        /// </summary>
        public DigitacionCreditoFinanciera()
        {
        ...
        /// Constructor del Documento
        /// </summary>
        public DigitacionCreditoFinanciera(string mod)
        {
        ...
        /// Constructor del Documento
        /// </summary>
        public DigitacionCreditoFinanciera(int libranza, string mod)
        {
        ...
        /// Constructor del Documento
        /// </summary>
        public DigitacionCreditoFinanciera(int libranza, bool readOnly)
        {
            InitializeComponent();
            try
            {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DigitacionCreditoFinanciera.cs", "DigitacionCreditoFinanciera"));
            }
        }
        ...
        {
            this._documentID = AppDocuments.DigitacionCreditoFinanciera;
            this._frmModule = ModulesPrefix.cf;
            ...
            fil.OperadorFiltro = OperadorFiltro.Diferente;
            fil.ValorFiltro = "6";
        ...
        private void AddComponentesCols()
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DigitacionCreditoFinanciera.cs", "AddComponentesCols"));
            }
        }
        ...
        private void AddComprasCols()
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DigitacionCreditoFinanciera.cs", "AddComprasCols"));
            }
        }
        ...
        private void AddPlanPagosCols()
        {
            try
            {
                ...
                numCuota.Caption = _bc.GetResource(LanguageTypes.Forms, this._documentID + "_NumCuota");
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DigitacionCreditoFinanciera.cs", "AddCtasCols"));
            }
        }
        ...
        private void AddCuotasExtrasCols()
        {
            try
            {
                ...
                cuotaExtraID.Caption = _bc.GetResource(LanguageTypes.Forms, this._documentID + "_CuotaID");
                ...
                cuotaExtraValor.Caption = _bc.GetResource(LanguageTypes.Forms, this._documentID + "_ValorCuota");
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DigitacionCreditoFinanciera.cs", "AddCuotasExtrasCols"));
            }
        }
        ...
        private void EnableHeaderNuevo(bool enabled)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DigitacionCreditoFinanciera.cs", "EnableHeader"));
            }
        }
        ...
        private void CleanData(bool cleanObligaciones)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DigitacionCreditoFinanciera.cs", "CleanData"));
            }
        }
        ...
        private bool ValidateHeader()
        {
            try
            {
                ...
                //Valida que exista el pagaré
                if (this._tipoCredito != TipoCredito.PolizaSinCredito && this._sector == SectorCartera.Financiero)
                {
                ...
                if (this._tipoCredito == TipoCredito.PolizaRenueva || this._tipoCredito == TipoCredito.PolizaSinCredito)
                {
                    DTO_ccLineaCredito linea = (DTO_ccLineaCredito)_bc.GetMasterDTO(AppMasters.MasterType.Simple, AppMasters.ccLineaCredito, false, this.masterLineaCredito.Value, false);
                    if (linea.IndSinDesembolso.Value.HasValue && linea.IndSinDesembolso.Value.Value)
                    {
                        MessageBox.Show(_bc.GetResource(LanguageTypes.Messages, DictionaryMessages.Cf_LineaCredNoDesembolso));
                        return false;
                    }
                }
                //Valida el valor de Giro en la reestructuracion
                if (this._tipoCredito == TipoCredito.RestructuracionConCambio)
                {
                    if (Convert.ToDecimal(this.txtVlrGiro.EditValue) != 0)
                    {
                        MessageBox.Show("El valor de Giro debe ser igual a $0 cuando es una reestructuración con cambio de crédito");
                ...
                if (this._tipoCredito == TipoCredito.Nuevo || this._tipoCredito == TipoCredito.Refinanciado || this._tipoCredito == TipoCredito.RestructuracionConCambio || this._tipoCredito == TipoCredito.PolizaSinCredito)
                {
                    // Nuevo
                    ...
                    this._headerSolicitud.CompraCarteraInd.Value = this.chkCompraCartera.Checked;
                ...
                else if (this._tipoCredito == TipoCredito.PolizaRenueva)
                {
                    // Renovación póliza
                    ...
                    //Poliza
                    this._headerCredito.PlazoSeguro.Value = this.comboPlazoPol.Text == "" ? Convert.ToInt16(0) : Convert.ToInt16(this.comboPlazoPol.Text);
                    this._headerCredito.VlrPoliza.Value = Convert.ToDecimal(this.txtVlrPoliza.EditValue, CultureInfo.InvariantCulture);
                    this._headerCredito.FechaLiqSeguro.Value = this.dtPolizaIni.DateTime;
                    this._headerCredito.FechaVigenciaINI.Value = this.dtPagoPoliza.DateTime;
                    this._headerCredito.FechaVigenciaFIN.Value = this.dtPagoPoliza.DateTime.AddMonths(this._headerCredito.PlazoSeguro.Value.Value).AddDays(-1);
                    this._headerCredito.PorSeguro.Value = Convert.ToDecimal(this.txtInteresPoliza.EditValue, CultureInfo.InvariantCulture);
                    this._headerCredito.Cuota1Seguro.Value = Convert.ToInt16(this.txtCta1Pol.Text);
                    this._headerCredito.VlrCuotaSeguro.Value = Convert.ToDecimal(this.txtCtaPoliza.EditValue, CultureInfo.InvariantCulture);
                    this._headerCredito.VlrFinanciaSeguro.Value = Convert.ToDecimal(this.txtVlrSolicitadoPoliza.EditValue, CultureInfo.InvariantCulture);


                    #endregion
                    #region Carga los datos de la póliza

                    this._poliza.PlazoFinancia.Value = this._headerCredito.PlazoSeguro.Value;
                    this._poliza.TasaFinancia.Value = this._headerCredito.PorSeguro.Value;
                    this._poliza.VlrCuotaFinancia.Value = this._headerCredito.VlrCuotaSeguro.Value;
                    this._poliza.Cuota1Financia.Value = this._headerCredito.Cuota1Seguro.Value;
                    this._poliza.ValorFinancia.Value = this._headerCredito.VlrFinanciaSeguro.Value;
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DigitacionCreditoFinanciera.cs", "ValidateHeader"));
                return false;
            }
        ...
        private void SetValuesFromSolicitud()
        {
            try
            {
                ...
                this.dtFechaCredito.DateTime = this._ctrl.FechaDoc.Value.Value;

                #region Header
                this.masterCliente.Value = this._headerSolicitud.ClienteRadica.Value;
                this.txtPagare.Text = this._headerSolicitud.Pagare.Value.ToString();
                this.txtPagarePol.Text = this._headerSolicitud.PagarePOL.Value.ToString();
                this.chkExcluyeCompExtra.Checked = this._headerSolicitud.ComponenteExtraInd.Value.HasValue ? this._headerSolicitud.ComponenteExtraInd.Value.Value : true;
                this.masterPagaduria.Value = this._headerSolicitud.PagaduriaID.Value;
                this.masterCodeudor1.Value = this._headerSolicitud.Codeudor1.Value;
                this.masterCodeudor2.Value = this._headerSolicitud.Codeudor2.Value;
                this.masterCodeudor3.Value = this._headerSolicitud.Codeudor3.Value;
                this.masterAsesor.Value = this._headerSolicitud.AsesorID.Value;
                this.masterLineaCredito.Value = this._headerSolicitud.LineaCreditoID.Value;
                this.masterConcesionario.Value = this._headerSolicitud.ConcesionarioID.Value;
                this.txtPlazo.Text = this._headerSolicitud.Plazo.Value.ToString();
                this.txtVlrSolicitado.EditValue = this._headerSolicitud.VlrSolicitado.Value;
                this.txtPorCredito.EditValue = this._headerSolicitud.PorInteres.Value;
                this.chkDto1Cuota.Checked = this._headerSolicitud.DtoPrimeraCuotaInd.Value.HasValue ? this._headerSolicitud.DtoPrimeraCuotaInd.Value.Value : false;
                this.txtVlrDto1Cuota.EditValue = this._headerSolicitud.ValorDtoPrimeraCuota.Value.HasValue ? this._headerSolicitud.ValorDtoPrimeraCuota.Value : 0;

                if (this._sector == SectorCartera.Solidario)
                {
                    #region Trae el porcentaje del interes para asignarlo
                    ...
                    if (comps.Exists(x => x.ID.Value == compInteres))
                    {
                        DTO_ccCarteraComponente dtoInteres = comps.Find(x => x.ID.Value == compInteres);
                        decimal porInteres = 0;
                        #region Trae el porcentaje (tasa) y valor del componente
                        switch (dtoInteres.FuenteLiquida.Value)
                        {
                            case (byte)FuenteLiquida.Componente:
                                #region Trae el porcentaje del Componente directo
                                if (dtoInteres.PorcentajeID.Value != null)
                                    porInteres = dtoInteres.PorcentajeID.Value.Value;
                                //else 
                                //result.Result = ResultValue.NOK;
                                #endregion
                                break;
                            case (byte)FuenteLiquida.LineaCredito:
                                #region  Trae el porcentaje de ccLineaComponente
                                Dictionary<string, string> pks = new Dictionary<string, string>();
                                pks.Add("LineaCreditoID", this._headerSolicitud.LineaCreditoID.Value);
                                pks.Add("ComponenteCarteraID", compInteres);
                                DTO_ccLineaComponente lineaCred = (DTO_ccLineaComponente)this._bc.GetMasterComplexDTO(AppMasters.ccLineaComponente, pks, true);
                                if (lineaCred != null)
                                {
                                    if (lineaCred.PorcentajeID.Value != null)
                                        porInteres = lineaCred.PorcentajeID.Value.Value;
                                    //else
                                    //result.Result = ResultValue.NOK;
                                }
                                #endregion
                                break;
                            case (byte)FuenteLiquida.Monto:
                                #region Valida que el componente tenga un porcentaje asignado
                                //pks = new Dictionary<string, string>();
                                //pks.Add("LineaCreditoID", this._headerSolicitud.LineaCreditoID.Value);
                                //pks.Add("ComponenteCarteraID", compInteres);
                                //DTO_ccLineaComponenteMonto monto = (DTO_ccLineaComponenteMonto)this._bc.GetMasterComplexDTO(AppMasters.ccLineaComponenteMonto, pks, true);
                                //var monto = this._bc.AdministrationModel.GetByMonto(lineaCredID, componente.ID.Value, vlrSolicitado);
                                ...
                                break;
                            case (byte)FuenteLiquida.MontoPlazo:
                                #region Valida que el componente tenga un porcentaje asignado
                                ...
                                #endregion     
                                break;
                            case (byte)FuenteLiquida.ComponenteEdad:
                                #region Valida que el componente tenga un porcentaje asignado
                        ...
                        this.txtPorCredito.EditValue = porInteres;
                        this._headerSolicitud.PorInteres.Value = porInteres;
                        this._headerSolicitud.DtoPrimeraCuotaInd.Value = this.chkDto1Cuota.Checked;
                        this._headerSolicitud.ValorDtoPrimeraCuota.Value = Convert.ToDecimal(this.txtVlrDto1Cuota.EditValue, CultureInfo.InvariantCulture);
                        #endregion
                    }
                    ...
                    if (comps.Exists(x => x.TipoLiquida.Value == (byte)TipoLiquidacionCartera.AjustaVlrNominal))
                    {
                        ...
                        decimal vlrCuotaIni = this._headerSolicitud.VlrSolicitado.Value.Value * (factor / 100);//Calcular el valor de la Cuota
                        decimal vlCuotaFin = (Math.Round(vlrCuotaIni / 50, 0) * 50); // Redondea el valor de la cuota a multiplos de 50
                        decimal vlrTotal1 = vlCuotaFin * this._headerSolicitud.Plazo.Value.Value; // Calcular el nuevo valor solicitado

                        //decimal vlrTotal2 = (Math.Round(this._headerSolicitud.VlrSolicitado.Value.Value / this._headerSolicitud.Plazo.Value.Value / 500, 0) * 500) * this._headerSolicitud.Plazo.Value.Value;// Calcula el valor solicitado a multiplos de 500
                        #region Calcular VlrTotal2
                        decimal vlrTotalByCuota = (Math.Round(Convert.ToDecimal(this.txtVlrSolicitado.EditValue, CultureInfo.InvariantCulture) / Convert.ToInt32(this.txtPlazo.Text) / 500, 0) * 500);// Calcula el valor solicitado a multiplos de 500
                        decimal vlr1 = Convert.ToDecimal(this.txtVlrSolicitado.EditValue, CultureInfo.InvariantCulture) / Convert.ToInt32(this.txtPlazo.Text);
                        decimal vlr2 = ((int)vlr1 / 1000) * 1000;
                        decimal residuo = Math.Abs(vlr1 - vlr2);
                        vlrTotalByCuota = residuo == 250 || residuo == 750 ? vlrTotalByCuota + 500 : vlrTotalByCuota;
                        decimal vlrTotal2 = vlrTotalByCuota * Convert.ToInt32(this.txtPlazo.Text);
                        #endregion

                        decimal vrlFuturo = vlrTotal1 + vlrTotal2;//suma los 2 valores
                        this.txtVlrFuturo.EditValue = vrlFuturo;//Nuevo valor futuro
                    }
                }
                ...
                #endregion
                #region Fecha Cuota 1
                if (this._headerSolicitud.FechaCuota1.Value != null)
                    this.dtFechaCta1.DateTime = this._headerSolicitud.FechaCuota1.Value.Value;
                else
                {
                    if (this._sector == SectorCartera.Financiero)
                ...
                else
                {
                    ...
                    this.txtVlrSolicitadoPoliza.EditValue = this.txtVlrPoliza.EditValue;

                    if (this._headerSolicitud.VlrPoliza.Value != null && this._headerSolicitud.VlrPoliza.Value.HasValue && this._headerSolicitud.VlrPoliza.Value.Value != 0)
                    {
                        this._plazoPoliza = this._headerSolicitud.PlazoSeguro.Value.ToString();
                        this.comboPlazoPol.Text = this._plazoPoliza;
                        this.txtCta1Pol.Text = this._headerSolicitud.Cuota1Seguro.Value.ToString();
                        this.dtPagoPoliza.DateTime = this._headerSolicitud.FechaVigenciaINI.Value.Value;
                        this.txtVlrSolicitadoPoliza.EditValue = this._headerSolicitud.VlrFinanciaSeguro.Value;
                        this.txtInteresPoliza.EditValue = this._headerSolicitud.PorSeguro.Value;
                    }
                    else
                    {
                        DateTime fCuota1 = this._ctrl.FechaDoc != null && this._ctrl.FechaDoc.Value.HasValue ? this._ctrl.FechaDoc.Value.Value : DateTime.Now;

                        this.dtPagoPoliza.DateTime = fCuota1;
                    ...
                    if (!this._poliza.FinanciadaIND.Value.Value)
                    {
                        this.comboPlazoPol.Enabled = false;
                        this.txtInteresPoliza.Enabled = false;

                        this.comboPlazoPol.Text = "1";
                        this.txtInteresPoliza.EditValue = 0.0;
                    ...
                    {
                        this.comboPlazoPol.Enabled = true;
                        this.txtInteresPoliza.Enabled = true;
                        this.txtVlrSolicitadoPoliza.Enabled = true;
                        this.txtVlrSolicitadoPoliza.EditValue = this.txtVlrPoliza.EditValue;
                    }
                }
                ...
                this.chkCompraCartera.Checked = this._headerSolicitud.CompraCarteraInd.Value.Value;
                #endregion
            }
            catch (Exception ex)
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DigitacionCredito.cs", "GetValuesSolicitud"));
        ...
        /// Funcion que carga los valores previamente guardados
        /// </summary>
        private void SetValuesForRenovacionPoliza()
        {
            try
            {
                #region Header
                ...
                this.txtVlrSolicitado.EditValue = this._headerCredito.VlrSolicitado.Value;
                ...
                this.txtVlrAdicional.EditValue = this._headerCredito.VlrAdicional.Value.Value;
                this.txtVlrCompra.EditValue = this._headerCredito.VlrCompra.Value.Value;
                this.txtVlrGiro.EditValue = this._headerCredito.VlrGiro.Value.Value;
                this.txtVlrPrestamo.EditValue = this._headerCredito.VlrPrestamo.Value.Value;
                this.txtVlrDescuento.EditValue = this._headerCredito.VlrDescuento.Value.Value;
                ...
                this.chkCompraCartera.Checked = this._headerCredito.CompraCarteraInd.Value.Value;
                ...
                else
                {
                    ...
                    this.txtVlrCuotaPol.EditValue = 0;
                    this.txtInteresPoliza.EditValue = 0.0;
                    this.txtCta1Pol.Text = this._credito.PlanPagos.FirstOrDefault(p => p.VlrSeguro.Value == 0 && p.FechaCuota.Value > this.dtFechaCredito.DateTime).CuotaID.Value.ToString();
        ...
        /// Funcion que carga los valores previamente guardados
        /// </summary>
        private void SetValuesForNuevaPoliza()
        {
            try
            {
                //Trae la fecha del documento
                ...
                if (this._headerSolicitud.FechaCuota1.Value != null)
                    ...
                    this.dtFechaCta1.DateTime = this._poliza.FechaVigenciaINI.Value.Value;
                #endregion
                #region Poliza
                ...
                if (this._headerSolicitud.VlrPoliza.Value != null && this._headerSolicitud.VlrPoliza.Value.HasValue && this._headerSolicitud.VlrPoliza.Value.Value != 0)
                {
                    ...
                    this._plazo = this.comboPlazoPol.Text;
                    this.txtPlazo.Text = this.comboPlazoPol.Text;
                ...
                else
                {
                    ...
                    this.dtPagoPoliza.DateTime = fCuota1;
                    this.txtVlrSolicitadoPoliza.EditValue = this._poliza.FinanciadaIND.Value.Value ? 0 : this.txtVlrPoliza.EditValue;
                    this.txtVlrCuotaPol.EditValue = 0;
                    this.txtInteresPoliza.EditValue = 0.0;
                    this.txtCta1Pol.Text = "1";
                    this.comboPlazoPol.Text = "12";
        ...
        private void AddNewRow_Compra()
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DigitacionCreditoFinanciera.cs", "AddNewRow"));
            }
        }
        ...
        private void CalcularGiro()
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DigitacionCreditoFinanciera.cs", "CalcularGiro"));
            }
        ...
        private void ValidateRow_CompraCartera(int fila)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DigitacionCreditoFinanciera.cs", "ValidateRow_CompraCartera"));
            }
        }
        ...
        private void ValidateCalcularLiquidacion()
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DigitacionCreditoFinanciera.cs", "ValidateGetLiquidacion"));
            }
        }
        ...
        private object CalcularPlanPagosNoFinanciado()
        {
            ...
            catch (Exception ex)
            {
                ...
                result.Result = ResultValue.NOK;
                result.ResultMessage = _bc.GetResourceForException(ex, "WinApp-DigitacionCreditoFinanciera.cs", "CalcularPlanPagosNoFinanciado");
        ...
        protected virtual void Form_Enter(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DigitacionCreditoFinanciera.cs", "Form_Enter"));
            }
        }
        ...
        protected virtual void Form_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DigitacionCreditoFinanciera.cs", "Form_Closing"));
            }
        }
        ...
        protected virtual void Form_FormClosed(object sender, FormClosedEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DigitacionCreditoFinanciera.cs", "Form_FormClosed"));
            }
        }
            ...
            try
            {
                if (this._tipoCreditoID != this.masterTipoCredito.Value)
                {
                    ...
                    if (this.masterTipoCredito.ValidID)
                    {
                        ...
                        {
                            this.chkCompraCartera.Enabled = true;
                            this.liquidaAll = true;
                        }
                        else if (this._tipoCredito == TipoCredito.Refinanciado || this._tipoCredito == TipoCredito.RestructuracionConCambio)
                        {
                            this.chkCompraCartera.Checked = true;
                            this.chkCompraCartera.Enabled = false;
                        }
                        else if (this._tipoCredito == TipoCredito.PolizaRenueva || this._tipoCredito == TipoCredito.PolizaSinCredito)
                        {
                            this.chkCompraCartera.Enabled = false;
                            this.liquidaAll = false;
                        }
                    }
                    else
                    {
                ...
                if (this._clienteID != this.masterCliente.Value)
                {
                    ...
                    if (this.masterCliente.ValidID)
                    {
                        ...
                        else if (this._tipoCredito == TipoCredito.PolizaRenueva)
                        {
                            ...
                            List<DTO_ccCreditoDocu> creditos = this._bc.AdministrationModel.GetCreditosForRenovacionPoliza(this._clienteID);
                        ...
                        else if (this._tipoCredito == TipoCredito.PolizaSinCredito)
                        {
                            //Nuevos polizas
                            List<DTO_ccSolicitudDocu> solicitudes = this._bc.AdministrationModel.GetSolicitudesByCliente(this._clienteID);
                            solicitudes = solicitudes.Where(s => s.Estado.Value == (byte)EstadoDocControl.SinAprobar || s.Estado.Value == (byte)EstadoDocControl.ParaAprobacion).ToList();
        ...
        private void lkpObligaciones_EditValueChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                if (this.lkpObligaciones.EditValue != null && !String.IsNullOrWhiteSpace(this.lkpObligaciones.EditValue.ToString()) && currentLib != 0)
                {
                    ...
                    {
                        //Nuevo / Refinanciado
                        #region Trae la informacion de la solicitud
                        ...
                        if (digCredito.DocCtrl != null)
                        {
                            ...
                            if (this._ctrl.Estado.Value.Value == (int)EstadoDocControl.ParaAprobacion || this._ctrl.Estado.Value.Value == (int)EstadoDocControl.SinAprobar)
                            {
                                #region Valida la información de la póliza

                                if (digCredito.Poliza != null)
                                {
                                    //Valida el tipo de póliza
                                    if (digCredito.Poliza.EstadoPoliza.Value.Value == (byte)EstadoPoliza.Renovada
                                        || digCredito.Poliza.EstadoPoliza.Value.Value == (byte)EstadoPoliza.NuevaSinCredito)
                                    {
                                        MessageBox.Show(_bc.GetResource(LanguageTypes.Messages, DictionaryMessages.Cf_InvalidPolizaCombinacion));
                                        return;
                                    }
                                }
                                ...
                                this._headerSolicitud = digCredito.Header;
                                this._poliza = digCredito.Poliza;
                                ...
                                if (this._sector == SectorCartera.Financiero)
                                {
                                    if (tipoDTO != null && tipoDTO.AbonaCapitalInd.Value.Value)
                                        this._compCartera = digCredito.CompraCartera.FindAll(x => x.EC_Proposito.Value == (byte)PropositoEstadoCuenta.RestructuracionAbono);
                                    else
                                        this._compCartera = digCredito.CompraCartera.FindAll(x => x.EC_Proposito.Value == (byte)PropositoEstadoCuenta.RecogeSaldo || x.EC_Proposito.Value == (byte)PropositoEstadoCuenta.RestructuracionPlazo);
                                }
                                else
                                    this._compCartera = digCredito.CompraCartera;


                                //Carga los valores y la póliza
                    ...
                    else if (this._tipoCredito == TipoCredito.PolizaRenueva)
                    {
                        ...
                        {
                            #region Valida los créditos pendientes

                            List<DTO_ccCreditoPlanPagos> cPendientes = this._credito.PlanPagos.Where(x => x.VlrPagadoCuota.Value == 0 && x.VlrSeguro.Value.Value == 0).ToList();
                            if (cPendientes.Count == 0)
                            {
                                this._libranzaValidID = 0;
                                string msg = _bc.GetResource(LanguageTypes.Messages, DictionaryMessages.Cc_RenovacionPolizaNoDisponible);
                                MessageBox.Show(msg);
                            ...
                            this._poliza = _bc.AdministrationModel.PolizaEstado_GetLastPoliza(this._headerCredito.NumeroDoc.Value.Value, this._headerCredito.Libranza.Value.Value);
                            if (this._poliza != null)
                            {
                                //Valida el tipo de póliza
                                if (this._poliza.EstadoPoliza.Value.Value == (byte)EstadoPoliza.NuevaConCredito
                                    || this._poliza.EstadoPoliza.Value.Value == (byte)EstadoPoliza.NuevaSinCredito)
                                {
                                    MessageBox.Show(_bc.GetResource(LanguageTypes.Messages, DictionaryMessages.Cf_InvalidPolizaCombinacion));
                                    return;
                                }
                            ...
                            //Carga los valores enel formulario
                            this._planPagos = this._credito.Cuotas;

                            this.gcComponentes.DataSource = this._credito.Componentes.Where(x => !x.CompInvisibleInd.Value.Value);
                            this.gcCompra.DataSource = this._credito.CompraCartera;
                            this.gcPlanPagos.DataSource = this._planPagos;
                            this.gcCuotasExtras.DataSource = this._cuotasExtras;
                            ...
                            this.SetValuesForRenovacionPoliza();
                    ...
                    else if (this._tipoCredito == TipoCredito.PolizaSinCredito)
                    {
                        ...
                        if (digCredito.DocCtrl != null)
                        {
                            ...
                            {
                                //Valida el tipo de póliza
                                if (digCredito.Poliza.EstadoPoliza.Value.Value != (byte)EstadoPoliza.NuevaSinCredito)
                                {
                                    this.masterCliente.Value = digCredito.Header.ClienteID.Value;
                                    MessageBox.Show(_bc.GetResource(LanguageTypes.Messages, DictionaryMessages.Cf_InvalidPolizaCombinacion));
                                    return;
                                }
                            }
                            ...
                            {
                                this.masterCliente.Value = digCredito.Header.ClienteID.Value;
                                MessageBox.Show(_bc.GetResource(LanguageTypes.Messages, DictionaryMessages.Cf_InvalidRegistroCombinacion));
                                return;
                            }
                            ...
                            this.masterConcesionario.EnableControl(true);
                            this._libranzaValidID = this._libranzaID;
                            this._headerSolicitud = digCredito.Header;
                            this._poliza = digCredito.Poliza;

                            //Carga los valores y la póliza
                            this.SetValuesForNuevaPoliza();
                    ...
                    {
                        #region Trae los saldos actuales del deudor y codeudores 
                        List<string> cedulas = new List<string>();
                        cedulas.Add(this._headerSolicitud.ClienteRadica.Value);
                        cedulas.Add(this._headerSolicitud.Codeudor1.Value);
                        cedulas.Add(this._headerSolicitud.Codeudor2.Value);
                        cedulas.Add(this._headerSolicitud.Codeudor3.Value);
                        foreach (string cedula in cedulas)
                        {
                            if (!string.IsNullOrEmpty(cedula))
                            {
                                decimal saldoPersona = 0;
                                //Trae creditos por deudor
                                List<DTO_ccCreditoDocu> creditos = this._bc.AdministrationModel.GetCreditosPendientesByCliente(cedula);
                                //Trae creditos por codeudor
                                creditos.AddRange(this._bc.AdministrationModel.GetCreditosByCodeudor(cedula));
                                //Obtiene el saldo total de creditos por cedula
                                foreach (DTO_ccCreditoDocu cred in creditos)
                                {
                                    DTO_InfoCredito saldo = this._bc.AdministrationModel.GetSaldoCredito(cred.NumeroDoc.Value.Value, DateTime.Now, false, false, false);
                                    if (saldo != null)
                                        saldoPersona += saldo.PlanPagos.Sum(y => y.VlrSaldo.Value.Value);
                                }
                                //Asigna valores segun el tipo de cedula
                                bool enableControl = saldoPersona == 0 ? false : true;
                                if (cedula.Equals(this._headerSolicitud.ClienteRadica.Value))
                                {
                                    this.txtSaldoDeudor.EditValue = saldoPersona;
                                    this.txtSaldoDeudor.Enabled = enableControl;
                                }
                                else if (cedula.Equals(this._headerSolicitud.Codeudor1.Value))
                                {
                                    this.txtSaldoCod1.EditValue = saldoPersona;
                                    this.txtSaldoCod1.Enabled = enableControl;
                                }
                                else if (cedula.Equals(this._headerSolicitud.Codeudor2.Value))
                                {
                                    this.txtSaldoCod2.EditValue = saldoPersona;
                                    this.txtSaldoCod2.Enabled = enableControl;
                                }
                                else if (cedula.Equals(this._headerSolicitud.Codeudor3.Value))
                                {
                                    this.txtSaldoCod3.EditValue = saldoPersona;
                                    this.txtSaldoCod3.Enabled = enableControl;
                                }
                            }
                        }
                        #endregion
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DigitacionCreditoFinanciera.cs", "lkpSolicitudes_EditValueChanged"));
            }
        }
        ...
        private void txtVlrSolicitado_Leave(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DigitacionCreditoFinanciera.cs", "txtVlrSolicitado_Leave"));
            }
        }
        ...
        private void chkCompraCartera_CheckedChanged(object sender, EventArgs e)
        {
            try
            {
                if (this._chkCompraCartera != this.chkCompraCartera.Checked)
                {
                    ...
                    {
                        //this.txtVlrGiro.EditValue = this.txtVlrSolicitado.EditValue;
                        if (this._compCartera.Count > 0)
                        {
                            ...
                            if (this._compCartera[0].EC_Proposito.Value.HasValue && this._compCartera[0].EC_Proposito.Value.Value == (byte)PropositoEstadoCuenta.RestructuracionAbono)
                            {
                                //DTO_coCuentaSaldo saldoFilter = new DTO_coCuentaSaldo();
                                //saldoFilter.PeriodoID.Value = this.periodo;
                                //saldoFilter.BalanceTipoID.Value = "01";
                                //saldoFilter.CuentaID.Value = cuentaAntic;
                                //saldoFilter.TerceroID.Value = this._cliente.TerceroID.Value;
                                //saldoFilter.IdentificadorTR.Value = this._cliente.TerceroID.Value;
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DigitacionCreditoFinanciera.cs", "chkCompraCartera_CheckedChanged"));
            }
        }
        ...
        private void btn_Liquidar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (this.liquidaInd)
                {
                    ...
                    if (this._tipoCredito == TipoCredito.PolizaRenueva)
                    {
                        int cuotaPol1 = Convert.ToInt32(this.txtCta1Pol.Text);
                        fechaCuota1 = this._credito.PlanPagos.FirstOrDefault(p => p.CuotaID.Value == cuotaPol1).FechaCuota.Value.Value;
                    }
                    #endregion

                    object res = null;
                    if (this._tipoCredito == TipoCredito.PolizaSinCredito && !this._poliza.FinanciadaIND.Value.Value)
                    {
                        res = this.CalcularPlanPagosNoFinanciado();
                    }
                    else
                    {
                        res = this._bc.AdministrationModel.GenerarPlanPagosFinanciera(this._lineaCreditoID, this.vlrSolicitadoPrestamo, this.vlrSolicitadoPoliza,
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DigitacionCreditoFinanciera.cs", "btn_Liquidar_Click"));
            }
        }
        ...
        /// <summary>
        /// Evento al cambiar la primera cuota de la póliza
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void txtCta1Pol_Leave(object sender, EventArgs e)
        {
            try
            {
                if (string.IsNullOrWhiteSpace(this.txtCta1Pol.Text) || this.txtCta1Pol.Text.StartsWith("-"))
                {
                    this.txtCta1Pol.Text = "1";
                }

                int plazo = !string.IsNullOrEmpty(this.txtPlazo.Text) ? Convert.ToInt32(this.txtPlazo.Text) : 0;
                int cta1Pol = !string.IsNullOrEmpty(this.txtCta1Pol.Text) ? Convert.ToInt32(this.txtCta1Pol.Text) : 0;
                int plazoPol = !string.IsNullOrEmpty(this.comboPlazoPol.Text) ? Convert.ToInt32(this.comboPlazoPol.Text) : 0;

                //Cuota superior a la permitida
                if (cta1Pol + plazoPol - 1 > plazo)
                {
                    this.txtCta1Pol.Text = (plazo - plazoPol).ToString();
                }

                //Cuota inferior a la permitida
                int primeraCuota = 1;
                if (this._credito != null && this._credito.PlanPagos != null && this._credito.PlanPagos.Count > 0)
                {
                    primeraCuota = this._credito.PlanPagos.FirstOrDefault(p => p.VlrSeguro.Value == 0 && p.FechaCuota.Value > this.dtFechaCredito.DateTime).CuotaID.Value.Value;
                    if (cta1Pol < primeraCuota)
                    {
                        this.txtCta1Pol.Text = primeraCuota.ToString();
                    }
                }
            }
            catch (Exception ex)
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DigitacionCreditoFinanciera.cs", "txtCta1Pol_Leave"));
            }
        }

        /// <summary>
        /// Event que se ejecuta al salir de plazo de la poliza
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void comboPlazoPol_Leave(object sender, EventArgs e)
        {
            try
            {
                if (this._tipoCredito == TipoCredito.PolizaSinCredito)
                {
                    this.txtPlazo.Text = this.comboPlazoPol.Text;
                    this._plazoPoliza = this.txtPlazo.Text;
                    this._plazo = this.txtPlazo.Text;
                }
            }
            catch (Exception ex)
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DigitacionCreditoFinanciera.cs", "comboPlazoPol_Leave"));
            }
        }
        ...
        private void txtVlrFuturo_Leave(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DigitacionCreditoFinanciera.cs", "txtVlrFuturo_Leave"));
            }
        }
        ...
        private void chkDto1Cuota_CheckedChanged(object sender, EventArgs e)
        {
            if (this.chkDto1Cuota.Checked && this._liquidador != null)
            {
                ...
                this.txtVlrDescuento.EditValue = this._liquidador.VlrDescuento;
                this.CalcularGiro();
                //this._liquidador.VlrGiro -= this._liquidador.VlrCuota;
                //this.txtVlrGiro.EditValue = this._liquidador.VlrGiro;
            }
            else
            {
        ...
        /// <summary>
        /// Permite ver los saldos de la cedula
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void txtSaldoDeudor_ButtonClick(object sender, ButtonPressedEventArgs e)
        {
            try
            {
                Dictionary<string, object> filter = new Dictionary<string, object>();
                ButtonEdit btn = (ButtonEdit)sender;
                if (btn.Name == "txtSaldoDeudor")
                    filter.Add("ClienteID", this.masterCliente.Value);
                else if (btn.Name == "txtSaldoCod1")
                    filter.Add("Codeudor1", this.masterCodeudor1.Value);
                else if (btn.Name == "txtSaldoCod2")
                    filter.Add("Codeudor2", this.masterCodeudor2.Value);
                else if (btn.Name == "txtSaldoCod3")
                    filter.Add("Codeudor3", this.masterCodeudor3.Value);
                ModalStandar origin = new ModalStandar(this._documentID, filter);
                origin.ShowDialog();
            }
            catch (Exception ex)
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DigitacionCreditoFinan.cs", "txtSaldoDeudor_ButtonClick"));
            }
        }
        ...
        private void gvComponentes_CellValueChanged(object sender, CellValueChangedEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DigitacionCreditoFinanciera.cs", "gvComponentes_CellValueChanged"));
            }
        }
        ...
        private void gvComponentes_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DigitacionCreditoFinanciera.cs", "gvComponentes_FocusedRowChanged"));
            }
        }
        ...
        private void editBtnGrid_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DigitacionCreditoFinanciera.cs", "editBtnGrid_ButtonClick"));
            }
        }
        ...
        private void gcCompra_EmbeddedNavigator_ButtonClick(object sender, DevExpress.XtraEditors.NavigatorButtonClickEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DigitacionCreditoFinanciera.cs", "gcDetail_EmbeddedNavigator_ButtonClick"));
            }
        }
        ...
        private void gvDetail_CellValueChanged(object sender, DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DigitacionCreditoFinanciera.cs", "gvDetail_CellValueChanged"));
            }
        }
        ...
        private void gcCuotasExtra_EmbeddedNavigator_ButtonClick(object sender, DevExpress.XtraEditors.NavigatorButtonClickEventArgs e)
        {
            try
            {
                if (this._tipoCredito != TipoCredito.PolizaRenueva || this._ctrl == null)
                    e.Handled = true;
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DigitacionCreditoFinanciera.cs-", "gcCuotasExtra_EmbeddedNavigator_ButtonClick"));
            }
        }
        ...
        public override void TBNew()
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DigitacionCreditoFinanciera.cs", "TBNew"));
            }
        }
        ...
        public override void TBSave()
        {
            try
            {
                ...
                if (this.ValidateHeader() && this.isValid)
                {
                    ...
                    if (this._tipoCredito == TipoCredito.Nuevo || this._tipoCredito == TipoCredito.Refinanciado || this._tipoCredito == TipoCredito.RestructuracionConCambio)
                    {
                        ...
                        this._headerSolicitud.FechaVto.Value = this._ctrl.FechaDoc.Value.Value.AddMonths(this._headerSolicitud.Plazo.Value.Value);

                        //Agrega las cuota extras
                        this._liquidador.CuotasExtras = this._cuotasExtras;

                        //Carga la info del crédito
                        digCredito.AddData(this._ctrl, this._headerSolicitud, this._liquidador, this._componentesContab, compraTemp);
                        digCredito.Poliza = this._poliza;

                        result = _bc.AdministrationModel.DigitacionCredito_Add(this._documentID, this._actFlujo.ID.Value, digCredito, this._liquidador.CuotasExtras);

                        if (result.Result == ResultValue.OK)
                        {
                            #region obtiene el nombre

                            string nombre = this._headerSolicitud.NombrePri.Value;
                            if (!string.IsNullOrWhiteSpace(this._headerSolicitud.NombreSdo.Value))
                                nombre += " " + this._headerSolicitud.NombreSdo.Value;
                            if (!string.IsNullOrWhiteSpace(this._headerSolicitud.ApellidoPri.Value))
                                nombre += " " + this._headerSolicitud.ApellidoPri.Value;
                            if (!string.IsNullOrWhiteSpace(this._headerSolicitud.ApellidoSdo.Value))
                                nombre += " " + this._headerSolicitud.ApellidoSdo.Value;
                    ...
                    {
                        #region Renovacion de Polizas

                        int? numDocRenovacion = null;
                        if (this._solicitudRenovacion != 0)
                            numDocRenovacion = this._solicitudRenovacion;

                        result = _bc.AdministrationModel.RenovacionPoliza(this._documentID, numDocRenovacion, this._headerCredito, this._liquidador, this._poliza);
                    ...
                    else if (this._tipoCredito == TipoCredito.PolizaSinCredito)
                    {
                        ...
                        //Asigna a this._ctrl la fecha selecionada en el documento
                        this._ctrl.FechaDoc.Value = this.dtFechaCredito.DateTime;

                        //Agrega el indicador del tipo de credito a realizar (Credito o Poliza)
                        this._headerSolicitud.LiquidaAll.Value = true; // Se pone en true para crear la info del nuevo crédito asociadoa a la póliza
                        this._headerSolicitud.FechaVto.Value = this._ctrl.FechaDoc.Value.Value.AddMonths(this._headerSolicitud.Plazo.Value.Value);
                        ...
                        //Carga la info del crédito
                        digCredito.AddData(this._ctrl, this._headerSolicitud, this._liquidador, this._componentesContab, new List<DTO_ccSolicitudCompraCartera>());
                        digCredito.Poliza = this._poliza;
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DigitacionCreditoFinanciera.cs", "TBSave"));
            }
        }
