...
{
    public partial class CobroJuridicoPoliza : FormWithToolbar
    {
        #region Variables
        ...
        public CobroJuridicoPoliza()
        {
            this.Constructor(null);
        }

        public CobroJuridicoPoliza(string mod) 
        {
        ...
        public void Constructor(string mod = null)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-CobroJuridicoPoliza.cs", "CobroJuridicoPoliza"));
            }
        }
        ...
        private void SetInitParameters()
        {
            try
            {
                this.documentID = AppDocuments.CobroJuridicoPoliza; 
                ...
                //Recursos
                this.rsxActiva = this._bc.GetResource(LanguageTypes.Forms, AppDocuments.PolizasCartera + "_Activa");
                this.rsxAnulada = this._bc.GetResource(LanguageTypes.Forms, AppDocuments.PolizasCartera + "_Anulada");
                this.rsxRevocada = this._bc.GetResource(LanguageTypes.Forms, AppDocuments.PolizasCartera + "_Revocada");
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-CobroJuridicoPoliza.cs", "SetInitParameters"));
            }
        }
        ...
        private void LoadPoliza(DTO_ccPolizaEstado exist)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-CobroJuridicoPoliza.cs", "LoadPoliza"));
            }
        }
        ...
        protected virtual void Form_Enter(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-CobroJuridicoPoliza.cs", "Form_Enter"));
            }
        }
        ...
        protected virtual void Form_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-CobroJuridicoPoliza.cs", "Form_Closing"));
            }
        }
        ...
        protected virtual void Form_FormClosed(object sender, FormClosedEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-CobroJuridicoPoliza.cs", "Form_FormClosed"));
            }
        }
        ...
        private void lkpCreditos_EditValueChanged(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-CobroJuridicoPoliza.cs", "lkpCreditos_EditValueChanged"));
            }
        }
        ...
        public override void TBNew()
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-CobroJuridicoPoliza.cs", "TBNew"));
            }
        }
        ...
        public override void TBSave()
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-CobroJuridicoPoliza.cs", "TBSave"));
            }
        }
        #endregion
    }
