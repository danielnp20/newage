...
{
    public partial class SolicitudChequeo : FormWithToolbar
    {
        #region Delegados
        ...
        {
            this.gvDocuments.ActiveFilterString = string.Empty;
        ...
        public SolicitudChequeo()
        {
            this.Constructor();
        }

        public SolicitudChequeo(string mod = null)
        {
        ...
        public void Constructor(string mod = null)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-SolicitudChequeo.cs", "SolicitudChequeo"));
            }
        }
        ...
        protected virtual void AddDocumentCols()
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-SolicitudChequeo.cs", "AddDocumentCols"));
            }
        }
        ...
        protected virtual void AddDetailCols()
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-SolicitudChequeo.cs", "AddDetailCols"));
            }
        }
        ...
        protected virtual void AddTareasCols()
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-SolicitudChequeo.cs", "AddTareasCols"));
            }
        }
        ...
        protected virtual void LoadDocuments()
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-SolicitudChequeo.cs", "LoadDocuments"));
            }
        }
        ...
        protected virtual void LoadAnexos()
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-SolicitudChequeo.cs", "LoadAnexos"));
            }
        }
        ...
        protected virtual void LoadTareas()
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-SolicitudChequeo.cs", "LoadTareas"));
            }
        }
        ...
        protected virtual bool ValidateDocRow(int fila)
        {
            ...
            {
                this.isOK = false;
                //MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-SolicitudChequeo.cs", "ValidateDocRow"));
            }
            return this.isOK;
        }
        ...
        protected virtual void Form_Enter(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-SolicitudChequeo.cs", "Form_Enter"));
            }
        }
        ...
        protected virtual void Form_Leave(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-SolicitudChequeo.cs", "Form_Leave"));
            }
        }
        ...
        protected virtual void Form_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-SolicitudChequeo.cs", "Form_FormClosing"));
            }
        }
        ...
        protected virtual void Form_FormClosed(object sender, FormClosedEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-SolicitudChequeo.cs", "Form_FormClosed"));
            }
        }
        ...
        protected virtual void chkSeleccionar_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-SolicitudChequeo.cs", "chkSeleccionar_CheckedChanged"));
            }
        }
        ...
        private void masterActividad_Leave(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-SolicitudChequeo.cs", "masterActividad_Leave"));
            }
        }
        ...
        protected virtual void gcDocuments_CellValueChanged(object sender, DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-SolicitudChequeo.cs", "gcDocuments_CellValueChanged"));
            }
        }
        ...
        protected virtual void gvDocuments_CustomRowCellEditForEditing(object sender, CustomRowCellEditEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-SolicitudChequeo.cs", "gvDocuments_CustomRowCellEditForEditing"));
            }
        }
        ...
        {
            if (!this.gvDocuments.IsFilterRow(e.RowHandle) && this.currentRow != -1)
            {
        ...
        protected virtual void gvDocuments_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-SolicitudChequeo.cs", "gvDocuments_FocusedRowChanged"));
            }
        }
            ...
            if (!this.gvDocuments.IsFilterRow(e.RowHandle))
            {
                ...
                if (fieldName == "Aprobado")
                {
                    if ((bool)e.Value)
                    {
                        ...
                        row.Rechazado.Value = false;
                        row.Observacion.Value = string.Empty;
                ...
                if (fieldName == "ActividadFlujoDesc")
                {
                    ...
                    row.ActividadFlujoDesc = actFlujoDesc;
                    row.ActividadFlujoReversion.Value = this.actFlujoForReversion[actFlujoDesc];
                }
        ...
        protected virtual void ApproveThread()
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-SolicitudChequeo.cs", "ApprovedThread"));
            }
            finally
            {
                FormProvider.Master.StopProgressBarThread(this.documentID);
