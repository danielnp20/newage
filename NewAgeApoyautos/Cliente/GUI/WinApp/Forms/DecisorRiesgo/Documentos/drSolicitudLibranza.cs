...
{
    public partial class drSolicitudLibranza : FormWithToolbar
    {
        #region Variables
        ...
        private bool _GarantiaCancela = false;
        private bool _ObligacionCancela = false;
        private bool _generoGarantias=false;
        private bool _clienteNuevoValida = false;
        ...
        /// Constructor del Documento
        /// </summary>
        public drSolicitudLibranza(string mod)
        {
        ...
        public void Constructor(string mod = null)
        {
            ...
            try
            {
                ...
                this.btnGarantias.Enabled = false;
                ...
                {
                    if (this._frmModule == ModulesPrefix.dr)
                    {
                    ...
                    else
                    {
                        ...
                        List<string> NextActs = _bc.AdministrationModel.glActividadFlujo_GetActividadesByDocumentID(AppDocuments.EnvioSolicitudLibranza);
                        if (NextActs.Count != 1)
                        {
                            string msg = _bc.GetResource(LanguageTypes.Error, DictionaryMessages.Err_Gl_DocMultActivities);
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-drSolicitudLibranza.cs", "Constructor"));
            }
        }
        ...
        private void SetInitParameters()
        {
            try
            {
                ...
                _bc.InitMasterUC(this.masterAsesor, AppMasters.ccAsesor, false, true, true, false);
                ...
                Dictionary<string, string> TipoOperacion = new Dictionary<string, string>();
                TipoOperacion.Add(string.Empty, string.Empty);
                TipoOperacion.Add("1", this._bc.GetResource(LanguageTypes.Tables, "tbl_restr_TipoOperacionCredito_v1"));
                TipoOperacion.Add("2", this._bc.GetResource(LanguageTypes.Tables, "tbl_restr_TipoOperacionCredito_v2"));
                TipoOperacion.Add("3", this._bc.GetResource(LanguageTypes.Tables, "tbl_restr_TipoOperacionCredito_v3"));
                TipoOperacion.Add("4", this._bc.GetResource(LanguageTypes.Tables, "tbl_restr_TipoOperacionCredito_v4"));
                TipoOperacion.Add("5", this._bc.GetResource(LanguageTypes.Tables, "tbl_restr_TipoOperacionCredito_v5"));
                TipoOperacion.Add("6", this._bc.GetResource(LanguageTypes.Tables, "tbl_restr_TipoOperacionCredito_v6"));
                TipoOperacion.Add("7", this._bc.GetResource(LanguageTypes.Tables, "tbl_restr_TipoOperacionCredito_v7"));

                this.lkp_TipoOperacion.Properties.DataSource = TipoOperacion;
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-drSolicitudLibranza.cs", "SetInitParameters"));
            }
        }
        ...
        private void AddGridCols()
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-drSolicitudLibranza.cs", "AddGridCols"));
            }
        }
        ...
        {
            //this.lkp_TipoOperacion.Enabled = enabled;
        ...
        private bool ValidateHeader()
        {
            ...
            ////Valida que si debe marcar obligacion este marcada al sea una
            //if (this._ObligacionCancela)
            //{
            //    if (this.cursor.Count(x => x.TipoPersona.Value == 1)==0)
            //    {
            //        string msg = "No tiene marcadas Obligaciones para cancelar";
            //        MessageBox.Show(msg);
            //        this.btnGarantias.Focus();
            //        return false;
            //    }
            //}

            ////Valida que si debe marcar obligacion este marcada al sea una
            //if (this._GarantiaCancela)
            //{
            //    if (this.cursor.Count(x => x.TipoPersona.Value == 1) == 0)
            //    {
            //        string msg = "No tiene marcadas Garantias para cancelar";
            //        MessageBox.Show(msg);
            //        this.btnGarantias.Focus();
            //        return false;
            //    }
            ...
            {
                if (this.masterCliente.ValidID && this._clienteNuevoValida)
                {
            ...
            if (this._ctrl.NumeroDoc.Value == null || this._ctrl.NumeroDoc.Value.Value == 0)
            {
                ...
                this._ctrl.Estado.Value = Convert.ToInt32(3) == (int)TipoGarantia.Real ? (byte)EstadoDocControl.ParaAprobacion : (byte)EstadoDocControl.SinAprobar;
            ...
            this._header.TipoGarantia.Value = Convert.ToByte(3);
            this._header.TipoOperacion.Value = Convert.ToByte(this.lkp_TipoOperacion.EditValue);
        ...
        private bool ValidateAprobacion()
        {
            #region Hace las Validaciones
            //Valida que si debe marcar obligacion este marcada al sea una
            if (this._ObligacionCancela)
            {
                if (this.cursor.Count(x => x.TipoPersona.Value == 1 && x.CancelaInd.Value==true) == 0)
                {
                    string msg = "No tiene marcadas Obligaciones para cancelar";
                    MessageBox.Show(msg);
                    this.btnGarantias.Focus();
        ...
        private void GetValues()
        {
            ...
            //Header
            this.lkp_TipoOperacion.EditValue = this._header.TipoOperacion.Value != null && this._header.TipoOperacion.Value.HasValue ?
                this._header.TipoOperacion.Value.Value.ToString() : "1";
        ...
        protected virtual void Form_Enter(object sender, EventArgs e)
        {
            try
            {
                ...
                if (_generoGarantias)
                {
                    this.cursorGarantia = this._bc.AdministrationModel.glGarantiaControl_Decisor(this._ctrl.NumeroDoc.Value.Value);
                    this.cursor = this._bc.AdministrationModel.Obligaciones(this._ctrl.NumeroDoc.Value.Value);
                }
                else
                {
                    this.cursorGarantia = null;
                    this.cursor = null;
                }
            }
            catch (Exception ex)
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-drSolicitudLibranza.cs", "Form_Enter"));
            }
        }
        ...
        protected virtual void Form_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-drSolicitudLibranza.cs", "Form_Closing"));
            }
        }
        ...
        protected virtual void Form_FormClosed(object sender, FormClosedEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-drSolicitudLibranza.cs", "Form_FormClosed"));
            }
        }
            ...
            try
            {
                if (this._tipoCreditoID != this.masterTipoCredito.Value)
                {
                    ...
                    if (this.masterTipoCredito.ValidID)
                    {
                        ...
                        this._GarantiaCancela = Convert.ToBoolean(tipoDTO.CancelaGarInd.Value);
                        this._ObligacionCancela = Convert.ToBoolean(tipoDTO.CancelaCreditoInd.Value);
        ...
        private void masterCliente_Leave(object sender, EventArgs e)
        {
            try
            {
                if (this._clienteID != this.masterCliente.Value)
                {
                    ...
                    if (this.masterCliente.ValidID)
                    {
                        if (this._clienteNuevoValida)
                        {
                            this.masterCliente.Value = "0";
                            this.masterCliente.Focus();
                            return;
                        }
                        ...
                        this.masterCodeudor1.Value = cliente.CedEsposa.Value;
                    ...
                    if (Convert.ToInt32(3) == (int)TipoGarantia.Real)
                    {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-drSolicitudLibranza.cs", "masterCliente_Leave"));
            }
        }
        ...
        private void masterCentroPago_Leave(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-drSolicitudLibranza.cs", "masterCentroPago_Leave"));
            }
        ...
        private void masterPagaduria_Leave(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-drSolicitudLibranza.cs", "masterPagaduria_Leave"));
            }
        ...
        private void txtLibranza_Leave(object sender, EventArgs e)
        {
            try
            {
                if (this._libranzaID != this.txtLibranza.Text.Trim())
                {
                    ...
                    if (solicitud.DocCtrl != null)
                    {
                        ...
                        this.masterAsesor.EnableControl(false);
                        int value = Convert.ToInt32(this.lkp_TipoOperacion.EditValue);
                        switch (value)
                        {
                            case 1:
                                break;
                            case 2:
                                break;
                            case 3:
                                this.btnGarantias.Enabled = true;
                                break;
                            case 4:
                                this.btnGarantias.Enabled = true;
                                break;
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-drSolicitudLibranza.cs", "txtLibranza_Leave"));
            }
        }
        ...
        private void btnCambiarLibranza_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-drSolicitudLibranza.cs", "btnCambiarLibranza_Click"));
            }
        }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void lkp_TipoOperacion_EditValueChanged(object sender, EventArgs e)            
        {
            this.btnGarantias.Enabled = false;
            this.masterAsesor.EnableControl(false);
            if (!String.IsNullOrEmpty(this.txtLibranza.Text) ) //&& this.txtLibranza.Text.ToString()!="0")
            {
                this.masterTipoCredito.Value = "";
                this.Refresh();
                List<DTO_glConsultaFiltro> filtrosComplejos = new List<DTO_glConsultaFiltro>();

                DTO_glConsultaFiltro CancelaCredito = new DTO_glConsultaFiltro();
                DTO_glConsultaFiltro CancelaGarantia = new DTO_glConsultaFiltro();
                DTO_glConsultaFiltro TipoCredito = new DTO_glConsultaFiltro();
                DTO_glConsultaFiltro AbonaCapitalInd = new DTO_glConsultaFiltro();
                DTO_glConsultaFiltro NuevoClienteInd = new DTO_glConsultaFiltro();
                
                NuevoClienteInd.ValorFiltro = null;
                AbonaCapitalInd.ValorFiltro = null;
                CancelaGarantia.ValorFiltro = null;
                if (String.IsNullOrEmpty(this.lkp_TipoOperacion.EditValue.ToString()))                     
                    return;
                int value = Convert.ToInt32(this.lkp_TipoOperacion.EditValue);
                switch (value)
                {
                    case 1: //NUEVOS
                        this._clienteNuevoValida = true;
                        NuevoClienteInd.ValorFiltro = "1";
                        CancelaCredito.ValorFiltro = "0";
                        TipoCredito.ValorFiltro = "1";
                        this.masterAsesor.EnableControl(true);
                        break;
                    case 2: // ACTIVACION
                        this._clienteNuevoValida = false;
                        NuevoClienteInd.ValorFiltro = "0";
                        CancelaCredito.ValorFiltro = "0";
                        TipoCredito.ValorFiltro = "1";
                        break;
                    case 3: // REOPERACIONES
                        this._clienteNuevoValida = false;
                        NuevoClienteInd.ValorFiltro = "0";
                        CancelaCredito.ValorFiltro = "1";
                        TipoCredito.ValorFiltro = "2";
                        //this.btnGarantias.Enabled = true;
                        break;
                    case 4: //Restructuracion 
                        this._clienteNuevoValida = false;
                        this._GarantiaCancela = true;
                        NuevoClienteInd.ValorFiltro = "0";
                        CancelaCredito.ValorFiltro = "1";
                        TipoCredito.ValorFiltro = "5";
                        AbonaCapitalInd.ValorFiltro = "0";
                        //this.btnGarantias.Enabled = true;
                        break;
                    case 5: //Restructuracion con abono a Capital                        
                        NuevoClienteInd.ValorFiltro = "0";
                        this._clienteNuevoValida = false;
                        CancelaCredito.ValorFiltro = "1";
                        TipoCredito.ValorFiltro = "5";
                        AbonaCapitalInd.ValorFiltro = "1";
                        //this.btnGarantias.Enabled = true;
                        break;
                    case 6: // Cambio de Garantia
                        NuevoClienteInd.ValorFiltro = "0";
                        this._clienteNuevoValida = false;
                        CancelaCredito.ValorFiltro = "0";
                        TipoCredito.ValorFiltro = "7";
                        CancelaGarantia.ValorFiltro = "1";
                        //this.btnGarantias.Enabled = true;
                        break;
                    case 7: //Libera Garantias
                        NuevoClienteInd.ValorFiltro = "0";
                        this._clienteNuevoValida = false;
                        CancelaCredito.ValorFiltro = "0";
                        TipoCredito.ValorFiltro = "7";
                ...
                if (!string.IsNullOrEmpty(NuevoClienteInd.ValorFiltro))
                {
                    #region Filtros Tipo de credito para Clientes nuevo
                    NuevoClienteInd.CampoFisico = "NuevoClienteInd";
                    NuevoClienteInd.OperadorFiltro = OperadorFiltro.Igual;
                    NuevoClienteInd.OperadorSentencia = "AND";
                    filtrosComplejos.Add(NuevoClienteInd);
                    #endregion
                }
                if (!string.IsNullOrEmpty(CancelaCredito.ValorFiltro))
                {
                    #region Filtros Tipo de credito Cancela Obligaciones
                    CancelaCredito.CampoFisico = "CancelaCreditoInd";
                    CancelaCredito.OperadorFiltro = OperadorFiltro.Igual;
                    CancelaCredito.OperadorSentencia = "AND";
                    filtrosComplejos.Add(CancelaCredito);
                    #endregion
                }
                if (!string.IsNullOrEmpty(TipoCredito.ValorFiltro))
                {
                    #region Filtros Tipo de credito
                    TipoCredito.CampoFisico = "TipoCredito";
                    TipoCredito.OperadorFiltro = OperadorFiltro.Igual;
                    TipoCredito.OperadorSentencia = "AND";
                    filtrosComplejos.Add(TipoCredito);
                    #endregion
                }
                if (!string.IsNullOrEmpty(CancelaGarantia.ValorFiltro))
                {
                    #region Filtros Tipo de credito Cancel
                    CancelaGarantia.CampoFisico = "CancelaGarInd";
                    CancelaGarantia.OperadorFiltro = OperadorFiltro.Igual;
                    CancelaGarantia.OperadorSentencia = "AND";
                    filtrosComplejos.Add(CancelaGarantia);
                    #endregion
                }
                if (!string.IsNullOrEmpty(AbonaCapitalInd.ValorFiltro))
                {
                    #region Filtros Tipo de credito
                    AbonaCapitalInd.CampoFisico = "AbonaCapitalInd";
                    AbonaCapitalInd.OperadorFiltro = OperadorFiltro.Igual;
                    AbonaCapitalInd.OperadorSentencia = "AND";
                    filtrosComplejos.Add(AbonaCapitalInd);
                    #endregion
                }
                

                _bc.InitMasterUC(this.masterTipoCredito, AppMasters.ccTipoCredito, true, true, true, false, filtrosComplejos); 
        ...
        public override void TBNew()
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-drSolicitudLibranza.cs", "TBNew"));
            }
        }
        ...
        public override void TBSave()
        {
            try
            {
                if (this.ValidateHeader())
                {
                    ...
                    //solLibranza.Header.NegociosGestionarInd.Value = true;
                    if(!solLibranza.Header.VersionNro.Value.HasValue)
                    {
                        solLibranza.Header.VersionNro.Value = 0;
                    }
                    ...
                    if (result.Result == ResultValue.OK)
                    {
                        ...
                        this.CleanData();
                        //Validacion para que cargue digitacion despues de radicar
                        Type frm = null;
                        frm = typeof(DigitacionSolicitudNuevos);
                        //FormProvider.GetInstance(frm, new object[] { this._clienteID, Convert.ToInt32(this._libranzaID), false, false });
                        ...
                        FormProvider.Master.itemSendtoAppr.Visible = true;
                        FormProvider.Master.itemSendtoAppr.Enabled = true;
                        this.txtLibranza.Text = result.ExtraField.TrimEnd();
                        this.txtLibranza.Focus();
                        this.masterCliente.Focus();
                        
                        //object sender;
                        //EventArgs e;
                        //this.txtLibranza_Leave(sender, e);
                        //this.txtLibranza.Leave;
        ...
        {
            _generoGarantias = true;
            this.Datos= new Dictionary<string, int>();
            this.Datos.Add("1", Convert.ToInt32(this._header.CtasPagadas.Value));
            this.Datos.Add("2", Convert.ToInt32(this._header.AbonosCapital.Value));
            this.Datos.Add("3", Convert.ToInt32(this._header.OblPrepagadas.Value));
            this.Datos.Add("4", Convert.ToInt32(this._header.NroPrejuridicos.Value));
            DTO_TxResult _resPreliminar = _bc.AdministrationModel.Genera_ObligacionesGarantias(this._ctrl.NumeroDoc.Value.Value,null);
            string msg = _resPreliminar.ResultMessage;
            Type frm = typeof(ConsultaObligacionesGarantias);
            FormProvider.GetInstance(frm, new object[] { this.masterCliente.Value, Convert.ToInt32(this._ctrl.NumeroDoc.Value), this.Datos,true});            
        }
    }
}