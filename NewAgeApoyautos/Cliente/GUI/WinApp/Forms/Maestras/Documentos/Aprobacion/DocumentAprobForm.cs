...
namespace NewAge.Cliente.GUI.WinApp.Forms
{
    ...
    /// </summary>
    public partial class DocumentAprobForm : FormWithToolbar
    {
        #region Delegados
        ...
        //public DocumentAprobForm()
        //{
        //    InitializeComponent();
        //}

        public DocumentAprobForm(string mod = null)
        {
            try
            {
                InitializeComponent();
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentAprobForm.cs", "DocumentAprobForm"));
            }
        }
        ...
        protected virtual bool ValidateDocRow(int fila)
        {
            ...
            {                
               MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentAprobForm.cs", "ValidateDocRow"));
            }
        ...
        protected virtual void Form_Enter(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentAprobForm.cs", "Form_Enter"));
            }
        }
        ...
        protected virtual void Form_Leave(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentAprobForm.cs", "Form_Leave"));
            }
        }
        ...
        protected virtual void Form_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentAprobForm.cs", "Form_FormClosing"));
            }
        }
        ...
        protected virtual void Form_FormClosed(object sender, FormClosedEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentAprobForm.cs", "Form_FormClosed"));
            }
        }
        ...
        protected virtual void gvDocuments_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentAprobForm.cs", "gvDocuments_FocusedRowChanged"));
            }
        }
        ...
        /// <param name="sender">Objeto que envia el evento</param>
        /// <param name="e">Evento</param>
        protected virtual void gvDetails_CustomRowCellEditForEditing(object sender, CustomRowCellEditEventArgs e)
        {
        }
        ...
        public override void TBUpdate()
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentAprobForm.cs", "TBUpdate"));
            }
        }
