...
namespace NewAge.Server.ReportesService
{
    ...
    public interface IReportesService
    {
        ...
        /// <returns></returns>
        [OperationContract]
        string Report_Dr_DecisorByNumeroDoc(Guid channel, int documentID, int numDoc, int Libranza, ExportFormatType formatType);
        ...
        string Report_Cc_RecaudosMasivosGetRelacionPagos(Guid channel, int documentID, List<DTO_ccIncorporacionDeta> data);
         ...
         /// <returns>Retorna el nombre del reporte</returns>
        [OperationContract]
        string Report_Cc_CobroJuridico(Guid channel, int documentID, byte claseDeuda, byte tipoReporte, string cliente, string obligacion);
        ...
        /// <returns>Retorna el nombre del reporte</returns>
        [OperationContract]
        string Report_Cc_CobroJuridicoHistoria(Guid channel, int documentID, int numDocCredito, bool isPrincipal);
        ...
        /// <returns>nombre de reporte</returns>
        [OperationContract]
        string Report_Cc_GestionCobranza(Guid channel, int document, string tipoReport, DateTime fechaCorte);
        ...
        /// <returns>nombre de reporte</returns>
        [OperationContract]
        string Report_Cc_CartaCustom(Guid channel, int document, object data, Dictionary<string, string> adicionales);
        ...
        /// <returns>URL del reporte</returns>
        [OperationContract]
        string ReportesFacturacion_FacturaVenta(Guid channel, int documentID, string numDoc, bool isAprobada, ExportFormatType formatType, decimal valorAnticipo, decimal valorRteGarantia, decimal? porcRteGarantia);
        ...
        /// <returns></returns>
        [OperationContract]
        string ReportesInventarios_SaldosSinParametros(Guid channel, int año, int mesIni, string bodega, string tipoBodega,
                string referencia, string grupo, string clase, string tipo, string serie, string material, bool isSerial, string Libro, ExportFormatType formatType);
        ...
        /// <returns></returns>
        [OperationContract]
        string ReportesInventarios_SaldosxReferencia(Guid channel, int año, int mesIni, string bodega, string tipoBodega,
                string referencia, string grupo, string clase, string tipo, string serie, string material, bool isSerial, string Libro, ExportFormatType formatType);
        ...
        /// <returns></returns>
        [OperationContract]
        string ReportesInventarios_SaldosSinParametrosxReferencia(Guid channel, int año, int mesIni, string bodega, string tipoBodega,
                string referencia, string grupo, string clase, string tipo, string serie, string material, bool isSerial, string Libro, ExportFormatType formatType);
        #endregion
        ...
        /// <returns>Listado de DTO</returns>
        [OperationContract]
        DTO_TxResult ReportesProveedores_OrdenCompras(Guid channel, DateTime FechaIni, DateTime FechaFin, string Proveedor, int Estado, bool isDetallado, string Moneda, ExportFormatType formatType);
        ...
        /// <returns>Listado de DTO</returns>
        [OperationContract]
        DTO_TxResult ReportesProveedores_OrdenComprasDetallada(Guid channel, DateTime FechaIni, DateTime FechaFin, string Proveedor, int Estado, bool isDetallado, string Moneda, ExportFormatType formatType);
        #endregion
        ...
        /// <returns></returns>
        [OperationContract]
        DTO_TxResult ReportesProveedores_Recibidos(Guid channel, DateTime Periodo, string proveedor, bool isDetallado, bool isFacturdo, ExportFormatType exportType);
        ...
        /// <returns></returns>
        [OperationContract]
        DTO_TxResult ReportesProveedores_RecibidosDetallado(Guid channel, DateTime Periodo, string proveedor, bool isDetallado, bool isFacturdo, ExportFormatType exportType);
        ...
        /// <returns>nombre del reporte</returns>
        [OperationContract]
        string Reportes_py_Actas(Guid channel, DTO_SolicitudTrabajo solicitud, bool useMultiplicadorInd, byte tipoReport);
