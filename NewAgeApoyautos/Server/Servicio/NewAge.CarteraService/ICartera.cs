...
namespace NewAge.Server.CarteraService
{
    ...
    public interface ICarteraService
    {
        ...
        /// <returns></returns>
        [OperationContract]
        DTO_TxResult RecaudosMasivos_Validar(Guid channel, int documentID, DateTime periodo, string centroPagoID, string pagaduriaID, DateTime fechaAplica,
       ...
       /// <summary>
        ...
        /// <returns>Retorna el resultado de la operacion</returns>
        [OperationContract]
        List<DTO_SerializedObject> SolicitudLibranza_AprobarRechazar(Guid channel, int documentID, string actFlujoID, List<DTO_SolicitudAprobacionCartera> solicitudes, List<DTO_ccSolicitudAnexo> anexos, List<DTO_ccTareaChequeoLista> tareas);
        ...
        [OperationContract]
        List<DTO_ccArchivoIncorporaciones> GetArchivosIncorporacion(Guid channel, DateTime periodo, string centroPago);
        ...
        [OperationContract]
        Tuple<DTO_ccCJHistorico, DTO_ccCJHistorico> ccCJHistorico_GetForAbono(Guid channel, int numDocCredito);
        ...
        [OperationContract]
        List<DTO_ccComisionDeta> LiquidacionComisionesCartera_GetForLiquidacion(Guid channel);
        ...
        [OperationContract]
        List<DTO_ccComisionDeta> LiquidacionComisionesCartera_GetForAprobacion(Guid channel, string actFlujoID);
        ...
        /// <returns>Retorna el resultado de la operacion</returns>
        [OperationContract]
        DTO_TxResult DatacreditoGestion_Add(Guid channel, int documentID, List<DTO_ccSolicitudDataCreditoDatos> datos, List<DTO_ccSolicitudDataCreditoScore> score, List<DTO_ccSolicitudDataCreditoUbica> ubica, List<DTO_ccSolicitudDataCreditoQuanto> quanto, bool isNewVersion);
        ...
        /// <returns></returns>
        [OperationContract]
        DTO_TxResult GestionSolicitud_Add(Guid channel, int documentoID, string actFlujoId, DTO_DigitaSolicitudDecisor data, List<DTO_glDocumentoChequeoLista> chequeos, bool isNewVersion);
        ...
        /// <returns></returns>
        [OperationContract]
        DTO_TxResultDetail Garantia_Add(Guid channel, int documentID, DTO_glDocumentoControl Garantia);
        ...
        /// <returns>Retorna el resultado de la operacion</returns>
        [OperationContract]
        DTO_TxResult Genera_Perfil(Guid channel, DateTime periodoID, int NumeroDoc);
        /// <summary>
        /// Genera ObligacionesGarantias
        /// </summary>
        /// <param name="NumeroDoc">Numero Doc</param>
        /// <returns>Retorna el resultado de la operacion</returns>
        [OperationContract]
        DTO_TxResult Genera_ObligacionesGarantias(Guid channel, int? NumeroDoc , string ClienteID );
        ...
        /// <returns>Retorna un objeto TxResult si se presenta un error, de lo contrario devuelve un objeto de tipo DTO_PlanDePagos</returns>
        [OperationContract]
        DTO_SerializedObject GenerarPlanPagosFinanciera(Guid channel, string lineaCredID, int valorCredito, int valorPoliza, int vlrGiro, int plazoCredito, int plazoPoliza,
        ...
        /// <returns></returns>
        [OperationContract]
        DTO_TxResult RecaudosMasivosFin_Validar(Guid channel, int documentID, DateTime fechaNomina, ref List<DTO_ccIncorporacionDeta> data);
        ...
        /// <returns>Retorna el resultado de la operacion</returns>
        [OperationContract]
        DTO_TxResult RecaudosMasivosFin_Procesar(Guid channel, int documentID, DateTime periodo, List<DTO_ccIncorporacionDeta> data);
        ...
        /// </summary>
        [OperationContract]
        DTO_TxResult drSolicitudGarantias_Update(Guid channel, List<DTO_QueryGarantiaControl> Garantias);

        [OperationContract]
        DTO_TxResult drSolicitudObligaciones_Update(Guid channel, List<DTO_QueryObligaciones> Obligaciones);

        [OperationContract]
        List<DTO_OperacionesPendientes> OperacionesPendientes (Guid channel);

        [OperationContract]
        List<DTO_QueryObligaciones> Obligaciones(Guid channel, int NumeroDoc);

        /// <summary>
        /// Agrega las nuevas solicitudes del canal preferencial
        /// </summary>
        [OperationContract]
        DTO_TxResult SolicitudCanalPreferencial_Add(Guid channel);
        ...
        /// <returns>Retorna la informacion de una solicitud de credito</returns>
        [OperationContract]
        DTO_DigitaSolicitudDecisor DigitacionSolicitud_GetBySolicitud(Guid channel, int libranzaID);
        ...
        /// <returns>Retorna el resultado de la operacion</returns>
        [OperationContract]
        DTO_TxResult DigitacionSolicitud_Add(Guid channel, int documentoID, string actFlujoId, DTO_DigitaSolicitudDecisor data,List<DTO_glDocumentoChequeoLista> chequeos, bool isNewVersion);
        ...
        [OperationContract]
        DataTable drSolicitudDatosPersonales_GetForDatacredito(Guid channel);
        ...
        [OperationContract]
        List<DTO_drActividadChequeoLista> drActividadChequeoLista_GetByActividad(Guid channel, string actividadFlujo);
        ...
        /// <returns>Retorna una lista con la maestra de lista de chequo</returns>
        [OperationContract]
        List<DTO_drSolicitudDatosChequeados> drSolicitudDatosChequeados_GetByActividadNumDoc(Guid channel, string actividadFlujo, int numdoc, int version);

        /// <summary>
        /// Guarda de chequeos de un flujo
        /// </summary>
        /// <param name="actividadFlujo">Flujo</param>
        /// <returns>Guarda lista con la maestra de lista de chequo</returns>
        [OperationContract]
        DTO_TxResult drSolicitudDatosChequeados_Add(Guid channel, List<DTO_glDocumentoChequeoLista> chequeo, int numdoc, int version);
        #endregion
        #endregion
