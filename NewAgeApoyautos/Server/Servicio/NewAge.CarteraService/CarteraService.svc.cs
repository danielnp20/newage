...
namespace NewAge.Server.CarteraService
{
    ...
    public class CarteraService : ICarteraService, IDisposable
    {
        ...
        /// <returns></returns>
        public DTO_TxResult RecaudosMasivos_Validar(Guid channel, int documentID, DateTime periodo, string centroPagoID, string pagaduriaID, DateTime fechaAplica, 
            ref List<DTO_ccIncorporacionDeta> data)
        {
            ...
            try
            {
                ...
                ModuloCartera modulo = (ModuloCartera)facade.GetModule(ModulesPrefix.cc, this._mySqlConnections[opIndex], null, _channels[channel].Item1, _channels[channel].Item2, this._connLoggerString);
                var response = modulo.RecaudosMasivos_Validar(documentID, periodo, centroPagoID, pagaduriaID, fechaAplica, ref data, DictionaryProgress.BatchProgress);
                return response;
            }
            finally
            {
            ...
            decimal valorPagaduria, string centroPagoID, DTO_tsBancosCuenta banco, List<DTO_ccIncorporacionDeta> data)
        {
            ...
            try
            {
                ...
                var response = modulo.RecaudosMasivos_Pagar(documentID, actFlujoID, periodo, fecha, fechaAplica, valorPagaduria,
                    centroPagoID, banco, data, false, DictionaryProgress.BatchProgress);
                return response;
            }
            finally
            {
        ...
        /// <returns>Retorna el resultado de la operacion</returns>
        public List<DTO_SerializedObject> SolicitudLibranza_AprobarRechazar(Guid channel, int documentID, string actFlujoID, List<DTO_SolicitudAprobacionCartera> solicitudes, List<DTO_ccSolicitudAnexo> anexos, List<DTO_ccTareaChequeoLista> tareas)
        {
            if (_currentProcess.Contains(documentID))
            {
       ...
       /// <returns>Lista de documentos</returns> 
        ...
        /// <param name="fechaIncorpora">Fecha de incorporacion de Creditos</param>
        /// <param name="centroPago">Centro de pago para incorporacion</param>
        /// <param name="isLiquidacion">Revisa si es incorporacion Previa</param>
        /// <returns>Retorna las incorporaciones por fecha</returns>
        public List<DTO_ccArchivoIncorporaciones> GetArchivosIncorporacion(Guid channel, DateTime periodo, string centroPago)
        {
            int opIndex = -1;
            try
            {
                ...
                var response = modulo.GetArchivosIncorporacion(periodo, centroPago);
                return response;
            }
            catch (Exception)
            {
        ...
        public Tuple<DTO_ccCJHistorico, DTO_ccCJHistorico> ccCJHistorico_GetForAbono(Guid channel, int ccCJHistorico_GetForAbono)
        {
            int opIndex = -1;
            try
            {
                opIndex = this.ADO_ConnectDB();
                ModuloCartera modulo = (ModuloCartera)facade.GetModule(ModulesPrefix.cc, this._mySqlConnections[opIndex], null, _channels[channel].Item1, _channels[channel].Item2, this._connLoggerString);
                var response = modulo.ccCJHistorico_GetForAbono(ccCJHistorico_GetForAbono);
                return response;
            }
            finally
            {
        ...
        public List<DTO_ccComisionDeta> LiquidacionComisionesCartera_GetForLiquidacion(Guid channel)
        {
            int opIndex = -1;
            try
            {
                opIndex = this.ADO_ConnectDB();
                ModuloCartera modulo = (ModuloCartera)facade.GetModule(ModulesPrefix.cc, this._mySqlConnections[opIndex], null, _channels[channel].Item1, _channels[channel].Item2, this._connLoggerString);
                var response = modulo.LiquidacionComisioneCarteras_GetForLiquidacion();
                return response;
            }
            finally
            {
        ...
        public List<DTO_ccComisionDeta> LiquidacionComisionesCartera_GetForAprobacion(Guid channel, string actFlujoID)
        {
            int opIndex = -1;
            try
            {
                opIndex = this.ADO_ConnectDB();
                ModuloCartera modulo = (ModuloCartera)facade.GetModule(ModulesPrefix.cc, this._mySqlConnections[opIndex], null, _channels[channel].Item1, _channels[channel].Item2, this._connLoggerString);
                var response = modulo.LiquidacionComisionesCartera_GetForAprobacion(actFlujoID);
                return response;
            }
            finally
            {
        ...
        /// <returns>Retorna el resultado de la operacion</returns>
        public DTO_TxResult DatacreditoGestion_Add(Guid channel, int documentID, List<DTO_ccSolicitudDataCreditoDatos> datos, List<DTO_ccSolicitudDataCreditoScore> score, List<DTO_ccSolicitudDataCreditoUbica> ubica, List<DTO_ccSolicitudDataCreditoQuanto> quanto, bool isNewVersion)
        {
            if (_currentProcess.Contains(documentID))
            {
                DTO_TxResult result = new DTO_TxResult()
            ...
            try
            {
                ...
                DictionaryProgress.IniciarProceso(_channels[channel].Item2, documentID);
                ModuloCartera modulo = (ModuloCartera)facade.GetModule(ModulesPrefix.cc, this._mySqlConnections[opIndex], null, _channels[channel].Item1, _channels[channel].Item2, this._connLoggerString);
                var response = modulo.DatacreditoGestion_Add(documentID, datos, score, ubica, quanto, isNewVersion,false, DictionaryProgress.BatchProgress);
                return response;
            }
            finally
            {
        ...
        /// <returns></returns>
        public DTO_TxResult GestionSolicitud_Add(Guid channel, int documentoID, string actFlujoId, DTO_DigitaSolicitudDecisor data, List<DTO_glDocumentoChequeoLista> chequeos, bool isNewVersion)
        {
            ...
            try
            {
                ...
                ModuloCartera modulo = (ModuloCartera)facade.GetModule(ModulesPrefix.cc, this._mySqlConnections[opIndex], null, _channels[channel].Item1, _channels[channel].Item2, this._connLoggerString);
                var response = modulo.GestionSolicitud_Add(documentoID,actFlujoId, data,chequeos, isNewVersion, false, DictionaryProgress.BatchProgress);
                return response;
            }
            finally
            {
        ...
        /// <param name="documentoID">doc </param>
        /// <returns></returns>
        public DTO_TxResultDetail Garantia_Add(Guid channel, int documentID, DTO_glDocumentoControl Garantia)
        {
...
//               {
                    opIndex = this.ADO_ConnectDB();
                    ModuloCartera modulo = (ModuloCartera)facade.GetModule(ModulesPrefix.cc, this._mySqlConnections[opIndex], null, _channels[channel].Item1, _channels[channel].Item2, this._connLoggerString);
                    var response = modulo.Garantia_Add(documentID, Garantia);
                    //response.Key = Garantia.DocumentoNro.Value.ToString();
                    return response;
//                }
//                else
//                    return result;                
        ...
        /// <returns></returns>
        public DTO_TxResult Genera_Perfil(Guid channel, DateTime periodoID, int NumeroDoc)
        {
                int opIndex = -1;
                try
                {
                    opIndex = this.ADO_ConnectDB();
                    ModuloCartera modulo = (ModuloCartera)facade.GetModule(ModulesPrefix.cc, this._mySqlConnections[opIndex], null, _channels[channel].Item1, _channels[channel].Item2, this._connLoggerString);
                    var response = modulo.Genera_Perfil(periodoID, NumeroDoc, false);
                    return response;
                }
        ...
        /// <param name="NumeroDoc">NumeroDoc </param>
        /// <returns></returns>
        public DTO_TxResult Genera_ObligacionesGarantias(Guid channel, int? NumeroDoc , string ClienteID )
        {
            int opIndex = -1;
            try
            {
                opIndex = this.ADO_ConnectDB();
                ModuloCartera modulo = (ModuloCartera)facade.GetModule(ModulesPrefix.cc, this._mySqlConnections[opIndex], null, _channels[channel].Item1, _channels[channel].Item2, this._connLoggerString);
                var response = modulo.Genera_ObligacionesGarantias(NumeroDoc,ClienteID,false);
                return response;
            }
        ...
        /// <returns>Retorna un objeto TxResult si se presenta un error, de lo contrario devuelve un objeto de tipo DTO_PlanDePagos</returns>
        public DTO_SerializedObject GenerarPlanPagosFinanciera(Guid channel, string lineaCredID, int valorCredito, int valorPoliza, int vlrGiro, int plazoCredito, int plazoPoliza,
            ...
            List<DTO_Cuota> cuotasExtras, Dictionary<string, decimal> compsNuevoValor, int numDocCredito, string tipoCredito, bool excluyeCompInvisibleInd)
        {
            ...
            try
            {
                opIndex = this.ADO_ConnectDB();
                ModuloCarteraFin modulo = (ModuloCarteraFin)facade.GetModule(ModulesPrefix.cf, this._mySqlConnections[opIndex], null, _channels[channel].Item1, _channels[channel].Item2, this._connLoggerString);
                var response = modulo.GenerarPlanPagosFinanciera(lineaCredID, valorCredito, valorPoliza, vlrGiro, plazoCredito, plazoPoliza, edad, fechaLiquida, fechaCuota1,
        ...
        /// <param name="data">Información a migrar</param>
        /// <returns></returns>
        public DTO_TxResult RecaudosMasivosFin_Validar(Guid channel, int documentID, DateTime fechaNomina, ref List<DTO_ccIncorporacionDeta> data)
        {
            if (_currentProcess.Contains(documentID))
            {
                DTO_TxResult result = new DTO_TxResult()
            ...
            try
            {
                ...
                DictionaryProgress.IniciarProceso(_channels[channel].Item2, documentID);
                ModuloCarteraFin modulo = (ModuloCarteraFin)facade.GetModule(ModulesPrefix.cf, this._mySqlConnections[opIndex], null, _channels[channel].Item1, _channels[channel].Item2, this._connLoggerString);
                var response = modulo.RecaudosMasivosFin_Validar(documentID, fechaNomina, ref data, DictionaryProgress.BatchProgress);
                return response;
            }
            finally
            {
        ...
        /// <param name="data">Información a migrar</param>
        /// <returns>Retorna el resultado de la operacion</returns>
        public DTO_TxResult RecaudosMasivosFin_Procesar(Guid channel, int documentID, DateTime periodo, List<DTO_ccIncorporacionDeta> data)
        {
            if (_currentProcess.Contains(documentID))
            {
                DTO_TxResult result = new DTO_TxResult()
            ...
            try
            {
                ...
                DictionaryProgress.IniciarProceso(_channels[channel].Item2, documentID);
                ModuloCarteraFin modulo = (ModuloCarteraFin)facade.GetModule(ModulesPrefix.cf, this._mySqlConnections[opIndex], null, _channels[channel].Item1, _channels[channel].Item2, this._connLoggerString);
                var response = modulo.RecaudosMasivosFin_Procesar(documentID, periodo, data, false, DictionaryProgress.BatchProgress);
                return response;
            }
            finally
            {
        ...
        /// </summary>
        public List<DTO_OperacionesPendientes> OperacionesPendientes(Guid channel)
        
        {
            ...
            {
                opIndex = this.ADO_ConnectDB();
                ModuloDecisorRiesgo modulo = (ModuloDecisorRiesgo)facade.GetModule(ModulesPrefix.dr, this._mySqlConnections[opIndex], null, _channels[channel].Item1, _channels[channel].Item2, this._connLoggerString);
                var response = modulo.OperacionesPendientes();
                return response;
            }
            finally
            {
        ...
        /// </summary>
        public List<DTO_QueryObligaciones> Obligaciones(Guid channel, int NumeroDoc)
        {
            int opIndex = -1;
            try
            {
                opIndex = this.ADO_ConnectDB();
                ModuloDecisorRiesgo modulo = (ModuloDecisorRiesgo)facade.GetModule(ModulesPrefix.dr, this._mySqlConnections[opIndex], null, _channels[channel].Item1, _channels[channel].Item2, this._connLoggerString);
                var response = modulo.Obligaciones(NumeroDoc);
                return response;
            }
            finally
            {
        ...
        /// <summary>
        /// Actualiza Solicitud Obligaciones
        /// </summary>
        public DTO_TxResult drSolicitudObligaciones_Update(Guid channel,List<DTO_QueryObligaciones> Obligaciones)
        {
            int opIndex = -1;
            try
            {
                opIndex = this.ADO_ConnectDB();
                ModuloDecisorRiesgo modulo = (ModuloDecisorRiesgo)facade.GetModule(ModulesPrefix.dr, this._mySqlConnections[opIndex], null, _channels[channel].Item1, _channels[channel].Item2, this._connLoggerString);
                var response = modulo.drSolicitudObligaciones_Update(Obligaciones);
                return response;
            }
            finally
            {
        ...
        /// <summary>
        /// Actualiza Solicitud Garantias
        /// </summary>
        public DTO_TxResult drSolicitudGarantias_Update(Guid channel, List<DTO_QueryGarantiaControl> Garantias)
        {
            int opIndex = -1;
            try
            {
                opIndex = this.ADO_ConnectDB();
                ModuloDecisorRiesgo modulo = (ModuloDecisorRiesgo)facade.GetModule(ModulesPrefix.dr, this._mySqlConnections[opIndex], null, _channels[channel].Item1, _channels[channel].Item2, this._connLoggerString);
                var response = modulo.drSolicitudGarantias_Update(Garantias);
                return response;
            }
            finally
            {
        ...
        /// </summary>
        public DTO_TxResult SolicitudCanalPreferencial_Add(Guid channel)

        {
            ...
            try
            {
                opIndex = this.ADO_ConnectDB();
                ModuloDecisorRiesgo modulo = (ModuloDecisorRiesgo)facade.GetModule(ModulesPrefix.dr, this._mySqlConnections[opIndex], null, _channels[channel].Item1, _channels[channel].Item2, this._connLoggerString);
                var response = modulo.SolicitudCanalPreferencial_Add(false);
                return response;
            }
            finally
            {
        ...
        /// <param name="actFlujoID">Identificador de la actividad de flujo</param>
        /// <returns>Retorna la informacion de una solicitud de credito</returns>
        public DTO_DigitaSolicitudDecisor DigitacionSolicitud_GetBySolicitud(Guid channel,int libranzaID)

        {
            ...
            try
            {
                opIndex = this.ADO_ConnectDB();
                ModuloDecisorRiesgo modulo = (ModuloDecisorRiesgo)facade.GetModule(ModulesPrefix.dr, this._mySqlConnections[opIndex], null, _channels[channel].Item1, _channels[channel].Item2, this._connLoggerString);
                var response = modulo.DigitacionSolicitud_GetBySolicitud(libranzaID);
                return response;
            }
            finally
            {
        ...
        /// <param name="data">Datos que se debe agregar</param>
        /// <returns>Retorna el resultado de la operacion</returns>
        public DTO_TxResult DigitacionSolicitud_Add(Guid channel, int documentoID, string actFlujoId, DTO_DigitaSolicitudDecisor data, List<DTO_glDocumentoChequeoLista> chequeos, bool isNewVersion)

        {
            ...
            try
            {
                opIndex = this.ADO_ConnectDB();
                ModuloDecisorRiesgo modulo = (ModuloDecisorRiesgo)facade.GetModule(ModulesPrefix.dr, this._mySqlConnections[opIndex], null, _channels[channel].Item1, _channels[channel].Item2, this._connLoggerString);
                var response = modulo.DigitacionSolicitud_Add(documentoID, actFlujoId, data,chequeos, isNewVersion,false);
                return response;
            }
            finally
            {
        ...
        public DataTable drSolicitudDatosPersonales_GetForDatacredito(Guid channel)

        {
            ...
            try
            {
                opIndex = this.ADO_ConnectDB();
                ModuloDecisorRiesgo modulo = (ModuloDecisorRiesgo)facade.GetModule(ModulesPrefix.dr, this._mySqlConnections[opIndex], null, _channels[channel].Item1, _channels[channel].Item2, this._connLoggerString);
                var response = modulo.drSolicitudDatosPersonales_GetForDatacredito();
                return response;
            }
            finally
            {
        ...
        public List<DTO_drActividadChequeoLista> drActividadChequeoLista_GetByActividad(Guid channel,string actividadFlujo)

        {
            ...
            try
            {
                opIndex = this.ADO_ConnectDB();
                ModuloDecisorRiesgo modulo = (ModuloDecisorRiesgo)facade.GetModule(ModulesPrefix.dr, this._mySqlConnections[opIndex], null, _channels[channel].Item1, _channels[channel].Item2, this._connLoggerString);
                var response = modulo.drActividadChequeoLista_GetByActividad(actividadFlujo);
                return response;
            }
            finally
            {
        ...
        /// <param name="actividadFlujo">Flujo</param>
        /// <returns>Retorna una lista con la maestra de lista de chequo</returns>
        public List<DTO_drSolicitudDatosChequeados> drSolicitudDatosChequeados_GetByActividadNumDoc(Guid channel, string actividadFlujo, int numdoc, int version)
        {
            int opIndex = -1;
            try
            {
                opIndex = this.ADO_ConnectDB();
                ModuloDecisorRiesgo modulo = (ModuloDecisorRiesgo)facade.GetModule(ModulesPrefix.dr, this._mySqlConnections[opIndex], null, _channels[channel].Item1, _channels[channel].Item2, this._connLoggerString);
                var response = modulo.drSolicitudDatosChequeados_GetByActividadNumDoc(actividadFlujo, numdoc,version);
                return response;
            }
            finally
            {
        ...
        public DTO_TxResult drSolicitudDatosChequeados_Add(Guid channel, List<DTO_glDocumentoChequeoLista> chequeo, int numdoc, int version)
        {
            int opIndex = -1;
            try
            {
                opIndex = this.ADO_ConnectDB();
                ModuloDecisorRiesgo modulo = (ModuloDecisorRiesgo)facade.GetModule(ModulesPrefix.dr, this._mySqlConnections[opIndex], null, _channels[channel].Item1, _channels[channel].Item2, this._connLoggerString);
                var response = modulo.drSolicitudDatosChequeados_add(chequeo, numdoc, version);
                return response;
            }
            finally
            {
