        ...
        public List<string> DAL_glActividadFlujo_GetTareaID(int documentoID)
        {
            try
            {
                ...
                mySqlCommand.CommandText = "select ActividadFlujoID from glActividadFlujo " +
                    " where EmpresaGrupoID = @EmpresaGrupoID and DocumentoID = @DocumentoID and ActivoInd=1";
        ...
        public List<DTO_glActividadFlujo> DAL_glActividadFlujo_GetParents(string actFlujoID)
        {
            try
            {
                ...
                mySqlCommand.CommandText =
                    ...
                    "    WHERE ActividadPadre = @ActividadPadre and ActivoInd=1" +
                    "    UNION all " +
                    "	SELECT parent.ActividadHija, parent.ActividadPadre " +
                    "	FROM MyCTE AS child INNER JOIN glProcedimientoFlujo AS parent ON parent.ActividadHija = child.ActividadPadre and ActivoInd=1 " +
                    ") " +
                    ...
                    "where ActividadPadre <> @ActividadPadre order by ActividadPadre ";
