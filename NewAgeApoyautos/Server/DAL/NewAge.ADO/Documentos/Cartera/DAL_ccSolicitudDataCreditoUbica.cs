...
namespace NewAge.ADO
{
    public class DAL_ccSolicitudDataCreditoUbica : DAL_Base
    {
        ...
        /// <returns>Dto de Detalle Docu</returns>
        public List<DTO_ccSolicitudDataCreditoUbica> DAL_ccSolicitudDataCreditoUbica_GetByLastVersion(int numeroDoc)
        {
            try
            {
                List<DTO_ccSolicitudDataCreditoUbica> result = new List<DTO_ccSolicitudDataCreditoUbica>();
                ...
                mySqlCommand.CommandText = "select Version from ccSolicitudDataCreditoUbica  with(nolock) " +
                ...
                mySqlCommand.CommandText = "Select * from ccSolicitudDataCreditoUbica data with(nolock) " +
            ...
            {
                var exception = new Exception(DictionaryMessages.Err_GettingList, ex);
                Mentor_Exception.LogException_Local(this.loggerConnectionStr, exception, this.UserId.ToString(), "DAL_ccSolicitudDataCreditoUbica_GetByLastVersion");
                throw exception;
            }
        }
        ...
        public int DAL_ccSolicitudDataCreditoUbica_Add(DTO_ccSolicitudDataCreditoUbica Datos)
        {
            try
            {
                ...
                mySqlCommandSel.CommandText =
                    ...
                    "   TelefonoOtro,Celular1IND,Celular2IND,CelularOtraIND,CelularOtro,EMailOtroIND,EMailOtro,EMail1IND,EMail2IND,TipoDirOtra,TipoTelOtro" +
                    ") " +
                    "VALUES " +
                    " ( "+
                    "   @NumeroDoc,@Version,@TipoId,@NumeroId,@Nombre,@FechaExp,@CiudadExp,@DeptoExp,@Genero,@RangoEdad,@CiudadTel1,@DeptoTel1,@CodCiudadTel1," +
                ...
                mySqlCommandSel.Parameters.Add("@EMail1IND", SqlDbType.Bit);
                mySqlCommandSel.Parameters.Add("@EMail2IND", SqlDbType.Bit);
                mySqlCommandSel.Parameters.Add("@TipoDirOtra", SqlDbType.Char, 20);
                mySqlCommandSel.Parameters.Add("@TipoTelOtro", SqlDbType.Char, 20);
                ...
                mySqlCommandSel.Parameters["@EMail1IND"].Value = Datos.EMail1IND.Value;
                mySqlCommandSel.Parameters["@EMail2IND"].Value = Datos.EMail2IND.Value;
                mySqlCommandSel.Parameters["@TipoDirOtra"].Value = Datos.TipoDirOtra.Value;
                mySqlCommandSel.Parameters["@TipoTelOtro"].Value = Datos.TipoTelOtro.Value;
                //Eg
            ...
            try
            {
                ...
                mySqlCommandSel.CommandText =
                                           "UPDATE ccSolicitudDataCreditoUbica SET  " +
                                                ...
                                                " ,EMail1IND=@EMail1IND" +
                                                " ,EMail2IND=@EMail2IND" +
                                                ",TipoDirOtra=@TipoDirOtra"+
                                                ",TipoTelOtro=@TipoTelOtro"+
