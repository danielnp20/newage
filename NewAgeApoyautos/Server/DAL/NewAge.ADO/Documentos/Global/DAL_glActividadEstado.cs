    ...
    public class DAL_glActividadEstado : DAL_Base
    {
        ...
        public void DAL_glActividadEstado_Add(DTO_glActividadEstado act)
        {
            try
            {
                ...
                mySqlCommand.CommandText =
                    ...
                    "   FechaAlarma2, UsuarioAlarma2, FechaAlarma3, UsuarioAlarma3, UsuarioDelegado, Observaciones, ActividadBase, CerradoInd, AlarmaInd, eg_glActividadFlujo) " +
        ...
        public void DAL_glActividadEstado_UpdateAlarmStatus(int numeroDoc, string actividadFlujoID, bool enable, DTO_glActividadEstado act)
        {
            try
            {
                ...
                string set = " Set CerradoInd=@CerradoInd,AlarmaInd=@AlarmaInd,FechaInicio=@FechaInicio,FechaFin=@FechaFin ";
                ...
                if (enable)
                {
                    ...
                    mySqlCommandSel.Parameters["@FechaInicio"].Value =DateTime.Now;
            ...
            DateTime? fechaFin, string terceroID, string prefijoID, int? docNro, EstadoTareaIncumplimiento estadoTarea)
        {
            try
            {
                ...
                "        actEst.FechaInicio, actEst.FechaFin, actEst.FechaCerrado,  actEst.FechaAlarma1, actEst.Observaciones,actEst.CerradoInd," +
        ...
        public string DAL_glActividadEstado_GetStatedbyNumeroDoc(string _numeroLibranza)
        {
            try
            {
                ...
                "   SELECT TOP(1)  CASE WHEN ac.CerradoInd = 0 THEN FLJ.Descriptivo ELSE 'Liquidado' END AS EstadoSol FROM  " +
                "   (  " +
                "   	SELECT * FROM  " +
                "   	(  " +
                "   		SELECT TOP(1) est.*  " +
