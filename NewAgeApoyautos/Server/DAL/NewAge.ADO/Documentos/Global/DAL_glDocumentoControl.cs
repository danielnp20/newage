...
namespace NewAge.ADO
{
    ...
    public class DAL_glDocumentoControl : DAL_Base
    {
        ...
        public List<DTO_glDocumentoControl> DAL_glDocumentoControl_GetByMigracionNomina(int documentID, DateTime periodo, string centroPagoID)
        {
            try
            {
                ...
                mySqlCommand.Parameters.Add("@DocumentoID", SqlDbType.Int);
                mySqlCommand.Parameters.Add("@PeriodoDoc", SqlDbType.SmallDateTime);
                mySqlCommand.Parameters.Add("@CentroPagoID", SqlDbType.VarChar, UDT_CentroPagoID.MaxLength);
                ...
                mySqlCommand.CommandText =
                    ...
                    "from glDocumentoControl ctrl with(nolock) " +
                    "	left join ccNominaDeta deta with(nolock) on ctrl.NumeroDoc = deta.NumDocNomina and deta.CentroPagoID = @CentroPagoID " +
                    "	left join ccNominaPreliminar pre with(nolock) on ctrl.NumeroDoc = pre.NumDocNomina and pre.CentroPagoID = @CentroPagoID " +
