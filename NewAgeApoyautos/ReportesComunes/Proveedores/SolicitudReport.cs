...
{
    public partial class SolicitudReport : BaseCommonReport
    {
        #region Variables
        ...
        public SolicitudReport(int docId, List<DTO_ReportSolicitud> documentoData,  ArrayList detailFieldList, CommonReportDataSupplier supplier)
            : base(supplier)
        {
            ...
            for (int i = 0; i < documentoData.Count; i++)
            {
                ...
                documentoHeaderTableCell_Name.Text = "Solicitud";//base._dataSupplier.GetResource(Librerias.Project.LanguageTypes.Forms, docID.ToString() + "_Para");
                ...
                documentoHeaderTableCell_Value.DataBindings.Add("Text", documentoData[i].Header, "Solicitud");
                ...
                documentoHeaderTableCell_Name.Font = new Font("Arial", 9);
                documentoHeaderTableCell_Name.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft;
                documentoHeaderTableCell_Name.Text = "Digitador";//base._dataSupplier.GetResource(Librerias.Project.LanguageTypes.Forms, docID.ToString() + "_Fecha");
                documentoHeaderTableRow.Cells.Add(documentoHeaderTableCell_Name);
                ...
                documentoHeaderTableCell_Value.DataBindings.Add("Text", documentoData[i].Header, "Digitador");
                documentoHeaderTableRow.Cells.Add(documentoHeaderTableCell_Value);
                ...
                documentoHeaderTableCell_Name.Font = new Font("Arial", 9);
                documentoHeaderTableCell_Name.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft;
                documentoHeaderTableCell_Name.Text = "Estado";//base._dataSupplier.GetResource(Librerias.Project.LanguageTypes.Forms, docID.ToString() + "_Fecha");
                documentoHeaderTableRow.Cells.Add(documentoHeaderTableCell_Name);

                documentoHeaderTableCell_Value = new XRTableCell();
                documentoHeaderTableCell_Value.WidthF = headerTableWidth;
                documentoHeaderTableCell_Value.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft;
                documentoHeaderTableCell_Value.DataBindings.Add("Text", documentoData[i].Header, "Estado");
                documentoHeaderTableRow.Cells.Add(documentoHeaderTableCell_Value);
                ...
                documentoHeaderTableCell_Name.Font = new Font("Arial", 10);
                documentoHeaderTableCell_Name.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft;
                documentoHeaderTableCell_Name.Text = "Solicitante";//base._dataSupplier.GetResource(Librerias.Project.LanguageTypes.Forms, docID.ToString() + "_Fecha");
                documentoHeaderTableRow.Cells.Add(documentoHeaderTableCell_Name);
                ...
                documentoHeaderTableCell_Value.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft;
                documentoHeaderTableCell_Value.DataBindings.Add("Text", documentoData[i].Header, "Solicitante");
                documentoHeaderTableRow.Cells.Add(documentoHeaderTableCell_Value);
            ...
            lblSolicita.Text = "PREAPROBADO POR ";
            ...
            XRLabel lblObservaciones = new XRLabel();
            lblObservaciones.LocationF = new PointF(30,590);
            lblObservaciones.SizeF = new SizeF(headerTableWidth / 3, 30);
            lblObservaciones.Font = new Font("Arial", 10);
            lblObservaciones.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft;
            lblObservaciones.Text = "OBSERVACIONES";
            documentFooterBand.Controls.Add(lblObservaciones);

            XRLabel lblObservaciones_blank = new XRLabel();
            lblObservaciones_blank.LocationF = new PointF(30, 410);
            lblObservaciones_blank.SizeF = new SizeF(headerTableWidth - 50, 200);
            lblObservaciones_blank.Borders = DevExpress.XtraPrinting.BorderSide.Bottom;
            documentFooterBand.Controls.Add(lblObservaciones_blank);
            ...
            foreach (string fieldName in detailFieldList)
            {
                ...
                string resourceFieldID = (AppReports.prSolicitudOld).ToString() + "_" + fieldName;
                ...
                if (fieldName.Contains("CodigoBSID"))
                {
                ...
                if (fieldName.Contains("Descripcion"))
                {
                    tableDetailCell.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
                    tableDetailCell.DataBindings.Add("Text", documentoData, "Detail." + fieldName);
                }
                if (fieldName.Contains("UnidadInv"))
                {
                    tableDetailCell.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
                    tableDetailCell.DataBindings.Add("Text", documentoData, "Detail." + fieldName);
                }
                if (fieldName.Contains("CantidadSol"))
                {
                    tableDetailCell.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
                    tableDetailCell.DataBindings.Add("Text", documentoData, "Detail." + fieldName);
                }
                if (fieldName.Contains("Proyecto"))
                {
                    tableDetailCell.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
                    tableDetailCell.DataBindings.Add("Text", documentoData, "Detail." + fieldName);
                }
                if (fieldName.Contains("CentroCosto"))
                {
                    tableDetailCell.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
                    tableDetailCell.DataBindings.Add("Text", documentoData, "Detail." + fieldName);
                }
