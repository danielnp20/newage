...
{
    public partial class NominaDetailExEReport : BaseCommonReport
    {
        #region Variables
        ...
        public NominaDetailExEReport(int docId, List<DTO_ReportNominaInfoEmpleado> documentoData, ArrayList detailFieldList, string reporteTipo, CommonReportDataSupplier supplier)
            : base(supplier)
        {
            ...
            //documentoBand.DataMember = "Detalles";
            ...
            for (int i = 0; i < documentoData.Count; i++)
            {
                ...
                documentoHeaderTableCell_Name.Font = new Font("Arial", 10);
                documentoHeaderTableCell_Name.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft;
                documentoHeaderTableCell_Name.Text = "Localidad ";
                //base._dataSupplier.GetResource(Librerias.Project.LanguageTypes.Forms, docID.ToString() + "_Para");
                documentoHeaderTableRow.Cells.Add(documentoHeaderTableCell_Name);
                ...
                documentoHeaderTableCell_Name.Font = new Font("Arial", 10);
                documentoHeaderTableCell_Name.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft;
                documentoHeaderTableCell_Name.Text = "Operacion ";
                //base._dataSupplier.GetResource(Librerias.Project.LanguageTypes.Forms, docID.ToString() + "_Para");
                documentoHeaderTableRow.Cells.Add(documentoHeaderTableCell_Name);
                ...
                documentoHeaderTableCell_Name.Font = new Font("Arial", 10);
                documentoHeaderTableCell_Name.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft;
                documentoHeaderTableCell_Name.Text = "C.Costo ";
                //base._dataSupplier.GetResource(Librerias.Project.LanguageTypes.Forms, docID.ToString() + "_Para");
                documentoHeaderTableRow.Cells.Add(documentoHeaderTableCell_Name);
                ...
                documentoHeaderTableCell_Name.Font = new Font("Arial", 10);
                documentoHeaderTableCell_Name.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft;
                documentoHeaderTableCell_Name.Text = "Fecha Inicial: ";
                documentoHeaderTableRow.Cells.Add(documentoHeaderTableCell_Name);
                ...
                documentoHeaderTableCell_Value.DataBindings.Add("Text", documentoData[i].FechaInicial, "FechaInicial");
                ...
                documentoHeaderTableCell_Name.Font = new Font("Arial", 10);
                documentoHeaderTableCell_Name.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft;
                documentoHeaderTableCell_Name.Text = "Fecha Final: ";
                documentoHeaderTableRow.Cells.Add(documentoHeaderTableCell_Name);

                documentoHeaderTableCell_Value = new XRTableCell();
                documentoHeaderTableCell_Value.WidthF = headerTableWidth / 8;
                documentoHeaderTableCell_Value.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft;
                documentoHeaderTableCell_Value.DataBindings.Add("Text", documentoData[i].FechaFinal, "FechaFinal");
                documentoHeaderTableRow.Cells.Add(documentoHeaderTableCell_Value);
            ...
            foreach (string fieldName in detailFieldList)
            {
                ...
                if (fieldName.Contains("Cédula"))
                {
                    ...
                    tableDetailCell.DataBindings.Add("Text", documentoData, "Detalles." + "EmpleadoID");
                }
                if (fieldName.Contains("Nombre"))
                {
                    tableDetailCell.WidthF = tableHeaderCell.WidthF / 5;
                    tableDetailCell.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft;
                    tableDetailCell.DataBindings.Add("Text", documentoData, "Detalles." + "EmpleadoDesc");
                }
                if (fieldName.Contains("Cuenta"))
                {
                    tableDetailCell.WidthF = tableHeaderCell.WidthF / 5;
                    tableDetailCell.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft;
                    //tableDetailCell. = "{0:#,0.00}";
                    tableDetailCell.DataBindings.Add("Text", documentoData, "Detalles." + fieldName, "$ {0:#,#}");
                }
