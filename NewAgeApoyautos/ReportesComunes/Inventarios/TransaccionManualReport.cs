...
{
    public partial class TransaccionManualReport : BaseCommonReport
    {
        #region Variables
        ...
        public TransaccionManualReport(int docId, List<DTO_ReportTransaccionManual> documentoData, ArrayList footerFieldList, ArrayList detailFieldList, CommonReportDataSupplier supplier)
            : base(supplier)
        {
            ...
            for (int i = 0; i < documentoData.Count; i++)
            {
                ...
                documentoHeaderTableCell_Name.Text = "Despachado A:";//base._dataSupplier.GetResource(Librerias.Project.LanguageTypes.Forms, docID.ToString() + "_Para");
                documentoHeaderTableRow.Cells.Add(documentoHeaderTableCell_Name);

                documentoHeaderTableCell_Value = new XRTableCell();
                documentoHeaderTableCell_Name.WidthF = headerTableWidth / 5;
                documentoHeaderTableCell_Name.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft;
                documentoHeaderTableCell_Value.DataBindings.Add("Text", documentoData[i].Header, "TerceroID");
                ...
                documentoHeaderTableCell_Name.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft;
                documentoHeaderTableCell_Name.Font = new Font("Arial", 10);
                documentoHeaderTableCell_Value.DataBindings.Add("Text", documentoData[i].Header, "EmpresaID");
                documentoHeaderTableRow.Cells.Add(documentoHeaderTableCell_Name);
                ...
                documentoHeaderTableCell_Name.Font = new Font("Arial", 10);
                documentoHeaderTableCell_Name.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft;
                documentoHeaderTableCell_Name.Text = "Centro Costo:";//base._dataSupplier.GetResource(Librerias.Project.LanguageTypes.Forms, docID.ToString() + "_Fecha");
                documentoHeaderTableRow.Cells.Add(documentoHeaderTableCell_Name);

                documentoHeaderTableCell_Value = new XRTableCell();
                documentoHeaderTableCell_Name.WidthF = headerTableWidth / 20 - 5;
                documentoHeaderTableCell_Name.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft;
                documentoHeaderTableCell_Value.DataBindings.Add("Text", documentoData[i].Header, "CentroCostoID");
                documentoHeaderTableRow.Cells.Add(documentoHeaderTableCell_Value);
                ...
                documentoHeaderTableCell_Value = new XRTableCell();
                documentoHeaderTableCell_Name.WidthF = headerTableWidth / 10;
                documentoHeaderTableCell_Name.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft;
                documentoHeaderTableCell_Value.DataBindings.Add("Text", documentoData[i].Header, "Descriptivo");
                documentoHeaderTableRow.Cells.Add(documentoHeaderTableCell_Value);
            ...
            lblSolicita.Text = "ENTREGADO POR ";
            ...
            foreach (string fieldName in detailFieldList)
            {
                ...
                if (fieldName.Contains("CantidadUni"))
                {
                    if (totalsInd == 0)
                    {
                        ...
                        totalFooterCell_Caption.Text = base._dataSupplier.GetResource(Librerias.Project.LanguageTypes.Forms, (AppForms.ReportForm).ToString() + "_Totals") + " x "+"CantidadUni";
                    ...
                    totalFooterCell_Value.DataBindings.Add("Text", documentoData, "Footer." + fieldName);
