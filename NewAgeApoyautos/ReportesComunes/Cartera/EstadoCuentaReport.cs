...
{
    public partial class EstadoCuentaReport : BaseCommonReport
    {
        #region Variables
        ...
        /// <summary>
        /// EstadoCuentaReport Constructor
        /// </summary>
        ...
        public EstadoCuentaReport(int docId, List<DTO_ReportEstadoCuenta> documentoData, ArrayList detailFieldList1, ArrayList detailFieldList2, CommonReportDataSupplier supplier)
            : base(supplier)
        {
            ...
            for (int i = 0; i < documentoData.Count; i++)
            {
                ...
                documentoHeaderTableCell_Name.Font = new Font("Arial", 8, FontStyle.Bold);
                documentoHeaderTableCell_Name.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft;
                documentoHeaderTableCell_Name.Text = "Otros1: ";//base._dataSupplier.GetResource(Librerias.Project.LanguageTypes.Forms, docID.ToString() + "_Fecha");
                documentoHeaderTableRow.Cells.Add(documentoHeaderTableCell_Name);
                ...
                documentoHeaderTableCell_Value.DataBindings.Add("Text", documentoData[i].Header, "VrOtrosMes1", "{0:C0}");
                documentoHeaderTableRow.Cells.Add(documentoHeaderTableCell_Value);
                ...
                documentoHeaderTableCell_Value.Font = new Font("Arial", 8);
                documentoHeaderTableCell_Value.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft;
                documentoHeaderTableCell_Value.DataBindings.Add("Text", documentoData[i].Header, "VrOtros1", "{0:C0}");
                documentoHeaderTableRow.Cells.Add(documentoHeaderTableCell_Value);
                ...
                documentoHeaderTableCell_Name.Font = new Font("Arial", 8, FontStyle.Bold);
                documentoHeaderTableCell_Name.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft;
                documentoHeaderTableCell_Name.Text = "Libranza: ";//base._dataSupplier.GetResource(Librerias.Project.LanguageTypes.Forms, docID.ToString() + "_Para");
                documentoHeaderTableRow.Cells.Add(documentoHeaderTableCell_Name);
                ...
                documentoHeaderTableCell_Name.Font = new Font("Arial", 8, FontStyle.Bold);
                documentoHeaderTableCell_Name.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft;
                documentoHeaderTableCell_Name.Text = "Numero Cuotas ";//base._dataSupplier.GetResource(Librerias.Project.LanguageTypes.Forms, docID.ToString() + "_Fecha");
                documentoHeaderTableRow.Cells.Add(documentoHeaderTableCell_Name);
                ...
                documentoHeaderTableCell_Name.Font = new Font("Arial", 8, FontStyle.Bold);
                documentoHeaderTableCell_Name.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft;
                documentoHeaderTableCell_Name.Text = "Otros 2:";//base._dataSupplier.GetResource(Librerias.Project.LanguageTypes.Forms, docID.ToString() + "_Para");
                documentoHeaderTableRow.Cells.Add(documentoHeaderTableCell_Name);
                ...
                documentoHeaderTableCell_Value.Font = new Font("Arial", 8);
                documentoHeaderTableCell_Value.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
                documentoHeaderTableCell_Value.DataBindings.Add("Text", documentoData[i].Header, "VrOtrosMes2", "{0:C0}");
                documentoHeaderTableRow.Cells.Add(documentoHeaderTableCell_Value);
                ...
                documentoHeaderTableCell_Value.Font = new Font("Arial", 8);
                documentoHeaderTableCell_Value.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft;
                documentoHeaderTableCell_Value.DataBindings.Add("Text", documentoData[i].Header, "VrOtros2", "{0:C0}");
                documentoHeaderTableRow.Cells.Add(documentoHeaderTableCell_Value);
                ...
                documentoHeaderTableCell_Name.Font = new Font("Arial", 8, FontStyle.Bold);
                documentoHeaderTableCell_Name.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft;
                documentoHeaderTableCell_Name.Text = "Pagaduria ";//base._dataSupplier.GetResource(Librerias.Project.LanguageTypes.Forms, docID.ToString() + "_Fecha");
                documentoHeaderTableRow.Cells.Add(documentoHeaderTableCell_Name);

                documentoHeaderTableCell_Value = new XRTableCell();
                documentoHeaderTableCell_Value.WidthF = tableWidth1 / 4;
                documentoHeaderTableCell_Value.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft;
                documentoHeaderTableCell_Value.DataBindings.Add("Text", documentoData[i].Header, "Pagaduria");
                documentoHeaderTableCell_Value.Font = new Font("Arial", 8);
                documentoHeaderTableRow.Cells.Add(documentoHeaderTableCell_Value);
                ...
                documentoHeaderTableCell_Name.Font = new Font("Arial", 8, FontStyle.Bold);
                documentoHeaderTableCell_Name.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft;
                documentoHeaderTableCell_Name.Text = "Interes ";//base._dataSupplier.GetResource(Librerias.Project.LanguageTypes.Forms, docID.ToString() + "_Fecha");
                documentoHeaderTableRow.Cells.Add(documentoHeaderTableCell_Name);

                documentoHeaderTableCell_Value = new XRTableCell();
                documentoHeaderTableCell_Value.WidthF = tableWidth1 / 4;
                documentoHeaderTableCell_Value.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft;
                documentoHeaderTableCell_Value.DataBindings.Add("Text", documentoData[i].Header, "Interes", "{0:C0}");
                documentoHeaderTableCell_Value.Font = new Font("Arial", 8);
                documentoHeaderTableRow.Cells.Add(documentoHeaderTableCell_Value);
                ...
                documentoHeaderTableCell_Name.Font = new Font("Arial", 8, FontStyle.Bold);
                documentoHeaderTableCell_Name.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft;
                documentoHeaderTableCell_Name.Text = "Otros 3: ";//base._dataSupplier.GetResource(Librerias.Project.LanguageTypes.Forms, docID.ToString() + "_Fecha");
                documentoHeaderTableRow.Cells.Add(documentoHeaderTableCell_Name);
                ...
                documentoHeaderTableCell_Value.Font = new Font("Arial", 8);
                documentoHeaderTableCell_Value.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
                documentoHeaderTableCell_Value.DataBindings.Add("Text", documentoData[i].Header, "VrOtrosMes3", "{0:C0}");
                documentoHeaderTableRow.Cells.Add(documentoHeaderTableCell_Value);
                ...
                documentoHeaderTableCell_Value.Font = new Font("Arial", 8);
                documentoHeaderTableCell_Value.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft;
                documentoHeaderTableCell_Value.DataBindings.Add("Text", documentoData[i].Header, "VrOtros3", "{0:C0}");
                documentoHeaderTableRow.Cells.Add(documentoHeaderTableCell_Value);
                ...
                documentoHeaderTableCell_Name.Font = new Font("Arial", 8, FontStyle.Bold);
                documentoHeaderTableCell_Name.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft;
                documentoHeaderTableCell_Name.Text = "TOTAL";//base._dataSupplier.GetResource(Librerias.Project.LanguageTypes.Forms, docID.ToString() + "_Fecha");
                documentoHeaderTableRow.Cells.Add(documentoHeaderTableCell_Name);
                ...
                documentoHeaderTableCell_Value.Font = new Font("Arial", 8);
                documentoHeaderTableCell_Value.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft;
                documentoHeaderTableCell_Value.DataBindings.Add("Text", documentoData[i].Header, "TotalOtros", "{0:C0}");
                documentoHeaderTableRow.Cells.Add(documentoHeaderTableCell_Value);
                ...
                lblAprobado_blank.SizeF = new SizeF(tableWidth1, 50);
                ...
                documentoHeaderTableCell_Name.Font = new Font("Arial", 8, FontStyle.Bold);
                documentoHeaderTableCell_Name.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft;
                documentoHeaderTableCell_Name.Text = "Vlr. Cédito ";//base._dataSupplier.GetResource(Librerias.Project.LanguageTypes.Forms, docID.ToString() + "_Fecha");
                documentoHeaderTableRow.Cells.Add(documentoHeaderTableCell_Name);
                ...
                documentoHeaderTableCell_Name.Font = new Font("Arial", 8, FontStyle.Bold);
                documentoHeaderTableCell_Name.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft;
                documentoHeaderTableCell_Name.Text = "Vlr. Solicitado ";//base._dataSupplier.GetResource(Librerias.Project.LanguageTypes.Forms, docID.ToString() + "_Fecha");
                documentoHeaderTableRow.Cells.Add(documentoHeaderTableCell_Name);
                ...
                documentoHeaderTableCell_Name.Font = new Font("Arial", 8, FontStyle.Bold);
                documentoHeaderTableCell_Name.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft;
                documentoHeaderTableCell_Name.Text = "Vlr. Adicional";//base._dataSupplier.GetResource(Librerias.Project.LanguageTypes.Forms, docID.ToString() + "_Fecha");
                documentoHeaderTableRow.Cells.Add(documentoHeaderTableCell_Name);
                ...
                documentoHeaderTableCell_Name.Font = new Font("Arial", 8, FontStyle.Bold);
                documentoHeaderTableCell_Name.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft;
                documentoHeaderTableCell_Name.Text = "Vlr. Descuento";//base._dataSupplier.GetResource(Librerias.Project.LanguageTypes.Forms, docID.ToString() + "_Fecha");
                documentoHeaderTableRow.Cells.Add(documentoHeaderTableCell_Name);
                ...
                documentoHeaderTableCell_Name.Font = new Font("Arial", 8, FontStyle.Bold);
                documentoHeaderTableCell_Name.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft;
                documentoHeaderTableCell_Name.Text = "Vlr. Libranza ";//base._dataSupplier.GetResource(Librerias.Project.LanguageTypes.Forms, docID.ToString() + "_Fecha");
                documentoHeaderTableRow.Cells.Add(documentoHeaderTableCell_Name);

                documentoHeaderTableCell_Value = new XRTableCell();
                documentoHeaderTableCell_Value.WidthF = tableWidth1;
                documentoHeaderTableCell_Value.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft;
                documentoHeaderTableCell_Value.DataBindings.Add("Text", documentoData[i].Header, "VrLibranza", "{0:C0}");
                documentoHeaderTableCell_Value.Font = new Font("Arial", 8);
                documentoHeaderTableRow.Cells.Add(documentoHeaderTableCell_Value);
            ...
            lblHeaderContab.Text = "SALDO";
            documentoHeader2.Controls.Add(lblHeaderContab);
            
            #region Documento footer
            //List<DTO_ReportEstadoCuentaDetail> detalle = new List<DTO_ReportEstadoCuentaDetail>();
            //foreach (DTO_ReportEstadoCuenta item in documentoData)
            //{
            //    detalle = item.Detail;
            //}
            //decimal devengos = 0;
