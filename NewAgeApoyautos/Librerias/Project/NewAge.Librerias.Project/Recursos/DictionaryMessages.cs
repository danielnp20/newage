...
namespace NewAge.Librerias.Project
{
    ...
    public static class DictionaryMessages
    {
        ...
        /// <summary>
        /// "El centro de pago no corresponde con el de la libranza"
        /// </summary>
        public static string Err_Cc_InvalidCentroPagoLibranza = "ERR_cc_InvalidCentroPagoLibranza";
        ...
        /// "No coincide "
        /// </summary>
        public static string NoCoincide = "msg_noCoincide";
        ...
        /// <summary>
        /// "Se guardó con éxito la solicitud número: {0}"
        /// </summary>
        public static string Dr_SolicitudGuardada = "msg_dr_SolicitudGuardada";
