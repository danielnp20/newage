...
namespace NewAge.DTO.Negocio
{
    [DataContract]
    [Serializable]
    public class DTO_ReportFacturasXPagar
    {
        #region Contructor
        /// <summary>
        ...
        /// </summary>
        /// <param name="?"></param>
        public DTO_ReportFacturasXPagar(IDataReader dr)
        {
            this.InitCols();
            try
            {
                ...
                if (!string.IsNullOrEmpty(dr["FactEquivalente"].ToString()))
        ...
        /// </summary>
        public DTO_ReportFacturasXPagar()
        {
            this.InitCols();
        }
