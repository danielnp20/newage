...
namespace NewAge.DTO.Negocio
{
    /// <summary>
    /// Class Error:
    /// Models DTO_drMoraOblVigentes
    /// </summary>
    [DataContract]
    [Serializable]
    public class DTO_drMoraOblVigentes : DTO_MasterBasic
    {
        #region drMoraOblVigentes
        /// <summary>
        /// Constuye el DTO a partir de un resultado de base de datos
        /// </summary>
        /// <param name="?"></param>
        public DTO_drMoraOblVigentes(IDataReader dr, DTO_aplMaestraPropiedades mp, bool isReplica)
            : base(dr, mp)
        {
            InitCols();
            try
        ...
        public DTO_drMoraOblVigentes(DTO_MasterBasic basic)
            : base(basic)
        {
            InitCols();
        }

        public DTO_drMoraOblVigentes(DTO_aplMaestraPropiedades masterProperties)
