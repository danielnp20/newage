...
namespace NewAge.DTO.Negocio
{
    /// <summary>
    /// Class Error:
    /// Models DTO_drRepNegRecuperado
    /// </summary>
    [DataContract]
    [Serializable]
    public class DTO_drRepNegRecuperado : DTO_MasterBasic
    {
        #region drRepNegRecuperado
        /// <summary>
        /// Constuye el DTO a partir de un resultado de base de datos
        /// </summary>
        /// <param name="?"></param>
        public DTO_drRepNegRecuperado(IDataReader dr, DTO_aplMaestraPropiedades mp, bool isReplica)
            : base(dr, mp)
        {
            InitCols();
            try
        ...
        public DTO_drRepNegRecuperado(DTO_MasterBasic basic)
            : base(basic)
        {
            InitCols();
        }

        public DTO_drRepNegRecuperado(DTO_aplMaestraPropiedades masterProperties)
