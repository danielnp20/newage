...
namespace NewAge.DTO.Negocio
{
    /// <summary>
    /// Class Error:
    /// Models DTO_pyTareaCapitulo
    /// </summary>
    [DataContract]
    [Serializable]
    public class DTO_pyTareaCapitulo : DTO_MasterBasic
    {
        ...
        /// </summary>
        /// <param name="?"></param>
        public DTO_pyTareaCapitulo(IDataReader dr, DTO_aplMaestraPropiedades mp, bool isReplica)
            : base(dr, mp)
        {
            InitCols();
            try
        ...
        public DTO_pyTareaCapitulo(DTO_MasterBasic basic)
            : base(basic)
        {
            InitCols();
        }

        public DTO_pyTareaCapitulo(DTO_aplMaestraPropiedades masterProperties)
