...
namespace NewAge.DTO.Negocio
{
    /// <summary>
    /// Class Error:
    /// Models tsBancosDatosPE
    /// </summary>  
    [DataContract]
    [Serializable]
    public class DTO_tsBancosDatosPE : DTO_MasterComplex
    {
        #region DTO_tsBancosDatosPE
        /// <summary>
        /// Constuye el DTO a partir de un resultado de base de datos
        /// </summary>
        /// <param name="?"></param>
        public DTO_tsBancosDatosPE(IDataReader dr, DTO_aplMaestraPropiedades mp, bool isReplica)
            : base(dr, mp)
        {
            InitCols();
            try
        ...
        public DTO_tsBancosDatosPE(DTO_MasterComplex basic)
            : base(basic)
        {
            InitCols();
        }

        public DTO_tsBancosDatosPE(DTO_aplMaestraPropiedades masterProperties)
