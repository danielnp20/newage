...
namespace NewAge.DTO.Negocio
{
    /// <summary>
    /// Class Error:
    /// Models DTO_tsBancoCierrePE
    /// </summary>  
    [DataContract]
    [Serializable]
    public class DTO_tsBancoCierrePE : DTO_MasterComplex
    {
        #region DTO_tsBancoCierrePE
        /// <summary>
        /// Constuye el DTO a partir de un resultado de base de datos
        /// </summary>
        /// <param name="?"></param>
        public DTO_tsBancoCierrePE(IDataReader dr, DTO_aplMaestraPropiedades mp, bool isReplica)
            : base(dr, mp)
        {
            InitCols();
            try
        ...
        public DTO_tsBancoCierrePE(DTO_MasterComplex basic)
            : base(basic)
        {
            InitCols();
        }

        public DTO_tsBancoCierrePE(DTO_aplMaestraPropiedades masterProperties)
