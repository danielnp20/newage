...
{
    /// <summary>
    /// Models DTO_coReclasificaBalExcluye
    /// </summary>
    [DataContract]
    [Serializable]
    public class DTO_coReclasificaBalExcluye
    {
        #region DTO_coReclasificaBalExcluye

        /// <summary>
        /// Constuye el DTO a partir de un resultado de base de datos
        /// </summary>
        /// <param name="?"></param>
        public DTO_coReclasificaBalExcluye(IDataReader dr)
        {
            InitCols();
            try
            {
        ...
        /// </summary>
        public DTO_coReclasificaBalExcluye()
        {
            this.InitCols();
        }
