...
{
    public partial class NominaDetailExCReport : BaseCommonReport
    {
        #region Variables
        ...
        public NominaDetailExCReport(int docId, List<DTO_ReportNominaDetalleCxE> documentoData, ArrayList detailFieldList, string reporteTipo, CommonReportDataSupplier supplier)
            : base(supplier)
        {
            ...
            for (int i = 0; i < documentoData.Count; i++)
            {
                switch (reporteTipo)
                {
                    case "Det.Empleado Concepto":
                        ...
                        documentoHeaderTableCell_Value.DataBindings.Add("Text", documentoData[i].Header, "FechaInicial","{0:dd/MMM/yyyy}");
                        ...
                        documentoHeaderTableCell_Value.WidthF = headerTableWidth / 4;
                        documentoHeaderTableCell_Value.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft;
                        documentoHeaderTableCell_Value.DataBindings.Add("Text", documentoData[i].Header, "FechaFinal","{0:dd/MMM/yyyy}");
                        documentoHeaderTableRow.Cells.Add(documentoHeaderTableCell_Value);
                        ...
                        documentoHeaderTableCell_Value.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft;
                        documentoHeaderTableCell_Value.DataBindings.Add("Text", documentoData[i].Header, "Localidad");
                        documentoHeaderTableRow.Cells.Add(documentoHeaderTableCell_Value);
                        ...
                        break;
                    case "Det.Empleado Empleado":
                        #region ExE

                        #endregion
                        break;
                    case "Resumido X Concepto":

                        break;
                    case "Resumido X Empleado":

                        break;
                    case "Resumido X Otros":
                ...
                switch (reporteTipo)
                {
                    case "Det.Empleado Concepto":
                        ...
                        if (fieldName.Contains("Cédula"))
                        {
                            ...
                            tableDetailCell.DataBindings.Add("Text", documentoData, "Detail." + "Cedula");
                        }
