...
{
    public partial class Report_Cc_CertificadoRelacionPagos : XtraReport
    {        
        #region Variables
        decimal total = 0;
        ...
        public Report_Cc_CertificadoRelacionPagos()
        {
          //  this.InitializeComponent();
        }

        public Report_Cc_CertificadoRelacionPagos(DTO_glEmpresa emp)
        {
            this.InitializeComponent();
            this._empresa = emp;
        }
        ...
        public Report_Cc_CertificadoRelacionPagos(string loggerConn, SqlConnection conn, SqlTransaction tx, DTO_glEmpresa emp, int userID, ExportFormatType formatType, int? numDoc = null)
        {
            InitializeComponent();
