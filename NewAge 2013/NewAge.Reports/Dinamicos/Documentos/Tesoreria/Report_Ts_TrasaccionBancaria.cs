...
{
    public partial class Report_Ts_TransaccionBancaria : XtraReport
    {
        decimal total = 0;
        ...
        public Report_Ts_TransaccionBancaria()
        {
        }

        public Report_Ts_TransaccionBancaria(DTO_glEmpresa emp)
        {
            this.InitializeComponent();
            this._empresa = emp;
        }

        public Report_Ts_TransaccionBancaria(string loggerConn, SqlConnection conn, SqlTransaction tx, DTO_glEmpresa emp, int userID, ExportFormatType formatType, int? numDoc = null)
        {
            InitializeComponent();
            ...
            //this.lblReportName.Text = this._moduloGlobal.GetResource(LanguageTypes.Forms, "36_TransaccionBancaria");
        } 
        #endregion
        ...
        /// <summary>
        /// Asigna el valor total por reporte
        /// </summary>
        ...
        private void xrLabel4_SummaryCalculated(object sender, TextFormatEventArgs e)
        {
            if (e.Value != null)
            {
                this.total = Convert.ToDecimal(e.Value);
                totalLetras.Text = CurrencyFormater.GetCurrencyString("ES1", "COP", this.total);
