...
{
    public partial class Report_Pr_OrdenCompraQuantum : XtraReport
    {
        ...
        public Report_Pr_OrdenCompraQuantum()
        {
          //  this.InitializeComponent();
        }

        public Report_Pr_OrdenCompraQuantum(DTO_glEmpresa emp)
        {
            this.InitializeComponent();
            this._empresa = emp;
        }
        ...
        public Report_Pr_OrdenCompraQuantum(string loggerConn, SqlConnection conn, SqlTransaction tx, DTO_glEmpresa emp, int userID, ExportFormatType formatType, int? numDoc = null)
        {
            InitializeComponent();
        ...
        protected virtual void SetInitParameters()
        {
            ...
            try
            {
                ...
                this.imageLogo.Image = logoImage;
            }
            catch (Exception ex)
            { }
        ...
        /// </summary>
        public string GenerateReport(int numeroDoc, bool isPreliminar)
        {
            try
            {
                ...
                List<DTO_ProveedoresTotal> data = _moduloProveedores.ReportesProveedores_OrdenCompra(numeroDoc);
