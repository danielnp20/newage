...
{
    public partial class Report_Cc_AmortizaDerechoDetalle : ReportBaseLandScape
    {
        #region Variables
        #endregion
        public Report_Cc_AmortizaDerechoDetalle()
        {
            
        }

        public Report_Cc_AmortizaDerechoDetalle(string loggerConn, SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, ExportFormatType formatType)
            : base(loggerConn, c, tx, empresa, userId, formatType)
        {
            this.lblReportName.Text = this._moduloGlobal.GetResource(LanguageTypes.Forms, "35105_AmortizaDerechoDetalle");          
        }
