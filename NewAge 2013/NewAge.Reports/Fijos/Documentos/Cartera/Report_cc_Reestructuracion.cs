...
{
    public partial class Report_cc_Reestructuracion : ReportBase
    {
        #region Variables
        #endregion
        public Report_cc_Reestructuracion()
        {
            
        }

        public Report_cc_Reestructuracion(string loggerConn, SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, ExportFormatType formatType)
            : base(loggerConn, c, tx, empresa, userId, formatType)
        {
            this.lblReportName.Text = this._moduloGlobal.GetResource(LanguageTypes.Forms, "Reestructuracion");          
        }
