        ...
        {            
            try
            {
                ...
                else if (tipoRep == 2)
                {
                    ...
                    this.tblCellFecha.DataBindings.Clear();
                    this.tblCellFecha.DataBindings.AddRange(new DevExpress.XtraReports.UI.XRBinding[] { new DevExpress.XtraReports.UI.XRBinding("Text", null, "Cartera_ReporteGestionDiariaCobranza.fecha", "{0:MM}") });
