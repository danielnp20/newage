...
{
    public partial class Report_Cc_DetalleSaldo : ReportBase
    {
        ...
        #endregion
        public Report_Cc_DetalleSaldo()
        {
            
        }

        public Report_Cc_DetalleSaldo(string loggerConn, SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, ExportFormatType formatType)
        ...
        public string GenerateReport(DateTime? fechaIni,  string compCartera, string cliente, int? libranza,int? agrupamiento)
        {
            try
            {
                ...
                this.QueriesDatasource.Queries[0].Parameters[3].Value = !string.IsNullOrEmpty(libranza.ToString()) ? libranza : null;                
                this.QueriesDatasource.Queries[0].Parameters[4].Value = fechaIni;
                this.QueriesDatasource.Queries[0].Parameters[5].Value = agrupamiento;
                #endregion        
