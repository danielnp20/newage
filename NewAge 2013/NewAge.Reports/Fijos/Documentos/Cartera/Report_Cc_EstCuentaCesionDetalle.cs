...
{
    public partial class Report_Cc_EstCuentaCesionDetalle : ReportBaseLandScape
    {
        #region Variables
        #endregion
        public Report_Cc_EstCuentaCesionDetalle()
        {
            
        }

        public Report_Cc_EstCuentaCesionDetalle(string loggerConn, SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, ExportFormatType formatType)
            : base(loggerConn, c, tx, empresa, userId, formatType)
        {
            this.lblReportName.Text = this._moduloGlobal.GetResource(LanguageTypes.Forms, "35105_EstCuentaCesionDetalle");          
        }
