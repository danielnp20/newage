...
{
    public partial class Report_Cc_EstadisticoGestDetallado : ReportBase
    {
        #region Variables
        ...
        #endregion 
        public Report_Cc_EstadisticoGestDetallado()
        {
            
        }

        public Report_Cc_EstadisticoGestDetallado(string loggerConn, SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, ExportFormatType formatType)
        ...
        /// </summary>
        public string GenerateReport(DateTime fechaCorte, string etapa,bool excluyeDemanda)
        {
            try
            {
                ...
                this.QueriesDatasource.Queries[0].Parameters[3].Value = excluyeDemanda;
                #endregion        
