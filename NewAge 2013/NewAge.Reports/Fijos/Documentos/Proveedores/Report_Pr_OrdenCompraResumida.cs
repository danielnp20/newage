...
{
    public partial class Report_Pr_OrdenCompraResumida : ReportBase
    {
        /// <summary>
        /// Contructor por defecto
        /// </summary>
        public Report_Pr_OrdenCompraResumida()
        {
        ...
        public Report_Pr_OrdenCompraResumida(string loggerConn, SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, ExportFormatType formatType)
            : base(loggerConn, c, tx, empresa, userId, formatType)
        {
            this.lblReportName.Text = this._moduloGlobal.GetResource(LanguageTypes.Forms, "Orden Compra Resumida x Proveedor");
        ...
        /// </summary>
        public DTO_TxResult GenerateReport(DateTime FechaIni, DateTime FechaFin, string Proveedor, Dictionary<int, string> filtros, bool isDetallado, string Moneda)
        {
            try
            {
                ...
                List<DTO_ProveedoresTotal> data = _moduloProveedores.ReportesProveedores_OrdenCompraArchivo(FechaIni, FechaFin, Proveedor, filtros, isDetallado, Moneda);
                if (data.Count != 0)
                {
