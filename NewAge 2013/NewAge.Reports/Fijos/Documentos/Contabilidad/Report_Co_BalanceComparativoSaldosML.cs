...
{
    public partial class Report_Co_BalanceComparativoSaldosML : ReportBase
    {
        public Report_Co_BalanceComparativoSaldosML()
        {

        }

        public Report_Co_BalanceComparativoSaldosML(string loggerConn, SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, ExportFormatType formatType)
