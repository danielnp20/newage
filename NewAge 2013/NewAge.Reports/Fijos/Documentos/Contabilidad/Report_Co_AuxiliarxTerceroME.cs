...
{
    public partial class Report_Co_AuxiliarxTerceroME : ReportBase
    {
        public Report_Co_AuxiliarxTerceroME()
        {

        }

        public Report_Co_AuxiliarxTerceroME(string loggerConn, SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, ExportFormatType formatType)
            ...
            string tercero, string proyecto, string centroCosto, string lineaPresupuestal)
        {
            ...
            List<DTO_ReportLibroDiarioTotales> data = _moduloContabilidad.ReportesContabilidad_AuxiliarxTercero( fechaInicial,  fechaFinal, libro, cuentaInicial, cuentaFin,
