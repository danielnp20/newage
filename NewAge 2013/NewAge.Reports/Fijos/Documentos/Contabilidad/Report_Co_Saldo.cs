...
{
    public partial class Report_Co_Saldo : ReportBase
    {
        public Report_Co_Saldo()
        {

        }

        public Report_Co_Saldo(string loggerConn, SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, ExportFormatType formatType)
