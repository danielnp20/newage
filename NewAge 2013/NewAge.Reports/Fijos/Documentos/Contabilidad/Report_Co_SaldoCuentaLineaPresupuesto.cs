...
{
    public partial class Report_Co_SaldoCuentaLineaPresupuesto : ReportBase
    {
        public Report_Co_SaldoCuentaLineaPresupuesto()
        {

        }

        public Report_Co_SaldoCuentaLineaPresupuesto(string loggerConn, SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, ExportFormatType formatType)
