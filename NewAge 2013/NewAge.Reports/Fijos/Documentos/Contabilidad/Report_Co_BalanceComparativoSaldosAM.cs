...
{
    public partial class Report_Co_BalanceComparativoSaldosAM : ReportBase
    {
        public Report_Co_BalanceComparativoSaldosAM()
        {

        }

        public Report_Co_BalanceComparativoSaldosAM(string loggerConn, SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, ExportFormatType formatType)
