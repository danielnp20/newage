...
{
    public partial class Report_Co_SaldoTerceroCentroCosto : ReportBase
    {
        public Report_Co_SaldoTerceroCentroCosto()
        {

        }

        public Report_Co_SaldoTerceroCentroCosto(string loggerConn, SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, ExportFormatType formatType)
