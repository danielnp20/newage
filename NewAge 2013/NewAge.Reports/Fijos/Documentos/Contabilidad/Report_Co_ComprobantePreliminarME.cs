...
{
    public partial class Report_Co_ComprobantePreliminarME : ReportBase
    {
        public Report_Co_ComprobantePreliminarME()
        {

        }

        public Report_Co_ComprobantePreliminarME(string loggerConn, SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, ExportFormatType formatType)
