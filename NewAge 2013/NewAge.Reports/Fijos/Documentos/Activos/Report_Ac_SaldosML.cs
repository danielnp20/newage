...
{
    public partial class Report_Ac_SaldosML : ReportBase
    {
         public Report_Ac_SaldosML()
        {

        }

         public Report_Ac_SaldosML(string loggerConn, SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, ExportFormatType formatType)
            : base(loggerConn, c, tx, empresa, userId, formatType)
        {
            ...
            this.xrLblLocal.Text = this._moduloGlobal.GetResource(LanguageTypes.Forms, "35087_Local");
        }
