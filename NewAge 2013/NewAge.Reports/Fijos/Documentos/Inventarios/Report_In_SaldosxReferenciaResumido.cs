...
{
    public partial class Report_In_SaldosxReferenciaResumido : ReportBase
    {
        public Report_In_SaldosxReferenciaResumido()
        {

        }

        public Report_In_SaldosxReferenciaResumido(string loggerConn, SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, ExportFormatType formatType)
            : base(loggerConn, c, tx, empresa, userId, formatType)
        {
            ...
            this.xrLblTitle.Text = this._moduloGlobal.GetResource(LanguageTypes.Forms, "35071_SaldosResumenxReferencia");
