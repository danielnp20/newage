...
{
    public partial class Report_In_KardexSinParametros : ReportBase
    {
        public Report_In_KardexSinParametros()
        {

        }

        public Report_In_KardexSinParametros(string loggerConn, SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, ExportFormatType formatType)
            : base(loggerConn, c, tx, empresa, userId, formatType)
        {
            ...
            this.xrLblTitle.Text = this._moduloGlobal.GetResource(LanguageTypes.Forms, "35071_Kardex");
                    ...
                    string referencia, string grupo, string clase, string tipo, string serie, string material, bool isSerial)
        {
            ...
            List<DTO_ReportInventariosSaldosTotal> data = _moduloInventarios.ReportesInventarios_SaldosSinParametros(año, mesIni, bodega, tipoBodega, referencia,
