...
{
    public partial class Report_In_KardexxReferencia : ReportBase
    {
        public Report_In_KardexxReferencia()
        {

        }

        public Report_In_KardexxReferencia(string loggerConn, SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, ExportFormatType formatType)
