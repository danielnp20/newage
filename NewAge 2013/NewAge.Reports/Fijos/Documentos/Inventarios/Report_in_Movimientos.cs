...
{
    public partial class Report_in_Movimientos : ReportBase
    {
        /// <summary>
        /// Constructor por defecto
        /// </summary>
        public Report_in_Movimientos()
        {

        }

        public Report_in_Movimientos(string loggerConn, SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, ExportFormatType formatType)
