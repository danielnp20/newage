...
{
    public partial class Report_In_SaldosxReferencia : ReportBase
    {
        public Report_In_SaldosxReferencia()
        {

        }

        public Report_In_SaldosxReferencia(string loggerConn, SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, ExportFormatType formatType)
                    ...
                    string referencia, string grupo, string clase, string tipo, string serie, string material, bool isSerial, string Libro)
        {
            ...
            List<DTO_ReportInventariosSaldosTotal> data = _moduloInventarios.ReportesInventarios_SaldosxReferencia(año, mesIni, bodega, tipoBodega, referencia,
