...
{
    public partial class Report_In_Saldos : ReportBase
    {
        public Report_In_Saldos()
        {

        }

        public Report_In_Saldos(string loggerConn, SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, ExportFormatType formatType)
                    ...
                    string referencia, string grupo, string clase, string tipo, string serie, string material, bool isSerial, string Libro)
        {
            ...
            List<DTO_ReportInventariosSaldosTotal> data = _moduloInventarios.ReportesInventarios_Saldos(año, mesIni, bodega, tipoBodega, referencia,
