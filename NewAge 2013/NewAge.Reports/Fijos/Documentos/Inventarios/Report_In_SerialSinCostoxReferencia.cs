...
{
    public partial class Report_In_SerialSinCostosxReferencia : ReportBase
    {
        public Report_In_SerialSinCostosxReferencia()
        {

        }

        public Report_In_SerialSinCostosxReferencia(string loggerConn, SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, ExportFormatType formatType)
