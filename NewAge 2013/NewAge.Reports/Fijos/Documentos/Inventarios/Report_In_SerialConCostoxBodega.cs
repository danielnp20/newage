...
{
    public partial class Report_In_SerialConCostoxBodega : ReportBase
    {
        public Report_In_SerialConCostoxBodega()
        {

        }

        public Report_In_SerialConCostoxBodega(string loggerConn, SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, ExportFormatType formatType)
                    ...
                    string referencia, string grupo, string clase, string tipo, string serie, string material, bool isSerial)
        {
            ...
            List<DTO_ReportInventariosSaldosTotal> data = _moduloInventarios.ReportesInventarios_SerialConCostos(año, mesIni, bodega, tipoBodega, referencia,
                grupo, clase, tipo, serie, material, isSerial,string.Empty);
