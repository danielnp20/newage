...
{
    public partial class Reports_Ts_Ejecutado : ReportBase
    {
        #region Variables
        ...
        #endregion
        public Reports_Ts_Ejecutado()
        {

        }

        public Reports_Ts_Ejecutado(string loggerConn, SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, ExportFormatType formatType)
