...
{
    public partial class Report_Pl_EjePresupuestalRecursoXActiviME : ReportBaseLandScape
    {

        /// <summary>
        /// Constructor por Defecto
        /// </summary>
        public Report_Pl_EjePresupuestalRecursoXActiviME()
        {
            InitializeComponent();
        }
        ...
        public Report_Pl_EjePresupuestalRecursoXActiviME(string loggerConn, SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, ExportFormatType formatType)
