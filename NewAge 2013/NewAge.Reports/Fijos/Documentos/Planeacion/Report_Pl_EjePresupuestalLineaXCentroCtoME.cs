...
{
    public partial class Report_Pl_EjePresupuestalLineaXCentroCtoME : ReportBaseLandScape
    {

        /// <summary>
        /// Constructor por Defecto
        /// </summary>
        public Report_Pl_EjePresupuestalLineaXCentroCtoME()
        {
            InitializeComponent();
        }
        ...
        public Report_Pl_EjePresupuestalLineaXCentroCtoME(string loggerConn, SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, ExportFormatType formatType)
