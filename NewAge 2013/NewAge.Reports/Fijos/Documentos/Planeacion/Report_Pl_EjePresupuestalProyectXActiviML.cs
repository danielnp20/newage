...
{
    public partial class Report_Pl_EjePresupuestalProyectXActiviML : ReportBaseLandScape
    {

        /// <summary>
        /// Constructor por Defecto
        /// </summary>
        public Report_Pl_EjePresupuestalProyectXActiviML()
        {
            InitializeComponent();
        }
        ...
        public Report_Pl_EjePresupuestalProyectXActiviML(string loggerConn, SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, ExportFormatType formatType)
