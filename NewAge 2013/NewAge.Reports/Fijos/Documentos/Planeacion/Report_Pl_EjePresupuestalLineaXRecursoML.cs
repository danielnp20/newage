...
{
    public partial class Report_Pl_EjePresupuestalLineaXRecursoML : ReportBaseLandScape
    {

        /// <summary>
        /// Constructor por Defecto
        /// </summary>
        public Report_Pl_EjePresupuestalLineaXRecursoML()
        {
            InitializeComponent();
        }
        ...
        public Report_Pl_EjePresupuestalLineaXRecursoML(string loggerConn, SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, ExportFormatType formatType)
