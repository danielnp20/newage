...
{
    public partial class Report_Pl_EjePresupuestalProyectXActiviME : ReportBaseLandScape
    {

        /// <summary>
        /// Constructor por Defecto
        /// </summary>
        public Report_Pl_EjePresupuestalProyectXActiviME()
        {
            InitializeComponent();
        }
        ...
        public Report_Pl_EjePresupuestalProyectXActiviME(string loggerConn, SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, ExportFormatType formatType)
