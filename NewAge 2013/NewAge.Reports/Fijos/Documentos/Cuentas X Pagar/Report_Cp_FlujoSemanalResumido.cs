...
{
    public partial class Report_Cp_FlujoSemanalResumido : ReportBase
    {
        #region Variables

        private string _mes;
        #endregion
        public Report_Cp_FlujoSemanalResumido()
        {

        }

        public Report_Cp_FlujoSemanalResumido(string loggerConn, SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, ExportFormatType formatType)
            : base(loggerConn, c, tx, empresa, userId, formatType)
        {
            this.lblReportName.Text = this._moduloGlobal.GetResource(LanguageTypes.Forms, "35081_CuentasxPagarxFlujoSemanalResumido");
