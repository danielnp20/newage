...
namespace NewAge.Server.GlobalService
{
    ...
    public interface IGlobalService
    {
        ...
        [OperationContract]
        string glActividadEstado_GetActFlujoByNumeroDoc(Guid channel, int numeroDoc, bool onlyAbiertas);
        #endregion
        ...
        /// <returns>Resultado</returns>
        [OperationContract]
        DTO_TxResult glGarantiaControl_Add(Guid channel, int documentID, List<DTO_glGarantiaControl> garantias, List<int> itemsDelete);
        ...
        [OperationContract]
        List<DTO_glMovimientoDeta> glMovimientoDeta_GetByParameter(Guid channel, DTO_glMovimientoDeta filter, bool isPre, bool onlyInventario);

        /// <summary>
        /// Trae informacion de acuerdo al filtro para excel
        /// </summary>
        /// <param name="filter"></param>
        /// <returns>Dto de Mvto detalle</returns>
        [OperationContract]
        DataTable glMovimientoDeta_GetByParameterExcel(Guid channel, DTO_glMovimientoDeta filter, bool isPre, bool onlyInventario);
