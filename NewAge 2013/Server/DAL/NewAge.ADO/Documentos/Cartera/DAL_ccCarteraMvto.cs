...
namespace NewAge.ADO
{
    public class DAL_ccCarteraMvto : DAL_Base
    {
        ...
        /// <summary>
        /// Elimina los movimientos por documento
        /// </summary>
        /// <returns></returns>
        public void DAL_ccCarteraMvto_Delete(int numeroDocCred)
        {
            try
            {
                string egCtrl = StaticMethods.GetGrupoEmpresasControl(base.MySqlConnection, base.MySqlConnectionTx, this.loggerConnectionStr);
                ...
                mySqlCommandSel.CommandText = " Delete from ccCarteraMvto WHERE NumCredito =  @NumCredito";

                mySqlCommandSel.Parameters.Add("@NumCredito", SqlDbType.Int);
                mySqlCommandSel.Parameters["@NumCredito"].Value = numeroDocCred;
            ...
            catch (Exception ex)
            {
                ...
                Mentor_Exception.LogException_Local(this.loggerConnectionStr, exception, this.UserId.ToString(), "DAL_ccCarteraMvto_Delete");
                throw exception;
            }
        }
        ...
        public List<DTO_ccCarteraMvto> DAL_CarteraMvto_QueryByNumCredito(int? numDocCredito)
        {
            try
            {
                ...
                mySqlCommandSel.CommandText = " SELECT * FROM ccCarteraMvto where NumCredito = @NumCredito ";
