...
namespace NewAge.ADO
{
    public class DAL_CarteraFin : DAL_Base
    {
        ...
        /// <returns></returns>
        public DTO_TxResult DAL_CarteraFin_RecaudosMasivos_Inconsistencias(string PagaduriaID, DateTime periodo, List<DTO_ccIncorporacionDeta> data)
        {
        ...
        /// </summary>
        /// <returns>retorna una lista de comprob </returns>
        public object DAL_CarteraFin_GetComprobanteCarteraAdmon(int numeroDoc)
        {
            try
            {
                DTO_Comprobante comp = new DTO_Comprobante();
                ...
                SqlCommand mySqlCommand = new SqlCommand("Cartera_ComprobanteCarteraAdministrada", base.MySqlConnection.CreateCommand().Connection);
                mySqlCommand.Transaction = base.MySqlConnectionTx;
                mySqlCommand.CommandType = CommandType.StoredProcedure;
