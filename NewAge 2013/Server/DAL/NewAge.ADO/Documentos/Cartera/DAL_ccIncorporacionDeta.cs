...
namespace NewAge.ADO
{
    public class DAL_ccIncorporacionDeta : DAL_Base
    {
        ...
        public List<DTO_ccArchivoIncorporaciones> DAL_CreditosIncorporados(DateTime periodo, string pagaduria, string terceroCoop)
        {
            try
            {
                ...
                mySqlCommandSel.CommandText =
                    ...
                    "	cli.ProfesionID, incorDeta.PagaduriaID, incorDeta.ValorNomina AS VlrIncorpora, pp.VlrCuota - pp.VlrPagadoCuota AS VlrSaldo, " + 
                    ...
                    " WHERE cre.EmpresaID = @EmpresaID AND incorDeta.FechaNovedad BETWEEN @FechaIni AND @FechaFin and incorDeta.PagaduriaID = @PagaduriaID ";
