...
namespace NewAge.ADO
{
    ...
    public class DAL_Comprobante : DAL_Base
    {
        ...
        /// </summary>
        /// <param name="comprobante">Comprobante contable</param>
        public void DAL_Comprobante_BorrarAuxiliar_Pre(DateTime periodo, string comprobanteID, int compNro, int numeroDoc = 0)
        {
            try
            {
                string egCtrl = StaticMethods.GetGrupoEmpresasControl(base.MySqlConnection, base.MySqlConnectionTx, this.loggerConnectionStr);
                ...
                //Valida si borra por numeroDoc o Comprobante
                if (numeroDoc == 0)
                {                  
                    mySqlCommandSel.Parameters.Add("@EmpresaID", SqlDbType.Char, UDT_EmpresaID.MaxLength);
                    mySqlCommandSel.Parameters.Add("@PeriodoID", SqlDbType.DateTime);
        ...
        /// <param name="numerosDoc">Lista con los numero doc de cada giro</param>
        /// <returns></returns>
        public List<DTO_ComprobanteFooter> DAL_Comprobante_GetByCompraCarteraExterna(List<int> numerosDoc, string ctaID)
        {
            try
            {
                SqlCommand mySqlCommandSel = base.MySqlConnection.CreateCommand();
        ...
        public void DAL_Comprobante_Update(int consecutivoAux, DTO_ComprobanteFooter comp, bool isPre)
        {
            try
            {
                ...
                mySqlCommand.Parameters.Add("@DatoAdd1", SqlDbType.Char, 50);
                mySqlCommand.Parameters.Add("@DatoAdd2", SqlDbType.Char, 50);
                mySqlCommand.Parameters.Add("@DatoAdd3", SqlDbType.Char, 50);
                mySqlCommand.Parameters.Add("@DatoAdd4", SqlDbType.Char, 50);
                mySqlCommand.Parameters.Add("@DatoAdd5", SqlDbType.Char, 50);
                mySqlCommand.Parameters.Add("@DatoAdd6", SqlDbType.Char, 50);
                mySqlCommand.Parameters.Add("@DatoAdd7", SqlDbType.Char, 50);
                mySqlCommand.Parameters.Add("@DatoAdd8", SqlDbType.Char, 50);
                mySqlCommand.Parameters.Add("@DatoAdd9", SqlDbType.Char, 50);
                mySqlCommand.Parameters.Add("@DatoAdd10", SqlDbType.Char, 50);
