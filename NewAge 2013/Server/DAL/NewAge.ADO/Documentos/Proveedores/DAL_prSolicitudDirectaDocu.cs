       ...
       /// <summary>
        ...
        public List<DTO_prSolicitudResumen> DAL_prSolicitudDirectaDocu_GetResumen(int documentID, bool asignInd, DTO_seUsuario usuario, ModulesPrefix mod,bool DestinoContrato = false)
        {
            try
            {
                ...
                mySqlCommand.CommandText =
                "select ctrl.NumeroDoc,ctrl.PeriodoDoc as PeriodoID,ctrl.Fecha,ctrl.DocumentoID,ctrl.PrefijoID,ctrl.DocumentoNro,solCargo.ProyectoID,solCargo.LineaPresupuestoID " +
                    ...
                    ",det.DatoAdd1,det.DatoAdd2,det.DatoAdd3,det.DatoAdd4,det.DatoAdd5,det.OrigenMonetario,IsNull(mat.Margen,0) as Margen    " +
                ...
                "group by det.SolicitudDocuID,det.SolicitudDetaID ) temp " +
                    ...
                    "where temp.CantidadSum!=0 and temp.CantidadSum > 0" + filtroDestino;
