...
namespace NewAge.ADO
{
    ...
    public class DAL_glGarantiaControl : DAL_Base
    {
        ...
        /// </summary>
        /// <returns></returns>
        public void DAL_glGarantiaControl_Delete(int consecutivo)
        {
            try
            {
                string egCtrl = StaticMethods.GetGrupoEmpresasControl(base.MySqlConnection, base.MySqlConnectionTx, this.loggerConnectionStr);
                ...
                mySqlCommandSel.CommandText = " Delete from glGarantiaControl WHERE Consecutivo =  @Consecutivo";
            ...
            {
                var exception = new Exception(DictionaryMessages.Err_GettingData, ex);
                Mentor_Exception.LogException_Local(this.loggerConnectionStr, exception, this.UserId.ToString(), "DAL_glGarantiaControl_Delete");
                throw exception;
            }
        }
