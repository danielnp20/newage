...
{
    public class DAL_pyPreProyectoDetaCLI : DAL_Base
    {
        /// <summary>
        ...
        public DAL_pyPreProyectoDetaCLI(SqlConnection c, SqlTransaction tx, DTO_glEmpresa empresa, int userId, string loggerConn) : base(c, tx, empresa, userId, loggerConn) { }

        /// <summary>
        ///  Adicona Solicitud servicio detallado
        /// </summary>
        /// <param name="deta">solicitud</param>
        public int DAL_pyPreProyectoDetaCLI_Add(DTO_pyPreProyectoDeta deta)
        {
            try
            {
                ...
                mySqlCommandSel.CommandText = "   INSERT INTO pyPreProyectoDetaCLI " +
                                              "    ([ConsecTarea] " +
                                              "    ,[TrabajoID] " +
                                              "    ,[RecursoID] " +
                                              "    ,[NumeroDoc] " +
            ...
            catch (Exception ex)
            {
                ...
                Mentor_Exception.LogException_Local(this.loggerConnectionStr, exception, this.UserId.ToString(), "DAL_pyPreProyectoDetaCLI_Add");
                return 0;
                throw exception;
            }
        }
        ...
        public void DAL_pyPreProyectoDetaCLI_Delete(int? consec)
        {
            try
            {
                string egCtrl = StaticMethods.GetGrupoEmpresasControl(base.MySqlConnection, base.MySqlConnectionTx, this.loggerConnectionStr);
                ...
                #region Query
                mySqlCommandSel.CommandText = "DELETE FROM pyPreProyectoDetaCLI " +
            ...
            catch (Exception ex)
            {
                ...
                Mentor_Exception.LogException_Local(this.loggerConnectionStr, exception, this.UserId.ToString(), "DAL_pyPreProyectoDetaCLI_Delete");
                throw exception;
            }
        }
        ...
        /// <returns></returns>
        public void DAL_pyPreProyectoDetaCLI_Upd(DTO_pyPreProyectoDeta deta)
        {
            try
            {
                string egCtrl = StaticMethods.GetGrupoEmpresasControl(base.MySqlConnection, base.MySqlConnectionTx, this.loggerConnectionStr);
                ...
                mySqlCommandSel.CommandText =
                                                "   UPDATE pyPreProyectoDetaCLI SET					" +
            ...
            catch (Exception ex)
            {
                //Log error
                var exception = new Exception(DictionaryMessages.Err_AddDocument, ex);
                Mentor_Exception.LogException_Local(this.loggerConnectionStr, exception, this.UserId.ToString(), "DAL_pyPreProyectoDetaCLI_Upd");
                throw exception;
            }
        }        
        ...
        public List<DTO_pyPreProyectoDeta> DAL_pyPreProyectoDetaCLI_GetByNumeroDoc(int? numeroDoc)
        {
            try
            {
        ...
        /// <param name="TrabajoID">Identificador del prefijo</param>
        /// <returns>Lista de componentes</returns>
        public List<DTO_pyPreProyectoDeta> DAL_pyPreProyectoDetaCLI_GetByConsecTarea(int? consecTarea)
        {
            try
            {
                SqlCommand mySqlCommand = base.MySqlConnection.CreateCommand();
        ...
        public DTO_pyPreProyectoDeta DAL_pyPreProyectoDetaCLI_GetByConsecutivo(int? consec)
        {
            try
            {
                ...
                SqlCommand mySqlCommand = base.MySqlConnection.CreateCommand();
                mySqlCommand.Transaction = base.MySqlConnectionTx;
                mySqlCommand.CommandText = "select * from pyPreProyectoDetaCLI  with(nolock) " +
                                           "Where Consecutivo =  @Consecutivo ";
            ...
            {
                var exception = new Exception(DictionaryMessages.Err_GettingList, ex);
                Mentor_Exception.LogException_Local(this.loggerConnectionStr, exception, this.UserId.ToString(), "DAL_pyPreProyectoDetaCLI_GetByConsecutivo");
                throw exception;
            }
        }
        ...
        /// <param name="filter"></param>
        /// <returns>Dto de Detalle Docu</returns>
        public bool DAL_pyPreProyectoDetaCLI_Exist(int? consec)
        {
            try
            {
                SqlCommand mySqlCommand = base.MySqlConnection.CreateCommand();
                ...
                mySqlCommand.CommandText = "select count(*) from pyPreProyectoDetaCLI with(nolock) where  Consecutivo = @Consecutivo";
            ...
            catch (Exception ex)
            {
                ...
                Mentor_Exception.LogException_Local(this.loggerConnectionStr, exception, this.UserId.ToString(), "DAL_pyPreProyectoDetaCLI_Exist");
                throw exception;
            }
        }      
    }
