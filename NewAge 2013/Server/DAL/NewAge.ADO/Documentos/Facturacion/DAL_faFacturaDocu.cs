       ...
       /// <summary>
        ...
        public void DAL_faFacturaDocu_Add(DTO_faFacturaDocu fact)
        {
            try
            {
                ...
                mySqlCommand.Parameters.Add("@Administracion", SqlDbType.Decimal);
                mySqlCommand.Parameters.Add("@Imprevistos", SqlDbType.Decimal);
                mySqlCommand.Parameters.Add("@Utilidad", SqlDbType.Decimal);
                ...
                mySqlCommand.Parameters["@Administracion"].Value = fact.Administracion.Value;
                mySqlCommand.Parameters["@Imprevistos"].Value = fact.Imprevistos.Value;
                mySqlCommand.Parameters["@Utilidad"].Value = fact.Utilidad.Value;
        ...
        public List<DTO_QueryHeadFactura> Consultar_Facturas(DateTime Ano, string terceroId, int tipoConsulta, string asesorID, string zonaID, string proyectoID, int TipoFact, string NumFact, string prefijoID, bool facturaFijaInd)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(proyectoID))
                    where += " AND docc.ProyectoID=@ProyectoID ";
                ...
                "SELECT docc.NumeroDoc , docc.TerceroID, RTRIM(docc.PrefijoID) + '-' + cast(docc.DocumentoNro as VARCHAR(100)) as PrefDoc, " +
                    ...
                    "docc.Valor, docc.PrefijoID AS Prefijo,docc.ProyectoID " +
