       ...
       /// <summary>
        ...
        public List<DTO_inMovimientoDocu> DAL_inMovimientoDocu_GetByParameter(DTO_inMovimientoDocu header)
        {
            try
            {
                ...
                if (!string.IsNullOrEmpty(header.TipoTraslado.Value.ToString()))
                {
                    query += "and TipoTraslado = @TipoTraslado ";
                    mySqlCommand.Parameters.Add("@TipoTraslado", SqlDbType.TinyInt);
                    mySqlCommand.Parameters["@TipoTraslado"].Value = header.TipoTraslado.Value;
                    filtroActivoInd = true;
                }
        ...
        public void DAL_inMovimientoDocu_Add(DTO_inMovimientoDocu mvtoHeader)
        {
            try
            {
                ...
                mySqlCommand.Parameters["@TipoTraslado"].Value = mvtoHeader.TipoTraslado.Value;
