        ...
        public List<DTO_ccCarteraComponente> DAL_ccCarteraComponente_GetByLineaCredito(string lineaCreditoID)
        {
            ...
            try
            {
                ...
                while (dr.Read())
                {
                    ...
                    if (!string.IsNullOrEmpty(dr["TipoLiquida"].ToString()))
                        carteraComp.TipoLiquida.Value = Convert.ToByte(dr["TipoLiquida"]);
                    if (!string.IsNullOrEmpty(dr["FuenteLiquida"].ToString()))
                        carteraComp.FuenteLiquida.Value = Convert.ToByte(dr["FuenteLiquida"]);
