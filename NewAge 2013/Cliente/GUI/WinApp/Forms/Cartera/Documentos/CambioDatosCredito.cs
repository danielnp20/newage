...
namespace NewAge.Cliente.GUI.WinApp.Forms
{
    public partial class CambioDatosCredito : FormWithToolbar
    {
        ...
        private void SetInitParameters()
        {
            ...
            _bc.InitMasterUC(this.masterAbogado, AppMasters.ccAbogado, true, true, true, false);
        ...
        private void EnableHeader(bool enabled)
        {
            try
            {
                ...
                this.masterAbogado.EnableControl(enabled);
            }
            catch (Exception ex)
            {
        ...
        private void CleanData()
        {
            try
            {
                ...
                this.masterAbogado.Value = String.Empty;
            ...
            try
            {
                if (this._libranzaID != this.txtLibranza.Text.Trim() && !String.IsNullOrWhiteSpace(this.txtLibranza.Text))
                {
                    ...
                    if (this.credito != null)
                    {
                        ...
                        this.masterAbogado.Value = this.credito.Abogado.Value;
        ...
        public override void TBSave()
        {
            try
            {
                if (this.ValidateHeader())
                {
                    ...
                    this.credito.Abogado.Value = this.masterAbogado.Value;
