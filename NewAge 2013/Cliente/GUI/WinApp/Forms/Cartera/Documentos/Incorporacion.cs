...
namespace NewAge.Cliente.GUI.WinApp.Forms
{
    public partial class Incorporacion : SolicitudCreditoChequeo
    {
        ...
        protected override void SetInitParameters()
        {
            ...
            this.msgInvalidCP = _bc.GetResourceError(DictionaryMessages.Err_Cc_InvalidPagaduriaLibranza);
        ...
        {
            if (!this.gvDocuments.IsFilterRow(e.RowHandle) && this.validateData && e.RowHandle >= 0 && this.isCredito && this.credito != null && this.canEdit)
            {
                this.ValidateDocRow(e.RowHandle);
                if (!this.validCreditos)
                    e.Allow = false;
        ...
        protected override void gvDocuments_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            try
            {
                ...
                if (this.validateData && row >= 0 && this.gvDocuments.RowCount > 0)
                {
                    if (this.isCredito)
                    {
