...
{
    public partial class CierreOferta : DocumentAprobBasicForm
    {
        ...
        public CierreOferta(string mod)
            : base(mod) { }
        ...
        protected override void SetInitParameters()
        {
            try
            {
                this.documentID = AppDocuments.CierreOferta;
                this.docRecursos = AppDocuments.EndosoLibranzasVendidas;
                this.frmModule = ModulesPrefix.cc;
                base.SetInitParameters();
            }
            catch (Exception ex)
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-CierreOferta.cs", "SetInitParameters"));
            }
        }
        ...
        protected override void LoadDocuments()
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-CierreOferta.cs", "LoadDocuments"));
            }
        ...
        protected override void AddDocumentCols()
        {
            try
            {
                ...
                compradorFinal.Caption = _bc.GetResource(LanguageTypes.Forms, this.docRecursos + "_CompradorFinal");
                ...
                vlrVenta.Caption = _bc.GetResource(LanguageTypes.Forms, this.docRecursos + "_VlrVenta");
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-", "CierreOferta.cs-AddGridCols"));
            }
        ...
        protected override void Form_Enter(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-CierreOferta.cs", "Form_Enter"));
            }
        }
        ...
        protected override void ApproveThread()
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-CierreOferta.cs", "ApproveThread"));
            }
            finally
            {
                FormProvider.Master.StopProgressBarThread(this.documentID);
