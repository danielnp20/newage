...
namespace NewAge.Cliente.GUI.WinApp.Forms
{
    ...
    public class Reports_CobroJuridico : ParametersCarteraForm
    {
        ...
        private byte tipoEstado = 3;
        private byte tipoReporte = 1;
        ...
        protected override void Report_PDF()
        {
            ...
            this.tipoReporte = Convert.ToByte(TipoReporte.SelectedListItem.Key);

            ReportParameterList Estado = (ReportParameterList)this.RPControls["Estado"];
            this.tipoEstado = Convert.ToByte(Estado.SelectedListItem.Key);
        ...
        protected override void LoadReportMethod_PDF()
        {
            try
            {
                ...
                reportName = this._bc.AdministrationModel.Report_Cc_CobroJuridico(AppReports.ccCobroJuridico, this.claseDeuda, this.tipoReporte, this._cliente, this._libranza.ToString(), this.tipoEstado);
