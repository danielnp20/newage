...
namespace NewAge.Cliente.GUI.WinApp.Forms
{
    class Reports_Referenciacion : ReportParametersForm
    {
        ...
        protected override void LoadReportMethod_PDF()
        {
            try
            {
                ...
                ReportParameterTextBox numeroLibranza = (ReportParameterTextBox)this.RPControls["libranza"];
                    ...
                    result = this._bc.AdministrationModel.ReportesCartera_Cc_Referenciacion(numeroLibranza.txtFrom.Text, cliente, _fechaIni,_llamadaCtrl, this._formatType);
        ...
        private bool _llamadaCtrl = false;
        #endregion
        ...
        protected override void InitReport()
        {
            ...
            this.AddCheck("ContactoEfectivo", (AppForms.ReportForm).ToString() + "_ContactoEfectivo",true);
            #endregion
        ...
        protected override void ListValueChanged(string option, object sender)
        {
            ...
            {
                this.periodoFilter1.txtYear.Visible = false;
                this.periodoFilter1.monthCB.Visible = false;
                this.periodoFilter1.monthCB1.Visible = false;
                this.periodoFilter1.txtYear1.Visible = false;
                this.periodoFilter1.lblFromMonth.Visible = false;
                this.periodoFilter1.lblFromYear.Visible = false;
                this.periodoFilter1.lblUntilMonth.Visible = false;
                this.periodoFilter1.lblUntilYear.Visible = false;
            }
            ...
            if (option.Equals("ContactoEfectivo"))
            {
                switch (reportParameters["ContactoEfectivo"][0])
                {
                    case "True":
                        this._llamadaCtrl = true;
                        break;
                    case "False":
                        this._llamadaCtrl = false;
                        break;
                }
            }
            #endregion
