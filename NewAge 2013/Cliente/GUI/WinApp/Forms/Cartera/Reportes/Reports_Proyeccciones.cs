...
namespace NewAge.Cliente.GUI.WinApp.Forms
{
    ...
    public class Reports_Proyecciones : ParametersCarteraForm
    {
        ...
        {
            this.documentReportID = AppReports.ccProyeccionVencim;
            base.InitReport();
        }
        ...
        protected override void LoadReportMethod_PDF()
        {
            try
            {
                ...
                reportName = this._bc.AdministrationModel.Report_Cc_CarteraByParameter(AppReports.ccReportesEpeciales, this._tipoReporte, this._fechaIni, this._fechaFin, this._cliente, this._libranza, this._zona, this._ciudad,
                                                                                  this._concesionario, this._asesor, this._lineaCredi, this._compradorCatera, string.Empty, string.Empty, null, null, this._formatType);
                fileURl = this._bc.UrlDocumentFile(TipoArchivo.Temp, null, null, reportName.ToString());
                Process.Start(fileURl);
            }
            catch (Exception ex)
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp", "Reports_Proyecciones.cs-LoadReportMethod"));
                throw;
            }
            finally
            {
