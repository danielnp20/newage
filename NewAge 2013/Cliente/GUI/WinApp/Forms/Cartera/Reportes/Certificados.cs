        ...
        protected override void Report_PDF()
        {
            try
            {
                ...
                if (cliente.Value != string.Empty)
                {
                    ...
                    if (this._libranza == null)
                    {
                        string msg = _bc.GetResource(LanguageTypes.Error, DictionaryMessages.Ac_noFilterSelected);
                        MessageBox.Show(msg);
                        return;
                    }
                    ...
                    if (this._report == AppTemplates.cc_PazYSalvo)
                    {
                        ...
                        else
                        {
                            ...
                            list.Add("Bogotá D.C.");
                            tem.GenerarPlantilla(this._report,this._report, list, ref saveOk);
                        }
                    }
