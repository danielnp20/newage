...
{
    public partial class CarteraAdministracion : ProcessForm
    {
        #region Delegados
        ...
        protected override void InitForm()
        {
            try
            {
                this.documentID = AppProcess.CarteraAdministracion;
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-CarteraAdministracion.cs", "InitForm"));
            }
        }
        ...
        private void btnCierre_Click(object sender, EventArgs e)
        {
            ...
            new Thread(CarteraAdministracionThread).Start();
        }
        ...
        /// </summary>
        private void CarteraAdministracionThread()
        {
            try
            {
                ...
                this._resProcesar = this._bc.AdministrationModel.Proceso_CarteraAdministracion(this.documentID, this.dtPeriod.DateTime);
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-CarteraAdministracion.cs", "btnCierre_Click"));
                this.StopProgressBarThread();
            }
        }
