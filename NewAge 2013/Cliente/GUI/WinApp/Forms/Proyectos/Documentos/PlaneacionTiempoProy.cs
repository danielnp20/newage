...
namespace NewAge.Cliente.GUI.WinApp.Forms
{
    ...
    /// </summary>
    public partial class PlaneacionTiempoProy : FormWithToolbar
    {
        #region Variables
        ...
        private void AddGridCols()
        {
            ...
            DiasInicioTrabajo.Width = 40;
            DiasInicioTrabajo.Visible = true;
            DiasInicioTrabajo.OptionsColumn.AllowEdit = true;
        ...
        private void AssignRecursos()
        {
            try
            {
                if (this._tareaIsFocused)
                {
                    ...
                    if (this.chkRecursoXTrabInd.Checked)
                    {
                        ...
                        List<DTO_pyProyectoTarea> listTarea = new List<DTO_pyProyectoTarea>();
            ...
            {
                MessageBox.Show(this._bc.GetResourceForException(ex, "WinApp-PlaneacionTiempoProy.cs", "AddNewRow: " + ex.Message));
            }
        }
        ...
        private void CargarInformacion(bool exist)
        {
            try
            {
                ...
                else
                {
                    ...
                    this.chkTiempoAutInd.Checked = this._dtoClaseServicio != null? this._dtoClaseServicio.TiempoTareaAutInd.Value.Value : false;
                }
            }
            catch (Exception ex)
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-PlaneacionTiempoProy.cs", "CargarInformacion"));
            }
        }
        ...
        private void CalculateValues(DTO_pyProyectoTarea tarea, bool firstTime = false)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-PlaneacionTiempoProy.cs", "CalculateValues"));
            }
        }
        ...
        private void CalculateHierarchy(DTO_pyProyectoTarea tarea, string value)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-PlaneacionTiempoProy.cs", "CalculateHierarchy"));
            }
        }
            ...
            try
            {
                if (!recursosAll)
                {
                    if (this.chkRecursoXTrabInd.Checked)
                    {
                        ...
                        {
                            //DTO_pyProyectoDeta this._rowRecursoCurrent = this._rowTareaCurrent.Detalle.FindAll(x => x.TrabajoID.Value == this._trabajoCurrent).First();
                            ...
                            if (this._rowRecursoCurrent.TipoRecurso.Value == (byte)TipoRecurso.Equipo || this._rowRecursoCurrent.TipoRecurso.Value == (byte)TipoRecurso.Personal)
                            {
                                ...
                                if (this._rowRecursoCurrent.FechaInicio.Value != null)
                                {
                                    ...
                                    if (this.gvRecursoCurrent.FocusedRowHandle == 0 && this.gvRecursoCurrent.DataRowCount > 1)
                                    {
                                        ...
                                        foreach (DTO_pyProyectoDeta d in this._rowTareaCurrent.Detalle.FindAll(x => x.TrabajoID.Value == this._trabajoCurrent))
                                        {
                            ...
                            if (this._rowRecursoCurrent.TipoRecurso.Value == (byte)TipoRecurso.Equipo || this._rowRecursoCurrent.TipoRecurso.Value == (byte)TipoRecurso.Personal)
                            {
                                ...
                                if (this._rowRecursoCurrent.FechaInicio.Value != null)
                                {
                                    ...
                                    if (this.gvRecurso.FocusedRowHandle == 0 && this.gvRecurso.DataRowCount > 1)
                                    {
                                        ...
                                        int index = 0;
                                        this._assignFechaInicio = false;
                                        foreach (DTO_pyProyectoDeta d in this._rowTareaCurrent.Detalle)
                                        {
                                            if (d.FechaInicio.Value == null)
                ...
                else
                {
                    ...
                    {
                        foreach (DTO_pyProyectoDeta rec in tarea.Detalle)
                        {
                            ...
                            {
                                rec.TiempoTotal.Value = rec.FactorID.Value != 0 ? Math.Round(tarea.Cantidad.Value.Value / rec.FactorID.Value.Value, 2) : 0;
                                #region Calcula la fechaFin del Recurso con el Tiempo Total
        ...
        private void CleanHeader(bool p)
        {
            ...
            {
                MessageBox.Show(this._bc.GetResourceForException(ex, "WinApp-PlaneacionTiempoProy.cs", "CleanHeader"));
            }
        }
        ...
        private void InitControls()
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-PlaneacionTiempoProy.cs", "InitControls"));
            }
        }
        ...
        private void UpdateValues()
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-PlaneacionTiempoProy.cs", "gvDetalle_FocusedRowChanged"));
            }
        }
        ...
        private void gvDocument_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-PlaneacionTiempoProy.cs", "gvDocument_FocusedRowChanged"));
            }
        }
        ...
        private void gcDocument_EmbeddedNavigator_ButtonClick(object sender, DevExpress.XtraEditors.NavigatorButtonClickEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-PlaneacionTiempoProy.cs", "gcDocument_EmbeddedNavigator_ButtonClick"));
            }
        }
        ...
        private void gvDocument_CellValueChanging(object sender, DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-PlaneacionTiempoProy.cs", "gvDocument_CellValueChanging"));
            }
        }
        ...
        private void editBtnGrid_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-PlaneacionTiempoProy.cs", "editBtnGrid_ButtonClick"));
            }
        }
        ...
        private void editLink_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-PlaneacionTiempoProy.cs", "editLink_Click"));
            }
        }
        ...
        private void gvRecurso_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            try
            {
                if (e.FocusedRowHandle >= 0 && this.gvRecurso.DataRowCount > 0)
                {
                    ...
                    if (this.chkRecursoXTrabInd.Checked)
                        this._rowRecursoCurrent = (DTO_pyProyectoDeta)this.gvRecursoCurrent.GetRow(e.FocusedRowHandle);
                    else
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-PlaneacionTiempoProy.cs", "gvRecurso_FocusedRowChanged"));
            }
        }
        ...
        private void gvRecurso_CellValueChanged(object sender, DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-PlaneacionTiempoProy.cs", "gvRecurso_CellValueChanged"));
            }
        }
        ...
        private void gvDetalleRecurso_CellValueChanged(object sender, DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-PlaneacionTiempoProy.cs", "gvDetalleRecurso_CellValueChanged"));
            }
        }
        ...
        private void gvDetalleRecurso_CustomColumnDisplayText(object sender, CustomColumnDisplayTextEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-PlaneacionTiempoProy.cs", "gvDetalleRecurso_CustomColumnDisplayText"));
            }
        ...
        public override void TBExport()
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-PlaneacionTiempoProy.cs", "TBExport"));
            }
        }
        ...
        public override void TBPrint()
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-PlaneacionTiempoProy.cs", "TBPrint"));
            }
        }
        #endregion
        ...
        public void SaveThread()
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-PlaneacionTiempoProy.cs", "SaveThread"));
            }
            finally
            {
        ...
        public void SendToApproveThread()
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp", "PlaneacionTiempoProy.cs-SendToApproveThread"));
            }
            finally
            {
                FormProvider.Master.StopProgressBarThread(this.documentID);
        ...
        public void ImportThreadTareas()
        {
                            ...
                            if (createDTO)
                            {
                                for (int colIndex = 0; colIndex < cols.Count; colIndex++)
                                {
                                    ...
                                    catch (Exception ex1)
                                    {
                                        DTO_TxResultDetailFields rdF = new DTO_TxResultDetailFields();
                                        rdF.Field = colRsx;
                                        rdF.Message = this._bc.GetResourceForException(ex1, "WinApp", "PlaneacionTiempoProy.cs - Creacion de DTO y validacion Formatos");
                                        rd.DetailsFields.Add(rdF);
                                        createDTO = false;
                                    }
                                }
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-PlaneacionTiempoProy.cs", "ImportThreadTareas"));
            }
            finally
            {
                FormProvider.Master.StopProgressBarThread(this.documentID);
