...
namespace NewAge.Cliente.GUI.WinApp.Forms
{
    ...
    /// </summary>
    public partial class PagosElectronicos : FormWithToolbar
    {
        #region Delegados
        ...
        private List<DTO_PagosElectronicos> _pagosElectronicosActual = new List<DTO_PagosElectronicos>();
        ...
        /// Constructor 
        /// </summary>
        public PagosElectronicos()
        {
            try
            {
                this.InitializeComponent();

                this._documentID = AppProcess.PagosElectronicos;
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-PagosElectronicos.cs", "PagosElectronicos"));
            }
        }
        ...
        {
            this._pagosElectronicosList = this._bc.AdministrationModel.PagosElectronicos_GetPagosElectronicosSinTransmitir();
        }
        ...
        private void LoadData()
        {
            if (this.masterCuenta.Value != string.Empty)
                this._pagosElectronicosActual = this._pagosElectronicosList.FindAll(p => p.BancoCuentaID.Value == this.masterCuenta.Value);
            else
                this._pagosElectronicosActual = new List<DTO_PagosElectronicos>();

            if (this._pagosElectronicosActual.Count > 0)
            {
                this.chkSelectAll.Enabled = true;
                if (this._pagosElectronicosActual.FindAll(p => !p.PagosElectronicosInd.Value.HasValue || !(bool)p.PagosElectronicosInd.Value).Count == 0)
                    this.chkSelectAll.CheckState = CheckState.Checked;
                else
                    this.chkSelectAll.CheckState = CheckState.Unchecked;

                if (this._pagosElectronicosActual.Exists(p => string.IsNullOrEmpty(p.Banco.Value) || p.TipoCuenta.Value == null || string.IsNullOrEmpty(p.CuentaNro.Value)))
                {
                    MessageBox.Show(this._bc.GetResource(LanguageTypes.Messages, DictionaryMessages.Ts_TercerosSinCuentaBancaria));
                    this._pagosElectronicosActual = this._pagosElectronicosActual.FindAll(p => !string.IsNullOrEmpty(p.Banco.Value) && p.TipoCuenta.Value != null && !string.IsNullOrEmpty(p.CuentaNro.Value));
                }
            }
            else
            {
            ...
            this.gcPagos.DataSource = this._pagosElectronicosActual;
        ...
        private void AddGridCols()
        {
            try
            {
                ...
                indicadorPago.FieldName = this._unboundPrefix + "PagosElectronicosInd";
                indicadorPago.Caption = _bc.GetResource(LanguageTypes.Forms, this._documentID + "_PagosElectronicosInd");
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-PagosElectronicos.cs", "PagosElectronicos.cs-AddGridCols"));
            }
        }
        ...
        protected virtual void Form_Enter(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-PagosElectronicos.cs", "PagosElectronicos.cs-Form_Enter"));
            }
        }
        ...
        protected virtual void Form_Leave(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-PagosElectronicos.cs", "PagosElectronicos.cs-Form_Leave"));
            }
        }
        ...
        protected virtual void Form_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-PagosElectronicos.cs", "PagosElectronicos.cs-Form_Closing"));
            }
        }
        ...
        protected virtual void Form_FormClosed(object sender, FormClosedEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-PagosElectronicos.cs", "PagosElectronicos.cs-Form_FormClosed"));
            }
        }
        ...
        private void gvPagos_CustomRowCellEdit(object sender, CustomRowCellEditEventArgs e)
        {
            ...
            if (fieldName == "PagosElectronicosInd")
            {
        ...
        private void gvPagos_CellValueChanging(object sender, CellValueChangedEventArgs e)
        {
            ...
            if (fieldName == "PagosElectronicosInd")
            {
                ...
                var pagoElectronico = this._pagosElectronicosList[index];
                pagoElectronico.PagosElectronicosInd.Value = value;
                if (value)
                {
                    if (this._pagosElectronicosActual.FindAll(p => !p.PagosElectronicosInd.Value.HasValue || !(bool)p.PagosElectronicosInd.Value).Count == 0)
                        this.chkSelectAll.CheckState = CheckState.Checked;
        ...
        private void gvPagos_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-PagosElectronicos.cs", "gvDocument_FocusedRowChanged"));
            }
        }
        ...
        private void chkSelectAll_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            this._pagosElectronicosActual.ForEach(p => p.PagosElectronicosInd.Value = value);
            this.gcPagos.RefreshDataSource();
        }

        /// <summary>
        /// Botón para transmitir el pago
        /// </summary>
        /// <param name="sender">Objeto que envia el evento</param>
        /// <param name="e">Evento</param>
        private void btnTransmitir_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (this._pagosElectronicosActual.FindAll(p => p.PagosElectronicosInd.Value.HasValue && (bool)p.PagosElectronicosInd.Value).Count > 0)
                {
                    Thread process = new Thread(this.TransmitThread);
                    process.Start();
                }
                else
                {
        ...
        public void SaveThread()
        {
            try
            {
                ...
                result = _bc.AdministrationModel.PagosElectronicos_Guardar(this._documentID, this._pagosElectronicosActual);
        ...
        public void TransmitThread()
        {
            try
            {
                List<DTO_PagosElectronicos> pagosElectronicosATransmitir = this._pagosElectronicosActual.FindAll(p => p.PagosElectronicosInd.Value.HasValue && p.PagosElectronicosInd.Value.Value);
                ...
                result = _bc.AdministrationModel.PagosElectronicos_Transmitir(this._documentID, pagosElectronicosATransmitir);
                FormProvider.Master.StopProgressBarThread(this._documentID);
