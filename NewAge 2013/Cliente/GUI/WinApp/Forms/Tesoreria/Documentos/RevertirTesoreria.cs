...
namespace NewAge.Cliente.GUI.WinApp.Forms
{
    ...
    /// </summary>
    public partial class RevertirTesoreria : DocumentReversiones
    {       
        ...
        {
            this.documentID = AppDocuments.RevertirTesoreria;
        ...
        protected override void InitControls()
        {
            ...
            doc = (DTO_glDocumento)this._bc.GetMasterDTO(AppMasters.MasterType.Simple, AppMasters.glDocumento, true, AppDocuments.DesembolsoFacturas.ToString(), true);
            this.docs.Add(doc);
            doc = (DTO_glDocumento)this._bc.GetMasterDTO(AppMasters.MasterType.Simple, AppMasters.glDocumento, true, AppDocuments.ReciboCaja.ToString(), true);
            this.docs.Add(doc);
            doc = (DTO_glDocumento)this._bc.GetMasterDTO(AppMasters.MasterType.Simple, AppMasters.glDocumento, true, AppDocuments.TransferenciasBancarias.ToString(), true);
            this.docs.Add(doc);
        ...
        public override void SaveThread()
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-RevertirTesoreria.cs", "SaveThread"));
            }
            finally
            {
                FormProvider.Master.StopProgressBarThread(this.documentID);
