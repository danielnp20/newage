...
{
    class Reports_OtrosMovBancarios : ReportParametersForm, IFiltrable
    {
        #region Hilos
        /// <summary>
        ...
        protected override void LoadReportMethod_PDF()
        {
            try
            {
                ...
                {
                    reportName = this._bc.AdministrationModel.Report_No_AportesPension(this._fechaIni, this._fechaFin, this._filtro, true, this._formatType,string.Empty,string.Empty,string.Empty);
                    fileURl = this._bc.UrlDocumentFile(TipoArchivo.Temp, null, null, reportName.ToString());
                    Process.Start(fileURl);
                }
                if (this._report == 2)
                {
                    reportName = this._bc.AdministrationModel.Report_No_AportesSalud(this._fechaIni, this._fechaFin, this._filtro, true, this._formatType, String.Empty, String.Empty, String.Empty);
                    fileURl = this._bc.UrlDocumentFile(TipoArchivo.Temp, null, null, reportName.ToString());
                    Process.Start(fileURl);
                }
                if (this._report == 3)
                {
                    reportName = this._bc.AdministrationModel.Report_No_AporteVoluntarioPension(this._fechaIni, this._fechaFin, this._filtro, true, this._formatType, String.Empty, String.Empty, String.Empty);
                    fileURl = this._bc.UrlDocumentFile(TipoArchivo.Temp, null, null, reportName.ToString());
                    Process.Start(fileURl);
                }
                if (this._report == 4)
                {
                    reportName = this._bc.AdministrationModel.Report_No_AporteARP(this._fechaIni, this._fechaFin, this._filtro, true, this._formatType, String.Empty, String.Empty, String.Empty);
                    fileURl = this._bc.UrlDocumentFile(TipoArchivo.Temp, null, null, reportName.ToString());
                    Process.Start(fileURl);
                }
        ...
        /// </summary>
        public Reports_OtrosMovBancarios() { }
        ...
        protected override void InitReport()
        {
            ...
            this.Text = _bc.GetResource(Librerias.Project.LanguageTypes.Forms, (AppReports.tsOtrosMovBancarios).ToString());
