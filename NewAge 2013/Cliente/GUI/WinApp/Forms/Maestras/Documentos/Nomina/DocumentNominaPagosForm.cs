...
namespace NewAge.Cliente.GUI.WinApp.Forms
{
    ...
    /// </summary>
    public partial class DocumentNominaPagosForm : FormWithToolbar
    {
        #region Delegados
        ...
        /// Constructor 
        /// </summary>)
        public DocumentNominaPagosForm()
        {
            try
            {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentNominaPagosForm.cs", "DocumentNominaPagosForm"));
            }
        }
        ...
        protected void LoadDocumentInfo(bool firstTime)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentNominaPagosForm.cs", "LoadDocumentInfo"));
            }
        }
        ...
        protected virtual void Form_Enter(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentNominaPagosForm.cs", "Form_Enter"));
            }
        }
        ...
        protected virtual void Form_Leave(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentNominaPagosForm.cs", "Form_Leave"));
            }
        }
        ...
        protected virtual void Form_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentNominaPagosForm.cs", "Form_Closing"));
            }
        }
        ...
        protected virtual void Form_FormClosed(object sender, FormClosedEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentNominaPagosForm.cs", "Form_FormClosed"));
            }
        }
        ...
        protected virtual void dtPeriod_EditValueChanged()
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentNominaPagosForm.cs", "dtPeriod_EditValueChanged"));
            }
        }
