...
namespace NewAge.Cliente.GUI.WinApp.Forms
{
    ...
    /// </summary>
    public partial class DocumentActivosFijosForm : FormWithToolbar
    {
        #region Delegados
        ...
        /// Constructor 
        /// </summary>)
        public DocumentActivosFijosForm()
        {
            try
            {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentActivosFijosForm.cs", "DocumentActivosFijosForm"));
            }
        }
        ...
        private void LoadDocumentInfo(bool firstTime)
        {
            try
            {
                if (firstTime)
                {
                    ...
                    this.terceroID = _bc.GetControlValueByCompany(ModulesPrefix.co,AppControl.co_TerceroXDefecto);
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentActivosFijosForm.cs", "LoadDocumentInfo"));
            }
        }
        ...
        protected virtual void Form_Enter(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentActivosFijosForm.cs", "Form_Enter"));
            }
        }
        ...
        protected virtual void Form_Leave(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentActivosFijosForm.cs", "Form_Leave"));
            }
        }
        ...
        protected virtual void Form_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentActivosFijosForm.cs", "Form_Closing"));
            }
        }
        ...
        protected virtual void Form_FormClosed(object sender, FormClosedEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentActivosFijosForm.cs", "Form_FormClosed"));
            }
        }
        ...
        /// <summary>
        /// Cambio lista de chequeo
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected virtual void editChkBox_CheckedChanged(object sender, System.EventArgs e){ }
