...
namespace NewAge.Cliente.GUI.WinApp.Forms
{
    ...
    /// </summary>
    public partial class DocumentReversiones : DocumentForm
    {
        #region Delegados
        ...
        public DocumentReversiones(string mod = null) : base(mod)
        {
        ...
        protected override void LoadData(bool firstTime = false)
        {
                    ...
                    if (this.docCtrls != null)
                    {
                        foreach (DTO_glDocumentoControl doc in this.docCtrls)
                        {
                            if (!string.IsNullOrEmpty(doc.TerceroID.Value))
                            {
                                ...
                                //doc.TerceroDesc.Value = tercero != null? tercero.Descriptivo.Value : string.Empty;
                            }
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentReversiones.cs", "TBUpdate"));
            }
        }
        ...
        protected virtual void lkpDocumentos_EditValueChanged(object sender, System.EventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentReversiones.cs", "lkpDocumentos_EditValueChanged"));
            }
        }
        ...
        private void btnQuery_Click(object sender, System.EventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentReversiones.cs", "btnFilter_Cheked"));
            }
        }
        ...
        protected virtual void LinkEdit_Click(object sender, System.EventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentReversiones.cs", "LinkEdit_Click"));
            }
        }
        ...
        public override void TBFilter()
        {
            try
            {
                ...
                this.lkpDocumentos_EditValueChanged(null, null);
            }
            catch (Exception ex)
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentReversiones.cs", "TBFilter"));
            }
        }
        ...
        public override void TBFilterDef()
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentReversiones.cs", "TBFilterDef"));
            }
        }
        ...
        public override void TBSave()
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentReversiones.cs", "TBSave"));
            }
        }
