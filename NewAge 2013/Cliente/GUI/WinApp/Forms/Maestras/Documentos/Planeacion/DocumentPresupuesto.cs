...
{
    public partial class DocumentPresupuesto : FormWithToolbar
    {
        #region Delegados
        ...
        {
            if (documentID != AppDocuments.Presupuesto)
            {
        ...
        protected void SendToApproveMethod()
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentPresupuesto.cs", "sendToApproveDelegate"));
            }
        }
        ...
        public DocumentPresupuesto()
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentPresupuesto.cs", "DocumentPresupuesto"));
            }
        }
        ...
        protected void AddColsDetalle()
        {
            try
            {
                ...
                AreaFisicaID.Caption = this._bc.GetResource(LanguageTypes.Forms, AppDocuments.Presupuesto + "_AreaFisica");
                ...
                ActividadID.Caption = this._bc.GetResource(LanguageTypes.Forms, AppDocuments.Presupuesto + "_ActividadID");
                ...
                Porcentaje01.Caption = _bc.GetResource(LanguageTypes.Forms, AppDocuments.Presupuesto + "_Porcentaje01");
                ...
                Porcentaje02.Caption = _bc.GetResource(LanguageTypes.Forms, AppDocuments.Presupuesto + "_Porcentaje02");
                ...
                Porcentaje03.Caption = _bc.GetResource(LanguageTypes.Forms, AppDocuments.Presupuesto + "_Porcentaje03");
                ...
                Porcentaje04.Caption = _bc.GetResource(LanguageTypes.Forms, AppDocuments.Presupuesto + "_Porcentaje04");
                ...
                Porcentaje05.Caption = _bc.GetResource(LanguageTypes.Forms, AppDocuments.Presupuesto + "_Porcentaje05");
                ...
                Porcentaje06.Caption = _bc.GetResource(LanguageTypes.Forms, AppDocuments.Presupuesto + "_Porcentaje06");
                ...
                Porcentaje07.Caption = _bc.GetResource(LanguageTypes.Forms, AppDocuments.Presupuesto + "_Porcentaje07");
                ...
                Porcentaje08.Caption = _bc.GetResource(LanguageTypes.Forms, AppDocuments.Presupuesto + "_Porcentaje08");
                ...
                Porcentaje09.Caption = _bc.GetResource(LanguageTypes.Forms, AppDocuments.Presupuesto + "_Porcentaje09");
                ...
                Porcentaje10.Caption = _bc.GetResource(LanguageTypes.Forms, AppDocuments.Presupuesto + "_Porcentaje10");
                ...
                Porcentaje11.Caption = _bc.GetResource(LanguageTypes.Forms, AppDocuments.Presupuesto + "_Porcentaje11");
                ...
                Porcentaje12.Caption = _bc.GetResource(LanguageTypes.Forms, AppDocuments.Presupuesto + "_Porcentaje12");
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp", "DocumentPresupuesto.cs-AddCols_Det"));
            }
        }
        ...
        protected virtual void AddNewRow_Det()
        {
            try
            {
                ...
                #endregion
                #region Carga informacion del detalle segun el tipo de proyecto
                //switch (this.tipoProy)
                //{
                //    case ProyectoTipo.Capex:
                //        //aux.ConceptoCargoID.Value = this.defConceptoCargo;
                //        break;
                //    case ProyectoTipo.Opex:
                //        if (this.ctrlOpex != 1)
                //            aux.LineaPresupuestoID.Value = this.defLineaPresupuesto;
                //        //aux.ConceptoCargoID.Value = this.defConceptoCargo;
                //        break;
                //    case ProyectoTipo.Administracion:
                //        aux.LineaPresupuestoID.Value = this.defLineaPresupuesto;

                //        break;
                //    case ProyectoTipo.InversionLoc:
                //        if (this.ctrlInversion != 1)
                //            aux.LineaPresupuestoID.Value = this.defLineaPresupuesto;
                //            //aux.ConceptoCargoID.Value = this.defConceptoCargo;
                //        break;
                //    case ProyectoTipo.InversionExt:
                //        if (this.ctrlInversion != 1)
                //            aux.LineaPresupuestoID.Value = this.defLineaPresupuesto;
                //            //aux.ConceptoCargoID.Value = this.defConceptoCargo;
                //            break;
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp", "DocumentPresupuesto.cs-AddNewRow_Det"));
            }
        }
        ...
        protected virtual bool ValidateRow_Det()
        {
            try
            {
                if (this.detList.Count > 0)
                {
                    ...
                    validField = _bc.ValidGridCellValue(this.gvDetail, string.Empty, fila, "VlrMvtoLocal", false, (this.detList[fila].VlrMvtoExtr.Value == 0 &&
                                this.documentID == AppDocuments.Presupuesto ? false : true), this.documentID == AppDocuments.ReclasifPresupuesto ? false : true, false);
                    if (!validField)
                        this.isValid_Det = false;
                    if (this.loadME)
                    {
            ...
            {
                this.isValid_Det = false;
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentPresupuesto.cs", "ValidateRow_Doc"));
            }
        ...
        protected virtual void RowIndexChanged_Det(int fila)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentPresupuesto.cs", "RowIndexChanged_Det"));
            }
        }
            ...
            try
            {
                ...
                if (Convert.ToByte(this.cmbTipoProyecto.EditValue) == (byte)ProyectoTipo.Capex || Convert.ToByte(this.cmbTipoProyecto.EditValue) == (byte)ProyectoTipo.Inversion)
                {
                    if (this.masterProyecto.ValidID)
                    {
                        ...
                        this.presupuesto = this._bc.AdministrationModel.Presupuesto_GetConsolidadoTotal(this.documentID, this.masterProyecto.Value, this.periodo,
                                                 Convert.ToByte(this.cmbTipoProyecto.EditValue), this.masterContrato.Value, this.masterActividad.Value, this.masterCampo.Value);
                    ...
                    if (this.masterContrato.ValidID)
                    {
                        ...
                        if (this.presupuesto == null)
                        {
                            ...
                            filtros.Add(new DTO_glConsultaFiltro()
                            {
                                ...
                                ValorFiltro = this.masterContrato.Value,

                            });
                            consulta.Filtros.AddRange(filtros);
                            long count = _bc.AdministrationModel.MasterSimple_Count(AppMasters.glAreaFisica, consulta, null, true);
                            var areasFis = this._bc.AdministrationModel.MasterSimple_GetPaged(AppMasters.glAreaFisica, count, 1, consulta, null, true).ToList();
                            #endregion
                            foreach (var campo in areasFis)
                            {
                                DTO_glAreaFisica dtoCampo = (DTO_glAreaFisica)campo;
                                ...
                                filtros.Add(new DTO_glConsultaFiltro()
                                {
                                    ...
                                    OperadorFiltro = OperadorFiltro.Igual,
                                    ValorFiltro = dtoCampo.ID.Value,

                                });
                                consulta.Filtros.AddRange(filtros);
                                count = _bc.AdministrationModel.MasterSimple_Count(AppMasters.glLocFisica, consulta, null, true);
                                var locFisicas = this._bc.AdministrationModel.MasterHierarchy_GetPaged(AppMasters.glLocFisica, count, 1, consulta, null, true).ToList();
                                #endregion
                                foreach (var locFis in locFisicas.Where(x => x.MovInd.Value.Value))
                                {
                                    ...
                                    if (this.masterActividad.ValidID)
                                    {
                                        filtros.Add(new DTO_glConsultaFiltro()
                                        {
                                            ...
                                            OperadorFiltro = OperadorFiltro.Igual,
                                            ValorFiltro = this.masterActividad.Value,
                                        });
                                    }
                                    consulta.Filtros.AddRange(filtros);
                                    count = _bc.AdministrationModel.MasterSimple_Count(AppMasters.coProyecto, consulta, null, true);
                                    var proyectos = this._bc.AdministrationModel.MasterHierarchy_GetPaged(AppMasters.coProyecto, count, 1, consulta, null, true).ToList();
                                    #endregion
        ...
        protected virtual void LoadDetails(bool isDocExist)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentPresupuesto.cs", "LoadDetails"));
            }
        }
        ...
        protected virtual void LoadParticiones(int index, bool isDocExist, TipoMoneda loadByMoneda = TipoMoneda.Both)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentPresupuesto.cs", "LoadParticiones"));
            }
        }
        ...
        {
            Dictionary<string, string> pksActLinea = new Dictionary<string, string>();
            pksActLinea.Add("LineaPresupuestoID", lineaPresup);
            pksActLinea.Add("ActividadID", this.detList[indexRow].ActividadID.Value);
            DTO_plActividadLineaPresupuestal actividadLinea = (DTO_plActividadLineaPresupuestal)_bc.GetMasterComplexDTO(AppMasters.plActividadLineaPresupuestal, pksActLinea, true);

            DTO_plLineaPresupuesto lineaPres = (DTO_plLineaPresupuesto)this._bc.GetMasterDTO(AppMasters.MasterType.Simple, AppMasters.plLineaPresupuesto, false, lineaPresup, true);
            this.detList[indexRow].LineaPresDesc.Value = lineaPres.Descriptivo.Value;
            if (actividadLinea != null)
            {
                if (this.actividadLineaPresupInd && (actividadLinea.ControlCosto.Value == (byte)ControlCosto.Variable ||
                                                     actividadLinea.ControlCosto.Value == (byte)ControlCosto.Estacionario))
                {
                    #region Asigna porcentajes de particion variable
                    DTO_glLocFisica locFisica = (DTO_glLocFisica)_bc.GetMasterDTO(AppMasters.MasterType.Hierarchy, AppMasters.glLocFisica, false, this.detList[indexRow].LocFisicaID.Value, true);
                    if (locFisica != null)
                    {
                        Dictionary<string, string> pks = new Dictionary<string, string>();
                        pks.Add("PeriodoID", this.dtPeriod.DateTime.ToShortDateString());
                        ...
                        if (distribxMes != null)
                        {
                            ...
                            this.detList[indexRow].Porcentaje01.Value = periodo <= 1 ? Math.Round(distribxMes.Porcentaje01.Value.Value * porcentajeAjuste, 3) : 0;
                            this.detList[indexRow].Porcentaje02.Value = periodo <= 2 ? Math.Round(distribxMes.Porcentaje02.Value.Value * porcentajeAjuste, 3) : 0;
                            this.detList[indexRow].Porcentaje03.Value = periodo <= 3 ? Math.Round(distribxMes.Porcentaje03.Value.Value * porcentajeAjuste, 3) : 0;
                            this.detList[indexRow].Porcentaje04.Value = periodo <= 4 ? Math.Round(distribxMes.Porcentaje04.Value.Value * porcentajeAjuste, 3) : 0;
                            this.detList[indexRow].Porcentaje05.Value = periodo <= 5 ? Math.Round(distribxMes.Porcentaje05.Value.Value * porcentajeAjuste, 3) : 0;
                            this.detList[indexRow].Porcentaje06.Value = periodo <= 6 ? Math.Round(distribxMes.Porcentaje06.Value.Value * porcentajeAjuste, 3) : 0;
                            this.detList[indexRow].Porcentaje07.Value = periodo <= 7 ? Math.Round(distribxMes.Porcentaje07.Value.Value * porcentajeAjuste, 3) : 0;
                            this.detList[indexRow].Porcentaje08.Value = periodo <= 8 ? Math.Round(distribxMes.Porcentaje08.Value.Value * porcentajeAjuste, 3) : 0;
                            this.detList[indexRow].Porcentaje09.Value = periodo <= 9 ? Math.Round(distribxMes.Porcentaje09.Value.Value * porcentajeAjuste, 3) : 0;
                            this.detList[indexRow].Porcentaje10.Value = periodo <= 10 ? Math.Round(distribxMes.Porcentaje10.Value.Value * porcentajeAjuste, 3) : 0;
                            this.detList[indexRow].Porcentaje11.Value = periodo <= 11 ? Math.Round(distribxMes.Porcentaje11.Value.Value * porcentajeAjuste, 3) : 0;
                            this.detList[indexRow].Porcentaje12.Value = periodo <= 12 ? Math.Round(distribxMes.Porcentaje12.Value.Value * porcentajeAjuste, 3) : 0;
                        }
                        else
                        {
                        ...
                        MessageBox.Show("NO existe Loc Fisica del Proyecto");
                    #endregion
                }
                else
                {
        ...
        protected virtual void LoadFooter(int index)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentPresupuesto.cs", "LoadFooter"));
            }
        }
        ...
        protected virtual void ShowFKModal(int row, string col, ButtonEdit be)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentPresupuesto.cs", "ShowFKModal"));
            }
            finally
            {
        ...
        protected void masterProyecto_Leave(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentPresupuesto", "masterProyecto_Leave"));
            }
        }
        ...
        protected virtual void dtPeriod_EditValueChanged()
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentPresupuesto", "dtPeriod_EditValueChanged"));
            }
        }
        ...
        protected void txt_Mes_Leave(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentPresupuesto", "txt_Mes_Leave"));
            }
        }
        ...
        protected virtual void riPopup_QueryPopUp(object sender, CancelEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentPresupuesto.cs", "riPopup_QueryPopUp"));
            }
        }
        ...
        private void btnNew_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                this.detList = new List<DTO_plPresupuestoDeta>();
                this.presupuesto = this._bc.AdministrationModel.PresupuestoPxQ_GetPresupuestoPxQConsolidado(this.documentID, this.masterProyecto.Value, this.periodo,
                                                        Convert.ToByte(this.cmbTipoProyecto.EditValue), this.masterContrato.Value, this.masterActividad.Value, this.masterCampo.Value, (byte)EstadoDocControl.ParaAprobacion);
                if (presupuesto != null)
                {
                    #region Obtiene el detalle
                    foreach (DTO_plPresupuestoPxQDeta pxq in presupuesto.DetallesPxQ)
                    {
                        DTO_plPresupuestoDeta deta = new DTO_plPresupuestoDeta(true);
                        DTO_plPresupuestoTotal total = new DTO_plPresupuestoTotal();
                        total.ProyectoID.Value = pxq.ProyectoID.Value;
                        total.CentroCostoID.Value = pxq.CentroCostoID.Value;
                        total.LineaPresupuestoID.Value = pxq.LineaPresupuestoID.Value; 
                        total.Ano.Value = pxq.Ano.Value;
                        List<DTO_plPresupuestoTotal> presupuestoTotal = this._bc.AdministrationModel.plPresupuestoTotal_GetByParameter(total);

                        deta.ProyectoID.Value = pxq.ProyectoID.Value;
                        #region Carga LocFisica
                        if (cacheLocFisicas.ContainsKey(pxq.LocFisicaID.Value))
                            _locFisica = cacheLocFisicas[pxq.LocFisicaID.Value];
                        else
                        {
                            _locFisica = (DTO_glLocFisica)this._bc.GetMasterDTO(AppMasters.MasterType.Hierarchy, AppMasters.glLocFisica, false, pxq.LocFisicaID.Value, true);
                            cacheLocFisicas.Add(pxq.LocFisicaID.Value, _locFisica);
                        }
                        #endregion
                        if (_locFisica != null)
                            deta.AreaFisicaID.Value = _locFisica.AreaFisica.Value;
                        deta.CentroCostoID.Value = pxq.CentroCostoID.Value;
                        deta.LineaPresupuestoID.Value = pxq.LineaPresupuestoID.Value;
                        deta.ActividadID.Value = pxq.ActividadID.Value;
                        deta.ContratoID.Value = pxq.ContratoID.Value;
                        deta.LocFisicaID.Value = pxq.LocFisicaID.Value;
                        deta.VlrMvtoLocal.Value = pxq.PresupuestoLoc.Value;
                        deta.VlrMvtoExtr.Value = pxq.PresupuestoExt.Value;
                        deta.VlrSaldoAntLoc.Value = presupuestoTotal.Sum(x=>x.VlrSaldoAntLoc.Value);
                        deta.VlrSaldoAntExtr.Value = presupuestoTotal.Sum(x => x.VlrSaldoAntExtr.Value);
                        deta.NumeroDoc.Value = pxq.NumeroDoc.Value;
                        this.detList.Add(deta);
                    }
                     this.detList =  this.detList.FindAll(x=>x.VlrMvtoLocal.Value != 0 || x.VlrMvtoExtr.Value != 0);
                    for (int i = 0; i < this.detList.Count; i++)
                    {
                        this.LoadParticiones(i, false);
                        this.LoadPorcent(this.detList[i].LineaPresupuestoID.Value, i);
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentPresupuesto", "btnNew_Click"));
            }
        }
        ...
        private void cmbTipoProyecto_EditValueChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    this.gvDetail.Columns[this.unboundPrefix + "AreaFisicaID"].VisibleIndex = 0;
                    this.gvDetail.Columns[this.unboundPrefix + "AreaFisicaID"].Visible = true;
                    this.gvDetail.Columns[this.unboundPrefix + "ActividadID"].VisibleIndex = 1;
                    this.gvDetail.Columns[this.unboundPrefix + "ActividadID"].Visible = true;
                    this.gvDetail.Columns[this.unboundPrefix + "CentroCostoID"].Visible = false;
                    this.masterProyecto.EnableControl(false);
                ...
                {
                    this.gvDetail.Columns[this.unboundPrefix + "AreaFisicaID"].Visible = false;
                    this.gvDetail.Columns[this.unboundPrefix + "ActividadID"].Visible = false;
                    this.gvDetail.Columns[this.unboundPrefix + "CentroCostoID"].VisibleIndex = 0;
                    this.gvDetail.Columns[this.unboundPrefix + "CentroCostoID"].Visible = true;
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentPresupuesto.cs", "cmbProyectoTipo_EditValueChanged"));
            }
        }
        #endregion
        ...
        protected void editBtn_Doc_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentPresupuesto.cs", "editBtn_Doc_ButtonClick"));
            }
        }
        ...
        protected void gcDetail_Enter(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentPresupuesto.cs", "gcDetail_Enter"));
            }
        }
        ...
        protected void gcDetail_EmbeddedNavigator_ButtonClick(object sender, DevExpress.XtraEditors.NavigatorButtonClickEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentPresupuesto.cs", "gcDetail_EmbeddedNavigator_ButtonClick"));
            }
        }
        ...
        protected void gvDetail_CellValueChanged(object sender, DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentPresupuesto.cs", "gvDocument_CellValueChanged"));
            }
        }
        ...
        protected void editBtn_Det_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentPresupuesto.cs", "editBtn_Det_ButtonClick"));
            }
        }
        ...
        private void Form_Enter(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp", "DocumentPresupuesto.cs-Form_Enter"));
            }
        }
        ...
        private void Form_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp", "DocumentPresupuesto.cs-Form_Closing"));
            }
        }
        ...
        private void Form_FormClosed(object sender, FormClosedEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp", "DocumentPresupuesto.cs-Form_FormClosed"));
            }
        }
        ...
        public override void TBNew()
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentPresupuesto.cs", "TBDelete"));
            }
        }
        ...
        public override void TBGenerateTemplate()
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentPresupuesto.cs", "TBGenerateTemplate"));
            }
        }
        ...
        public virtual void SaveThread()
        {
            try
            {
                ...
                obj = _bc.AdministrationModel.Presupuesto_Nuevo(this.documentID, this.dtPeriod.DateTime, this.proyectoID, tc, this.presupuesto, true);
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentPresupuesto.cs", "SendToApproveThread"));
            }
            finally
            {
                FormProvider.Master.StopProgressBarThread(this.documentID);
        ...
        public virtual void SendToApproveThread()
        {
            try
            {
                ...
                this.presupuesto.Detalles = this.detList;
                this.presupuesto.NumeroDocPresup.Value = this.numeroDocPresup;
                obj = _bc.AdministrationModel.Presupuesto_Nuevo(this.documentID, this.dtPeriod.DateTime, this.proyectoID, tc, this.presupuesto, false);
                            ...
                            if (createDTO)
                            {
                                for (int colIndex = 0; colIndex < cols.Count; colIndex++)
                                {
                                    ...
                                    catch (Exception ex1)
                                    {
                                        DTO_TxResultDetailFields rdF = new DTO_TxResultDetailFields();
                                        rdF.Field = colRsx;
                                        rdF.Message = this._bc.GetResourceForException(ex1, "WinApp", "DocumentPresupuesto.cs - Creacion de DTO y validacion Formatos");
                                        rd.DetailsFields.Add(rdF);
                                        createDTO = false;
                                    }
                                }
        ...
        public void SetConsulta(DTO_glConsulta consulta, List<ConsultasFields> fields)
        {
            try
            {
                ...
                this.gvDetail.ActiveFilterString = filtros;
                if (this.gvDetail.RowCount > 0)
                    this.RowIndexChanged_Det(0);
            }
            catch (Exception ex)
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumentPresupuesto.cs", "SetConsulta"));
            }
            finally
            {
                this.disableValidate_Det = false;
