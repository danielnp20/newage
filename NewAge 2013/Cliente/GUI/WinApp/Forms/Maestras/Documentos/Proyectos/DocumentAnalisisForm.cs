...
namespace NewAge.Cliente.GUI.WinApp.Forms
{
    ...
    /// </summary>
    public partial class DocumentAnalisisForm : FormWithToolbar, IFiltrable
    {
        #region Delegados
        ...
        public DTO_pyPreProyectoDocu _doc = null;
        public List<DTO_pySolServicio> _lista = null;
        ...
        public DocumentAnalisisForm()
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DocumenAnalisisForm.cs", "DocumenAnalisisForm"));
            }
        }
        ...
        /// <summary>
        /// Llena los campos del Header con la información del encabezado
        /// </summary>
        ...
        protected virtual void txtNro_Leave(object sender, System.EventArgs e)
        {
            try
            {
                ...
                {
                    this._ctrl = this._bc.AdministrationModel.pyServicioDocu_GetInternalDoc(AppDocuments.PreProyecto, this.uc_Prefijo.Value, Convert.ToInt32(this.txtNro.Text), this._actFlujo.ID.Value);
                    if (this._ctrl != null)
                    {
                        this._doc = this._bc.AdministrationModel.pyPreProyectoDocu_Get(this._ctrl.NumeroDoc.Value.Value);
                        this._lista = this._bc.AdministrationModel.pyServicioDeta_GetSolicitud(this._ctrl.NumeroDoc.Value.Value, this.uc_ClaseServicio.Value, string.Empty);
                        this.uc_AreaFuncional.Value = this._ctrl.AreaFuncionalID.Value;
                        this.uc_Cliente.Value = this._doc.ClienteID.Value;
                        this.uc_Proyecto.Value = this._ctrl.ProyectoID.Value;
                        this.uc_Responsable.Value = this._doc.ResponsableEMP.Value;
