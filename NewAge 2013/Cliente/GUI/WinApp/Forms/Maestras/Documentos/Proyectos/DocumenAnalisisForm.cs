...
namespace NewAge.Cliente.GUI.WinApp.Forms
{
    ...
    /// </summary>
    public partial class DocumenAnalisisForm : FormWithToolbar, IFiltrable
    {
        #region Delegados
        ...
        private void LoadDocumentInfo(bool firstTime)
        {
            try
            {
                if (firstTime)
                {
                    ...
                    this._bc.InitMasterUC(this.uc_Cliente, AppMasters.pyContrato, true, true, false, false);
                    this._bc.InitMasterUC(this.uc_Actividad, AppMasters.pyActividadTarea, true, true, false, false);
                }
            }
            catch (Exception ex)
            {
