                ...
                switch (value)
                {
                    case AppReportParametersForm.coBalancePrueba:
                        ...
                        List<ReportParameterListItem> tipoReporteBalancePrueba = new List<ReportParameterListItem>(){
                            ...
                            new ReportParameterListItem() { Key = "EstResultadosMes", Desc = _bc.GetResource(LanguageTypes.Tables, "Estado de Resultados Mensualizado") } };
                        ...
                        this.AddMaster("ProyectoID", AppMasters.coProyecto, true, null, false);
                        this.AddMaster("CentroCostoID", AppMasters.coCentroCosto, true, null, false);
