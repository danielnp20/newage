...
{
    public partial class MigracionNomina : ProcessForm
    {
        #region Delegados
        ...
        public void EndImportarMethod()
        {
            ...
            if (this._isOK)
            {
                ...
                this.txtDocTercero.Text = this.docTercero;
            ...
            else
            {
                ...
                this.masterCentroPago.Enabled = true;
        ...
        private string docTercero = string.Empty;
        ...
        {
            this.documentID = AppProcess.MigracionNomina;
            ...
            this._clienteRsx = _bc.GetResource(LanguageTypes.Forms, this.documentID + "_ClienteID");
            ...
            dic.Add("1", this._bc.GetResource(LanguageTypes.Tables, this.documentID.ToString() + "_tbl_Mensual"));
            dic.Add("2", this._bc.GetResource(LanguageTypes.Tables, this.documentID.ToString() + "_tbl_Quincenal"));
            ...
            //Asigna el formato
            this.format = _bc.GetImportExportFormat(typeof(DTO_ccIncorporacionDeta), this.documentID);

            //Carga los recuros
            FormProvider.LoadResources(this, AppProcess.MigracionNomina);
        }
            ...
            string msgClienteRepetido, string msgCodAndCliente)
        {
            try
            {
                ...
                if (dto.FechaNomina.Value.Value < this.fechaIni || dto.FechaNomina.Value.Value > this.fechaFin)
                {
                    DTO_TxResultDetailFields rdF = new DTO_TxResultDetailFields();
                    rdF.Field = _bc.GetResource(LanguageTypes.Forms, this.documentID + "_FechaNomina"); ;
                ...
                if (string.IsNullOrWhiteSpace(dto.ClienteID.Value) && string.IsNullOrWhiteSpace(dto.CodEmpleado.Value) && (dto.Libranza.Value == null))
                {
                    ...
                    rdF.Field = _bc.GetResource(LanguageTypes.Forms, this.documentID + "_ClienteID") +
                            _bc.GetResource(LanguageTypes.Forms, this.documentID + "_CodEmpleado") +
                            _bc.GetResource(LanguageTypes.Forms, this.documentID + "_Libranza");
                ...
                {
                    DTO_TxResultDetailFields rdF = new DTO_TxResultDetailFields();
                    rdF.Field = _bc.GetResource(LanguageTypes.Forms, this.documentID + "_ValorCuota");
                ...
                {
                    DTO_TxResultDetailFields rdF = new DTO_TxResultDetailFields();
                    rdF.Field = _bc.GetResource(LanguageTypes.Forms, this.documentID + "_CodEmpleado"); ;
                ...
                {
                    DTO_TxResultDetailFields rdF = new DTO_TxResultDetailFields();
                    rdF.Field = _bc.GetResource(LanguageTypes.Forms, this.documentID + "_ClienteID") + _bc.GetResource(LanguageTypes.Forms, this.documentID + "_CodEmpleado");
                ...
                {
                    if (codigos.ContainsKey(dto.CodEmpleado.Value))
                    {
                    ...
                    else
                    {
                        ...
                        clientes.Add(dto.CodEmpleado.Value, val);
                    }
                }
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-MigracionNomina.cs", "ValidateDataImport"));
            }
        }
        ...
        private void masterCentroPago_Leave(object sender, EventArgs e)
        {
            try
            {
                if (this.centroPagoID != this.masterCentroPago.Value)
                {
                    ...
                    if (loadCP)
                    {
                        ...
                        if (masterCentroPago.ValidID)
                        {
                            DTO_ccCentroPagoPAG centroPag = (DTO_ccCentroPagoPAG)this._bc.GetMasterDTO(AppMasters.MasterType.Simple, AppMasters.ccCentroPagoPAG, false, this.masterCentroPago.Value, true);
                            this.pagaduria = (DTO_ccPagaduria)this._bc.GetMasterDTO(AppMasters.MasterType.Simple, AppMasters.ccPagaduria, false, centroPag.PagaduriaID.Value, true);
                            ...
                            bool isMensual = this.pagaduria.PeriodoPago.Value.Value == 1 ? true : false;
                            int año = this.dtFecha.DateTime.Year;
                            int mes = this.dtFecha.DateTime.Month;
                            if (isMensual)
                            {
                                this.fechaIni = new DateTime(año, mes, 1);
                                this.fechaFin = new DateTime(año, mes, DateTime.DaysInMonth(año, mes));
                            }
                            else
                            {
                                if (this.dtFecha.DateTime.Day <= 15)
                                    this.fechaFin = new DateTime(año, mes, 15);
                                else
                                    this.fechaIni = new DateTime(año, mes, 15);
                            }
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-MigracionNomina.cs", "masterCentroPago_Leave"));
            }
        }
        ...
        {
            if (!string.IsNullOrWhiteSpace(this.txtDocTercero.Text))
                this.btnImportar.Enabled = this.masterCentroPago.ValidID ? true : false;
        }
        ...
        private void btnTemplate_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-MigracionNomina.cs", "btnTemplate_Click"));
            }
        }
        ...
        private void btnImportar_Click(object sender, EventArgs e)
        {
            ...
            if (loadData)
            {
                ...
                this.masterCentroPago.Enabled = false;
                this.dtFecha.Enabled = false;
                this.txtDocTercero.Enabled = false;

                this.docTercero = this.txtDocTercero.Text;
        ...
        public void ImportThread()
        {
            try
            {
                if (this.pasteRet.Success)
                {
                            ...
                            if (createDTO)
                            {
                                ...
                                for (int colIndex = 0; colIndex < colNames.Count(); colIndex++)
                                {
                                    ...
                                    catch (Exception ex1)
                                    {
                                        DTO_TxResultDetailFields rdF = new DTO_TxResultDetailFields();
                                        rdF.Field = colRsx;
                                        rdF.Message = _bc.GetResourceForException(ex1, "WinApp", "MigracionNomina.cs - Creacion de DTO y validacion Formatos");
                                        rd.DetailsFields.Add(rdF);
                    ...
                    if (validList)
                    {
                        ...
                        this.result = _bc.AdministrationModel.MigracionNomida_Validar(this.documentID, ref this.numeroDoc, this.periodo, this.centroPagoID, this.pagaduria.ID.Value,
                            ref this.docTercero, this.fechaIni, this.fechaFin, ref this.data);
            ...
            catch (Exception ex)
            {
                ...
                this._isOK = false;
                this.result.Result = ResultValue.NOK;
                this.result.ResultMessage = _bc.GetResourceForException(ex, "WinApp-MigracionNomina.cs", "ProcesarThread");
            }
            finally
            {
        ...
        private void ProcesarThread()
        {
            try
            {
                ...
                this.result = _bc.AdministrationModel.MigracionNomina_Procesar(this.documentID, ref this.numeroDoc, this.centroPagoID, this.pagaduria.ID.Value, 
                    this.txtDocTercero.Text, this.dtPeriod.DateTime, this.dtFecha.DateTime, this.data);
                this.StopProgressBarThread();
            }
            catch (Exception ex)
            {
        ...
        private void PagarThread()
        {
            try
            {
                ...
                this.result = _bc.AdministrationModel.MigracionNomina_Pagar(this.documentID, this._actFlujo.ID.Value, this.numeroDoc, this.periodo, 
                    this.dtFecha.DateTime, this.centroPagoID, this.data);
            ...
            catch (Exception ex)
            {
                this._isOK = false;
                this.result.Result = ResultValue.NOK;
                this.result.ResultMessage = _bc.GetResourceForException(ex, "WinApp-MigracionNomina.cs", "PagarThread");
            }
            finally
            {
