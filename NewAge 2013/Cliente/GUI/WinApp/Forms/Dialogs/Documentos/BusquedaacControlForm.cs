...
namespace NewAge.Cliente.GUI.WinApp.Forms
{
    public partial class BusquedaacControlForm : Form
    {
        ...
        private void uc_Saldos_PerEditPeriodo_Leave(object sender, EventArgs e)
        {
            ...
            this._acActivoSaldo = this._bc.AdministrationModel.acCargarSaldos(_activoID, Convert.ToDateTime(periodoSaldos), _acClaseID);
            this.LoadPageData(2);
        }
        #endregion
        ...
        private void cmbAñoMLocal_Leave(object sender, EventArgs e)
        {
            ...
            this._acActivoSaldoMonedaLocal = this._bc.AdministrationModel.acCargarSaldos_Meses(año.ToString(), this._activoID, this._acClaseID, true);
        ...
        private void cmbAñoMExtranjera_Leave(object sender, EventArgs e)
        {
            ...
            this._acActivoSaldoMonedaExtranjera = this._bc.AdministrationModel.acCargarSaldos_Meses(añoExtra.ToString(), this._activoID, this._acClaseID, false);
                ...
                if (info.HitTest != GridHitTest.Column)
                {
                    ...
                    if (MessageBox.Show(msgGetData, msgTitleData, MessageBoxButtons.YesNo) == DialogResult.Yes)
                    {
                        if (info.InRow || info.InRowCell)
                        {
                            ...
                            this._acActivoSaldo = this._bc.AdministrationModel.acCargarSaldos(_activoID, period, _acClaseID);
                            ...
                            this._acActivoSaldoMonedaLocal = this._bc.AdministrationModel.acCargarSaldos_Meses(añoLocal.ToString(), this._activoID, this._acClaseID, true);
                            ...
                            this._acActivoSaldoMonedaExtranjera = this._bc.AdministrationModel.acCargarSaldos_Meses(añoExtranjera.ToString(), this._activoID, this._acClaseID, false);
