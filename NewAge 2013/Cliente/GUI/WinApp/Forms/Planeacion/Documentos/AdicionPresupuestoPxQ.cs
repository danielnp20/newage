...
{
    public partial class AdicionPresupuestoPxQ : DocumentPresupuestoPxQ
    {
        /// <summary>
        /// Constructor del Documento
        /// </summary>
        public AdicionPresupuestoPxQ()
        {
            try
            {
                //InitializeComponent();
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-AdicionPresupuestoPxQ.cs", "AdicionPresupuestoPxQ"));
            }
        }
        ...
        protected override void SetInitParameters()
        {
            try
            {
                this.documentID = AppDocuments.AdicionPresupuestoPxQ;
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-AdicionPresupuestoPxQ.cs", "SetInitParameters"));
            }
        }
