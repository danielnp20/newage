...
namespace NewAge.Cliente.GUI.WinApp.Forms
{
    ...
    /// </summary>
    public partial class GenerarPresupuestoAprob : DocumentAprobBasicForm
    {
        #region Variables
        ...
        {
            this.documentID = AppDocuments.GenerarPresupuestoAprob;
        ...
        protected override void AfterInitialize()
        {
            ...
            this.cmbUserTareas.Items.Add(this._bc.GetResource(LanguageTypes.Forms, AppDocuments.AreaPresupAprob.ToString()));
            this.cmbUserTareas.Items.Add(this._bc.GetResource(LanguageTypes.Forms, AppDocuments.ConsolidacionAprob.ToString()));
            this.cmbUserTareas.Items.Add(this._bc.GetResource(LanguageTypes.Forms, AppDocuments.GenerarPresupuestoAprob.ToString()));
        ...
        protected override void cmbUserTareas_SelectedValueChanged(object sender, EventArgs e)
        {
            ...
            if (cmb.SelectedIndex == 0)
                this.documentID = AppDocuments.AreaPresupAprob;
            else if (cmb.SelectedIndex == 1)
                this.documentID = AppDocuments.ConsolidacionAprob;
            else
                this.documentID = AppDocuments.GenerarPresupuestoAprob;
