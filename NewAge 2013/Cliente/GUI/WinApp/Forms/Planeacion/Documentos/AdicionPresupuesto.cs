...
{
    public partial class AdicionPresupuesto : DocumentPresupuesto
    {
        /// <summary>
        /// Constructor del Documento
        /// </summary>
        public AdicionPresupuesto()
        {
            try
            {
                //InitializeComponent();
        ...
        protected override void SetInitParameters()
        {
            try
            {
                this.documentID = AppDocuments.AdicionPresupuesto;
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-AdicionPresupuesto.cs", "SetInitParameters"));
            }
        }
        ...
        protected override void LoadData()
        {
            try
            {
                if (this.masterProyecto.ValidID)
                {
                    ...
                    {
                        string msg = this._bc.GetResourceError(DictionaryMessages.Err_CodeIncompleteFK);
                    ...
                    this.presupuesto = this._bc.AdministrationModel.Presupuesto_GetConsolidadoTotal(AppDocuments.AdicionPresupuesto, this.masterProyecto.Value, this.periodo,
                    ...
                    else
                    {
                        ...
                        #endregion
                        #region Carga Detalle(Verifica si existe la Adicion)
                        DTO_Presupuesto adicionExist = this._bc.AdministrationModel.Presupuesto_GetNuevo(AppDocuments.AdicionPresupuesto, this.masterProyecto.Value, this.periodo);
