...
namespace NewAge.Cliente.GUI.WinApp.Forms
{
    ...
    /// </summary>
    public partial class RevertirFacturacion : DocumentReversiones
    {       
        ...
        {
            this.documentID = AppDocuments.RevertirFacturacion;
        ...
        protected override void InitControls()
        {
            ...
            doc = (DTO_glDocumento)this._bc.GetMasterDTO(AppMasters.MasterType.Simple, AppMasters.glDocumento, true, AppDocuments.FacturaVenta.ToString(), true);
            this.docs.Add(doc);
            doc = (DTO_glDocumento)this._bc.GetMasterDTO(AppMasters.MasterType.Simple, AppMasters.glDocumento, true, AppDocuments.NotaCredito.ToString(), true);
            this.docs.Add(doc);
        ...
        public override void SaveThread()
        {
            try
            {
                ...
                else if (temps.Count == 1)
                {
                    ...
                    if (MessageBox.Show(msgDelete, msgTitleDelete, MessageBoxButtons.YesNo) == DialogResult.Yes)
                    {
                        ...
                        DTO_TxResult result = this._bc.AdministrationModel.Facturacion_Revertir(this.documentID, numDoc);
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-RevertirFacturacion.cs", "SaveThread"));
            }
            finally
            {
                FormProvider.Master.StopProgressBarThread(this.documentID);
