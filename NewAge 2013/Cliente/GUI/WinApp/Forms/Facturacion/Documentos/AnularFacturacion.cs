...
namespace NewAge.Cliente.GUI.WinApp.Forms
{
    ...
    /// </summary>
    public partial class AnularFacturacion  : DocumentAnulaciones
    {       
        ...
        {
            this.documentID = AppDocuments.AnularFacturacion;
        ...
        public override void SaveThread()
        {
            try
            {
                ...
                if (MessageBox.Show(msgDelete, msgTitleDelete, MessageBoxButtons.YesNo) == DialogResult.Yes)
                {
                    ...
                    DTO_TxResult result = this._bc.AdministrationModel.FacturaVenta_Anular(this.documentID, numDocSelected);
