...
{
    public partial class TrasladoSaldoInventario : ProcessForm
    {
        ...
        /// CONSTRUCTOR
        /// </summary>
        public TrasladoSaldoInventario() : base() { }
        ...
        {
            this.documentID = AppProcess.TrasladoSaldoInventario;
            ...
            string periodoStr = _bc.GetControlValueByCompany(ModulesPrefix.@in, AppControl.in_Periodo);
        ...
        private void ProcesarThread()
        {
            try
            {
                ...
                DTO_TxResult result = this._bc.AdministrationModel.Proceso_TrasladoSaldosInventario(this.documentID, this.uc_Periodo.DateTime);
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-TrasladoSaldoInventario.cs", "ProcesarThread"));
                this.StopProgressBarThread();
            }
