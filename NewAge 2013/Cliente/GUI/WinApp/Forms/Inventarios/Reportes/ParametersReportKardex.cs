...
{
    class ParametersReportKardex : ReportParametersForm
    {
        #region Hilos
                    ...
                    case "1":
                        {
                            if (_parametro == true)
                            {
                                reportName = this._bc.AdministrationModel.ReportesInventarios_KardexDetallado(this._fechaIni.Year, this._fechaIni.Month, this._bodega,
                            ...
                            {
                                reportName = this._bc.AdministrationModel.ReportesInventarios_KardexSinParametros(this._fechaIni.Year, this._fechaIni.Month, this._bodega,
                                    this._tipoBodega, this._referencia, this._grupo, this._clase, this._tipo, this._serie, this._material, _isSerializable, this._formatType);
                                fileURl = this._bc.UrlDocumentFile(TipoArchivo.Temp, null, null, reportName.ToString());
                                Process.Start(fileURl);
                            }
                    ...
                    case "2":
                        {
                            if (_parametro == true)
                            {
                                reportName = this._bc.AdministrationModel.ReportesInventarios_KardexxReferencia(this._fechaIni.Year, this._fechaIni.Month, this._bodega,
                                  this._tipoBodega, this._referencia, this._grupo, this._clase, this._tipo, this._serie, this._material, _isSerializable, this._formatType);
                                fileURl = this._bc.UrlDocumentFile(TipoArchivo.Temp, null, null, reportName.ToString());
                                Process.Start(fileURl);
                            }
                            ...
                            {
                                reportName = this._bc.AdministrationModel.ReportesInventarios_KardexSinParametrosxReferencia(this._fechaIni.Year, this._fechaIni.Month, this._bodega,
                                    this._tipoBodega, this._referencia, this._grupo, this._clase, this._tipo, this._serie, this._material, _isSerializable, this._formatType);
                                fileURl = this._bc.UrlDocumentFile(TipoArchivo.Temp, null, null, reportName.ToString());
                                Process.Start(fileURl);
                            }
        ...
        protected override void InitReport()
        {
            ...
            this.Text = _bc.GetResource(Librerias.Project.LanguageTypes.Forms, (AppReports.inKardex).ToString());
            ...
            //this.AddCheck("Detalle",(AppForms.ReportForm).ToString() + "_DetallexSerial", false);
