...
namespace NewAge.Cliente.GUI.WinApp.Forms
{
    ...
    /// </summary>
    public partial class RevertirInventarios : DocumentReversiones
    {       
        ...
        protected override void InitControls()
        {
            ...
            doc = (DTO_glDocumento)this._bc.GetMasterDTO(AppMasters.MasterType.Simple, AppMasters.glDocumento, true, AppDocuments.GenerarPresupuesto.ToString(), true);
            this.docs.Add(doc);
