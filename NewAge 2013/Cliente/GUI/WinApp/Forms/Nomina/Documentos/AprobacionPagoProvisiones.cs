...
{
    public partial class AprobacionPagoProvisiones : DocumentNominaAprobacionForm
    {
        #region Variables
        ...
        private List<DTO_noProvisionDeta> _liquidaciones = null;
        private bool IsFirstTime = false;
        Dictionary<int, List<DTO_noProvisionDeta>> _repositoryTemp = new Dictionary<int, List<DTO_noProvisionDeta>>();
        ...
        protected override void LookUpDocumentosDataSource()
        {
            ...
            dtoDoc = (DTO_glDocumento)_bc.GetMasterDTO(AppMasters.MasterType.Simple, AppMasters.glDocumento, true, AppDocuments.PagoProvisionesAprob.ToString(), true);
        ...
        protected override void LoadData()
        {
            if (this.IsFirstTime)
            {
                ...
                {
                    this.Liquidaciones = null;//this._bc.AdministrationModel.Nomina_NominaPreliminarGet(this.actividadFlujoID, this.dtPeriod.DateTime);
                ...
                this.gcDocument.DataSource = (from r in this._repositoryTemp
        ...
        public override void SaveThread()
        {
            try
            {
                ...
                else
                {
                    ...
                    DTO_TxResult result = new DTO_TxResult();// this._bc.AdministrationModel.Nomina_AprobarLiquidacion(this.Liquidaciones, this.actividadFlujoID);
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp_AprobacionPagoProvisiones", "SaveThread"));
            }
            finally
            {
                FormProvider.Master.StopProgressBarThread(this.documentID);
        ...
        /// </summary>
        protected virtual List<DTO_noProvisionDeta> Liquidaciones
        {
