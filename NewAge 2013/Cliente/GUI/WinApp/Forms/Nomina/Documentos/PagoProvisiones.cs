...
{
    public partial class PagoProvisiones : DocumentNominaPagosForm
    {
        #region Variables
        ...
        protected override void LookUpDocumentosDataSource()
        {
            ...
            dtoDoc = (DTO_glDocumento)_bc.GetMasterDTO(AppMasters.MasterType.Simple, AppMasters.glDocumento, true, AppDocuments.PagoProvisiones.ToString(), true);
        ...
        public override void SaveThread()
        {
            try
            {
                ...
                var result = this._bc.AdministrationModel.Nomina_PagoNomina(this.documentID, this.dtPeriod.DateTime, this.dtFecha.DateTime, this.Liquidaciones, this.actividadFlujoID);
