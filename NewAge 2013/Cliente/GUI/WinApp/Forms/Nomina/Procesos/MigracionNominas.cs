...
{
    public partial class MigracionNominas : ProcessForm
    {
        #region Delegados
        ...
        private string _fondoRsx = string.Empty;
        //Variables del formulario
        private bool _isOK;
        private List<DTO_noMigracionNomina> _data;
        #endregion
        ...
        protected override void InitForm()
        {
            try
            {
                this.documentID = AppProcess.MigracionNominas1;
                ...
                this._isOK = false;
                this.btnGenerar.Enabled = false;
                this._data = new List<DTO_noMigracionNomina>();
        ...
        private void InitVars()
        {
            ...
            this._fondoRsx = _bc.GetResource(LanguageTypes.Forms, this.documentID + "_FondoNOID");
        }
        ...
        {
            string templateFormat = _bc.GetImportExportFormat(typeof(DTO_noMigracionNomina), this.documentID);
        ...
        private int GetMasterDocumentID(string colName)
        {
            ...
            //Moneda
            if (colName == this._fondoRsx)
                return AppMasters.noFondo;          
        ...
        private void ImportThread()
        {
            try
            {
                if (this.pasteRet.Success)
                {
                    ...
                    List<DTO_noMigracionNomina> list = new List<DTO_noMigracionNomina>();
                    ...
                    DTO_noMigracionNomina det = new DTO_noMigracionNomina();
                    bool createDTO = true;
                    bool validList = true;
                    #endregion
                    ...
                    PropertyInfo[] pis = typeof(DTO_noMigracionNomina).GetProperties();
                                ...
                                for (int colIndex = 0; colIndex < colNames.Count(); colIndex++)
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        if (string.IsNullOrEmpty(colValue) &&
                                                ...
                                                colName == "TipoLiquidacion" ||
                                                colName == "Periodo" ||
                                                colName == "Valor" ||
                                                colName == "Base" ||
                                                colName == "Origen Concepto" ||
                                                colName == "Dias"
                                              )
                                        )
                                        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-MigracionNominas.cs", "ImportThread"));
            }
            finally
            {
        ...
        private void ProcesarThread()
        {
            try
            {
                ...
                List<DTO_TxResult> results = this._bc.AdministrationModel.Proceso_MigracionNomina(this.documentID, this._data);
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-MigracionNominas.cs", "MigracionNominas.cs-btnProcesar_Click"));
            }
            finally
            {
                this.Invoke(this.UpdateProgressDelegate, new object[] { 0 });
