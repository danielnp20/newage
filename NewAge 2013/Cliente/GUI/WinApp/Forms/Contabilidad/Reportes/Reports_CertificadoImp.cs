...
namespace NewAge.Cliente.GUI.WinApp.Forms
{
    class Reports_CertificadoImp : ReportParametersForm
    {
        ...
        private string _tipoLibro = string.Empty;
        ...
        {  
            try
            {               
                string name = this._bc.AdministrationModel.ReportesContabilidad_GetByParameter(this.documentReportID,this._tipoReport,this._fechaIni,this._fechaFin,this._tipoLibro,string.Empty,null,string.Empty,
