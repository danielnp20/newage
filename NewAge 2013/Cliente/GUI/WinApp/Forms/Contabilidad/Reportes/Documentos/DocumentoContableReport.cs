...
namespace NewAge.Cliente.GUI.WinApp.Reports
{
    ...
    public class DocumentoContableReport : BaseReport
    {
        #region Variables
        ...
        public DocumentoContableReport(int documentId, List<DTO_ReportDocumentoContable> reportList, bool multiMonedaInd, ArrayList fieldList)
        {
            this.lblReportName.Text = _bc.GetResource(Librerias.Project.LanguageTypes.Forms, (AppReports.DocumentoContable).ToString()); ;
            ...
            observacionGroupHeader.HeightF = 40;
            ...
            estadoTableCell_EstadoName.Text = _bc.GetResource(Librerias.Project.LanguageTypes.Forms, (AppReports.DocumentoContable).ToString() + "_Estado") + ":  ";
            ...
            groupHeaderTableCell_Name.Text = _bc.GetResource(Librerias.Project.LanguageTypes.Forms, (AppReports.DocumentoContable).ToString() + "_DocumentoCont");
            ...
            groupHeaderTableCell_Name.BorderColor = Color.White;
            groupHeaderTableCell_Name.Font = new Font("Times New Roman", 9, FontStyle.Bold);
            groupHeaderTableCell_Name.Text = _bc.GetResource(Librerias.Project.LanguageTypes.Forms, (AppReports.DocumentoContable).ToString() + "_MdaOrigen");
            reportHeaderTableRow.Cells.Add(groupHeaderTableCell_Name);
            ...
            groupHeaderTableCell_Name.Font = new Font("Times New Roman", 9, FontStyle.Bold);
            groupHeaderTableCell_Name.BorderColor = Color.White;
            groupHeaderTableCell_Name.Text = _bc.GetResource(Librerias.Project.LanguageTypes.Forms, (AppReports.DocumentoContable).ToString() + "_CuentaID");
            reportHeaderTableRow.Cells.Add(groupHeaderTableCell_Name);
            ...
            groupHeaderTableCell_Name.Font = new Font("Times New Roman", 9, FontStyle.Bold);
            groupHeaderTableCell_Name.BorderColor = Color.White;
            groupHeaderTableCell_Name.Text = _bc.GetResource(Librerias.Project.LanguageTypes.Forms, (AppReports.DocumentoContable).ToString() + "_TerceroID");
            reportHeaderTableRow.Cells.Add(groupHeaderTableCell_Name);
            ...
            groupHeaderTableCell_Name.WidthF = reportHeaderTableCellWidth_Caption;
            groupHeaderTableCell_Name.Font = new Font("Times New Roman", 9, FontStyle.Bold);
            groupHeaderTableCell_Name.Text = _bc.GetResource(Librerias.Project.LanguageTypes.Forms, (AppReports.DocumentoContable).ToString() + "_DocumentoCOM");
            reportHeaderTableRow.Cells.Add(groupHeaderTableCell_Name);
            ...
            groupHeaderTableCell_Name.Font = new Font("Times New Roman", 9, FontStyle.Bold);
            groupHeaderTableCell_Name.BorderColor = Color.White;
            groupHeaderTableCell_Name.Text = _bc.GetResource(Librerias.Project.LanguageTypes.Forms, (AppReports.DocumentoContable).ToString() + "_Nro");
            reportHeaderTableRow.Cells.Add(groupHeaderTableCell_Name);
            ...
            groupHeaderTableCell_ID.Borders = DevExpress.XtraPrinting.BorderSide.Right | DevExpress.XtraPrinting.BorderSide.Bottom;
            groupHeaderTableCell_ID.TextAlignment = DevExpress.XtraPrinting.TextAlignment.TopRight;
            groupHeaderTableCell_ID.DataBindings.Add("Text", reportList, "DocumentoNro");
            reportHeaderTableRow.Cells.Add(groupHeaderTableCell_ID);
            ...
            groupHeaderTableCell_Name.Font = new Font("Times New Roman", 9, FontStyle.Bold);
            groupHeaderTableCell_Name.BorderColor = Color.White;
            groupHeaderTableCell_Name.Text = _bc.GetResource(Librerias.Project.LanguageTypes.Forms, (FormCodes.ReportForm).ToString() + "_Moneda");
            reportHeaderTableRow.Cells.Add(groupHeaderTableCell_Name);
            ...
            groupHeaderTableCell_Name.Font = new Font("Times New Roman", 9, FontStyle.Bold);
            groupHeaderTableCell_Name.BorderColor = Color.White;
            groupHeaderTableCell_Name.Text = _bc.GetResource(Librerias.Project.LanguageTypes.Forms, (AppReports.DocumentoContable).ToString() + "_ProyectoID");
            reportHeaderTableRow.Cells.Add(groupHeaderTableCell_Name);
            ...
            groupHeaderTableCell_Name.Font = new Font("Times New Roman", 9, FontStyle.Bold);
            groupHeaderTableCell_Name.BorderColor = Color.White;
            groupHeaderTableCell_Name.Text = _bc.GetResource(Librerias.Project.LanguageTypes.Forms, (AppReports.DocumentoContable).ToString() + "_CentroCostoID");
            reportHeaderTableRow.Cells.Add(groupHeaderTableCell_Name);
            ...
            groupHeaderTableCell_Name.WidthF = reportHeaderTableCellWidth_Caption;
            groupHeaderTableCell_Name.Font = new Font("Times New Roman", 9, FontStyle.Bold);
            groupHeaderTableCell_Name.Text = _bc.GetResource(Librerias.Project.LanguageTypes.Forms, (AppReports.DocumentoContable).ToString() + "_LugarGeoID");
            reportHeaderTableRow.Cells.Add(groupHeaderTableCell_Name);
            ...
            reportHeaderTableRow = new XRTableRow();
            reportHeaderTableRow.HeightF = 3 * reportHeaderTable.HeightF / 5;

            groupHeaderTableCell_Name = new XRTableCell();
            groupHeaderTableCell_Name.WidthF = reportHeaderTableCellWidth_Caption;
            groupHeaderTableCell_Name.Font = new Font("Times New Roman", 9, FontStyle.Bold);
            groupHeaderTableCell_Name.BorderColor = Color.White;
            groupHeaderTableCell_Name.Text = _bc.GetResource(Librerias.Project.LanguageTypes.Forms, (AppReports.DocumentoContable).ToString() + "_UsuarioResp");
            reportHeaderTableRow.Cells.Add(groupHeaderTableCell_Name);
            ...
            groupHeaderTableCell_Name.Font = new Font("Times New Roman", 9, FontStyle.Bold);
            groupHeaderTableCell_Name.BorderColor = Color.White;
            groupHeaderTableCell_Name.Text = _bc.GetResource(Librerias.Project.LanguageTypes.Forms, (AppReports.DocumentoContable).ToString() + "_PeriodoID");
            reportHeaderTableRow.Cells.Add(groupHeaderTableCell_Name);
            ...
            groupHeaderTableCell_Name.Font = new Font("Times New Roman", 9, FontStyle.Bold);
            groupHeaderTableCell_Name.BorderColor = Color.White;
            groupHeaderTableCell_Name.Text = _bc.GetResource(Librerias.Project.LanguageTypes.Forms, (AppReports.DocumentoContable).ToString() + "_Fecha");
            reportHeaderTableRow.Cells.Add(groupHeaderTableCell_Name);
            ...
            groupHeaderTableCell_Name.Font = new Font("Times New Roman", 9, FontStyle.Bold);
            groupHeaderTableCell_Name.BorderColor = Color.White;
            groupHeaderTableCell_Name.Text = _bc.GetResource(Librerias.Project.LanguageTypes.Forms, (AppReports.DocumentoContable).ToString() + "_TasaDeCambio");
            reportHeaderTableRow.Cells.Add(groupHeaderTableCell_Name);
            ...
            groupHeaderTableCell_Name.WidthF = reportHeaderTableCellWidth_Caption;
            groupHeaderTableCell_Name.Font = new Font("Times New Roman", 9, FontStyle.Bold);
            groupHeaderTableCell_Name.Text = _bc.GetResource(Librerias.Project.LanguageTypes.Forms, (AppReports.DocumentoContable).ToString() + "_ValorDoc");
            reportHeaderTableRow.Cells.Add(groupHeaderTableCell_Name);
            ...
            groupHeaderCell_ObservacionName.Text = _bc.GetResource(Librerias.Project.LanguageTypes.Forms, (AppReports.DocumentoContable).ToString() + "_Observacion") + ":  ";
            ...
            //groupHeaderCell_EstadoName.Text = _bc.GetResource(Librerias.Project.LanguageTypes.Forms, (AppReports.DocumentoContable).ToString() + "_Estado") + ":  ";
            ...
            //groupHeaderCell_PeriodoName.Text = _bc.GetResource(Librerias.Project.LanguageTypes.Forms, (AppReports.DocumentoContable).ToString() + "_PeriodoID") + ":  ";
            ...
            //groupHeaderCell_FechaName.Text = _bc.GetResource(Librerias.Project.LanguageTypes.Forms, (AppReports.DocumentoContable).ToString() + "_Fecha") + ":  ";
            ...
            foreach (string fieldName in fieldList)
            {
                ...
                string resourceId = (AppReports.DocumentoContable).ToString() + "_" + fieldName;
                ...
                if (fieldName.Contains("Debito") || fieldName.Contains("Credito"))
                {
                    ...
                    switch (fieldName)
                    {
                        case "DebitoML":
                            ...
                            tableHeaderCell.Text = _bc.GetResource(Librerias.Project.LanguageTypes.Forms, (AppReports.DocumentoContable).ToString() + "_DebitoML"); ////////////// Changing field header name
                            break;
                        case "CreditoML":
                            calcField.Expression = "Iif([vlrMdaLoc.Value]>0,0,(-1)*[vlrMdaLoc.Value])";
                            tableHeaderCell.Text = _bc.GetResource(Librerias.Project.LanguageTypes.Forms, (AppReports.DocumentoContable).ToString() + "_CreditoML"); ////////////// Changing field header name
                            break;
                        case "DebitoME":
                            calcField.Expression = "Iif([vlrMdaExt.Value]>0,[vlrMdaExt.Value],0)";
                            tableHeaderCell.Text = _bc.GetResource(Librerias.Project.LanguageTypes.Forms, (AppReports.DocumentoContable).ToString() + "_DebitoME"); ////////////// Changing field header name
                            break;
                        case "CreditoME":
                            calcField.Expression = "Iif([vlrMdaExt.Value]>0,0,(-1)*[vlrMdaExt.Value])";
                            tableHeaderCell.Text = _bc.GetResource(Librerias.Project.LanguageTypes.Forms, (AppReports.DocumentoContable).ToString() + "_CreditoME"); ////////////// Changing field header name
                            break;
                    };
                };
                if (fieldName.Contains("ME") || fieldName.Contains("ML"))
                {
                    if (fieldName.Contains("Base"))
                    {
                        ...
                        tableHeaderCell.Text = _bc.GetResource(Librerias.Project.LanguageTypes.Forms, (AppReports.DocumentoContable).ToString() + "_BaseML"); ////////////// Changing field header name
                    }
                    else
                    {
                ...
                if (fieldName.Contains("ME") || fieldName.Contains("ML"))
                {
                    if (TotlasInd == 0)
                    {
                        ...
                        {
                            Text = _bc.GetResource(Librerias.Project.LanguageTypes.Forms, (FormCodes.ReportForm).ToString() + "_Totals") + ": ",
                        ...
                        //tableFooterCell_Name = new XRTableCell()
                        //{
                        //    Text = _bc.GetResource(Librerias.Project.LanguageTypes.Forms, (AppReports.DocumentoContable).ToString() + "_TotalMvto") + ": ",
