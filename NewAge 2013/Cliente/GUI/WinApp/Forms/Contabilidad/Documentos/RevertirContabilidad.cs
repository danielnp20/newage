...
namespace NewAge.Cliente.GUI.WinApp.Forms
{
    ...
    /// </summary>
    public partial class RevertirContabilidad : DocumentReversiones
    {       
        ...
        {
            this.documentID = AppDocuments.RevertirContabilidad;
        ...
        protected override void InitControls()
        {
            ...
            doc = (DTO_glDocumento)this._bc.GetMasterDTO(AppMasters.MasterType.Simple, AppMasters.glDocumento, true, AppDocuments.ComprobanteManual.ToString(), true);
            this.docs.Add(doc);
            doc = (DTO_glDocumento)this._bc.GetMasterDTO(AppMasters.MasterType.Simple, AppMasters.glDocumento, true, AppDocuments.DocumentoContable.ToString(), true);
            this.docs.Add(doc);
            doc = (DTO_glDocumento)this._bc.GetMasterDTO(AppMasters.MasterType.Simple, AppMasters.glDocumento, true, AppProcess.MigracionComprobantes.ToString(), true);
            this.docs.Add(doc);
        ...
        public override void SaveThread()
        {
            try
            {
                ...
                else if (temps.Count == 1)
                {
                    ...
                    if (MessageBox.Show(msgDelete, msgTitleDelete, MessageBoxButtons.YesNo) == DialogResult.Yes)
                    {
                        ...
                        DTO_TxResult result = this._bc.AdministrationModel.glDocumentoControl_Revertir(this.documentID, numDoc);
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-RevertirContabilidad.cs", "SaveThread"));
            }
            finally
            {
                FormProvider.Master.StopProgressBarThread(this.documentID);
