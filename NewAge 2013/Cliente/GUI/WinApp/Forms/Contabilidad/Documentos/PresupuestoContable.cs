        ...
        protected virtual void LoadData()
        {
            ...
            {                
                ...
                this.presupuesto = this._bc.AdministrationModel.Presupuesto_GetConsolidadoTotal(this.documentID, this.masterProyecto.Value, this.periodo,
                                        Convert.ToByte(this.cmbTipoProyecto.EditValue), string.Empty, string.Empty, string.Empty);
                ...
                if (this.presupuesto == null)
                {
                    this.detList = new List<DTO_plPresupuestoDeta>();                            
                        ...
                        foreach (var proy in proyectos.Where(x => x.MovInd.Value.Value))
                        {
                            ...
                            if (dtoActividad != null && dtoProy.PresupuestalInd.Value.Value && (dtoActividad.ProyectoTipo.Value == (byte)ProyectoTipo.Opex ||
        ...
        private void btnNew_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                this.presupuesto = this._bc.AdministrationModel.PresupuestoPxQ_GetPresupuestoPxQConsolidado(this.documentID, this.masterProyecto.Value, this.periodo,
                                                        Convert.ToByte(this.cmbTipoProyecto.EditValue),string.Empty,string.Empty, string.Empty, (byte)EstadoDocControl.ParaAprobacion);
                if (presupuesto != null)
                {
