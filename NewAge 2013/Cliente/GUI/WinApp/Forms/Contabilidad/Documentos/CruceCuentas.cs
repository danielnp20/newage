    ...
    public partial class CruceCuentas : DocumentAuxiliarForm
    {
        ...
        protected override void CalcularTotal()
        {
            if (!this.newDoc)
            {
                ...
                this.txtAjuste.EditValue = (-1 * ML).ToString();

                if (string.IsNullOrEmpty(this.txtSaldo.Text.Trim())) this.txtSaldo.EditValue = "0";
                this.txtSaldoAjustado.EditValue = (Convert.ToDecimal(this.txtSaldo.EditValue, CultureInfo.CurrentCulture) - ML).ToString();
            }
        }
        ...
        protected override void LoadTempData(object aux)
        {
            try
            {
                ...
                if (usefulTemp || this._compNro == 0)
                {
                    ...
                    this.AssignValues();
                    this.txtDescripcionHeader.Text = "CRUCE DE CUENTAS";
                    this.txtSaldo.EditValue = ajuste.Valor.Value.ToString();
                        ...
                        if (this.masterTercero_.ValidID)
                        {
                            if (!string.IsNullOrEmpty(this.txtDocumentoNroExt.Text))
                            {
                                ...
                                else
                                {
                                    ...
                                    this.txtSaldo.EditValue = saldo.ToString();
                                }
                            }
                            else
                                this.masterTercero_.Focus();
