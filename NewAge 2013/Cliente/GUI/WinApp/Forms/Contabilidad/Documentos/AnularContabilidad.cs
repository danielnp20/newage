...
namespace NewAge.Cliente.GUI.WinApp.Forms
{
    ...
    /// </summary>
    public partial class AnularContabilidad : DocumentAnulaciones
    {       
        ...
        {
            this.documentID = AppDocuments.AnularContabilidad;
        ...
        public override void SaveThread()
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-AnularContabilidad.cs", "SaveThread"));
            }
            finally
            {
                FormProvider.Master.StopProgressBarThread(this.documentID);
