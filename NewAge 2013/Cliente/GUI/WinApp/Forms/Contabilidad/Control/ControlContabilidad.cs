    ...
    public partial class ControlContabilidad : ControlForm // FormWithToolbar //
    {
        ...
        protected override bool ValidateControl()
        {
            ...
            if (this.ctrl_134.ValidID)
            {
                ...
                if (comp134 != null && comp134.BalanceTipoID.Value != this.ctrl_125.Value)
                {
            ...
            #endregion
            #region FISCAL
            if (this.ctrl_133.ValidID)
            {
                DTO_coComprobante comp133 = (DTO_coComprobante)_bc.GetMasterDTO(AppMasters.MasterType.Simple, AppMasters.coComprobante, false, this.ctrl_133.Value, false);
                if (comp133 != null && comp133.BalanceTipoID.Value != this.ctrl_135.Value)
                {
