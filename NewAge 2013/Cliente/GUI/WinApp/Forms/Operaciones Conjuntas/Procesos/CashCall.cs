...
{
    public partial class CashCall : ProcessForm
    {
        #region Delegados
        ...
        protected override void InitForm()
        {
            try
            {
                this.documentID = AppProcess.CashCall;
        ...
        private void btnCashCall_Click(object sender, EventArgs e)
        {
            this.ControlBox = false;
            this.btnCashCall.Enabled = false;
            new Thread(CashCallThread).Start();
        }
        ...
        private void CashCallThread()
        {
            try
            {
                ...
                DateTime dt = DateTime.Parse(_bc.GetControlValueByCompany(ModulesPrefix.cc, AppControl.co_Periodo));
                this._resPreliminar = this._bc.AdministrationModel.CashCall_Procesar(this.documentID, this._actFlujo.ID.Value, dt);
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-CashCall.cs", "btnCierre_Click"));
                this.StopProgressBarThread();
            }
        }
        ...
        private void ProcesarThread()
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-CashCall.cs", "btnProcesar_Click"));
                this.StopProgressBarThread();
            }
        }
