...
namespace NewAge.Cliente.GUI.WinApp.Forms
{
    ...
    /// </summary>
    public partial class ReclasificacionSaldosCxP : FormWithToolbar
    {
        #region Delegados
        ...
        protected void SaveMethod()
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-ReclasificacionSaldosCxP.cs", "SaveMethod"));
            }
        }
        ...
        /// Constructor 
        /// </summary>
        public ReclasificacionSaldosCxP()
        {
            try
            {
                this.InitializeComponent();

                this._documentID = AppDocuments.ReclasificaSaldosCxP;
                ...
                string docContable = _bc.GetControlValueByCompany(ModulesPrefix.cp, AppControl.cp_DocContableReclasificaSaldo);
                string cuentaDocContable = string.Empty;
                if(string.IsNullOrEmpty(docContable))
                {
                    string msg = _bc.GetResource(LanguageTypes.Error, DictionaryMessages.Err_ControlNoData);                   
                    MessageBox.Show(string.Format(msg, ((int)ModulesPrefix.cp).ToString(), AppControl.cp_DocContableReclasificaSaldo.ToString()));
                    FormProvider.Master.itemSave.Enabled = false;
                }
                else
                {
                    DTO_coDocumento doc = (DTO_coDocumento)this._bc.GetMasterDTO(AppMasters.MasterType.Simple, AppMasters.coDocumento, false, docContable, true);
                    cuentaDocContable = doc != null? doc.CuentaLOC.Value : string.Empty;
                }

                if (string.IsNullOrEmpty(cuentaDocContable))
                {
                    MessageBox.Show(_bc.GetResource(LanguageTypes.Messages, "El documento contable registrado en el control " + AppControl.cp_DocContableReclasificaSaldo.ToString() + " no es válido"));
                    FormProvider.Master.itemSave.Enabled = false;
                }

                //Inicia los controles de usuario maestras
                _bc.InitMasterUC(this.masterCuenta, AppMasters.coPlanCuenta, true, true, true, false);
                this.masterCuenta.Value = cuentaDocContable;
                ...
                this.dtPeriod.DateTime = Convert.ToDateTime(periodoCP);
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-ReclasificacionSaldosCxP.cs", "ReclasificacionSaldosCxP"));
            }
        }
        ...
        private void LoadData()
        {
            try
            {
               // this._programaPagoList = _bc.AdministrationModel.ProgramacionPagos_GetProgramacionPagos();
                ...
                this._cuenta = (DTO_coPlanCuenta)_bc.GetMasterDTO(AppMasters.MasterType.Simple, AppMasters.tsBancosCuenta, false, this.masterCuenta.Value, true);
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-ReclasificacionSaldosCxP.cs", "LoadData"));
            }
        ...
        private void AddGridCols()
        {
            try
            {
                ...
                //ConceptoCxPID
                GridColumn ConceptoCxPDesc = new GridColumn();
                ConceptoCxPDesc.FieldName = this._unboundPrefix + "ConceptoCxPDesc";
                ConceptoCxPDesc.Caption = _bc.GetResource(LanguageTypes.Forms, AppDocuments.ReclasificaSaldosCxP + "_ConceptoCxPDesc");
                ConceptoCxPDesc.UnboundType = UnboundColumnType.String;
                ConceptoCxPDesc.VisibleIndex = 3;
                ConceptoCxPDesc.Width = 120;
                ConceptoCxPDesc.Visible = true;
                ConceptoCxPDesc.OptionsColumn.AllowEdit = false;
                this.gvPagos.Columns.Add(ConceptoCxPDesc);
                ...
                valorPendienteML.VisibleIndex = 5;
                ...
                valorPendienteME.VisibleIndex = 6;
                ...
                indicadorPago.Caption = _bc.GetResource(LanguageTypes.Forms, AppDocuments.ReclasificaSaldosCxP + "_PagoInd");
                indicadorPago.UnboundType = UnboundColumnType.Boolean;
                indicadorPago.VisibleIndex = 7;
                ...
                valorPago.Caption = _bc.GetResource(LanguageTypes.Forms, AppDocuments.ReclasificaSaldosCxP + "_ValorPago");
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-ReclasificacionSaldosCxP.cs", "ReclasificacionSaldosCxP.cs-AddGridCols"));
            }
        }
        ...
        private bool ValidateDocRow(int fila)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-ReclasificacionSaldosCxP.cs", "ReclasificacionSaldosCxP.cs-ValidateDocRow"));
                return false;
            }
        }
        ...
        private bool ValidateHeader()
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-ReclasificacionSaldosCxP.cs", "ValidateHeader"));
                return false;
            }
        }
        ...
        protected virtual void Form_Enter(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-ReclasificacionSaldosCxP.cs", "ReclasificacionSaldosCxP.cs-Form_Enter"));
            }
        }
        ...
        protected virtual void Form_Leave(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-ReclasificacionSaldosCxP.cs", "ReclasificacionSaldosCxP.cs-Form_Leave"));
            }
        }
        ...
        protected virtual void Form_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-ReclasificacionSaldosCxP.cs", "ReclasificacionSaldosCxP.cs-Form_Closing"));
            }
        }
        ...
        protected virtual void Form_FormClosed(object sender, FormClosedEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-ReclasificacionSaldosCxP.cs", "ReclasificacionSaldosCxP.cs-Form_FormClosed"));
            }
        }
        ...
        private void gvPagos_CellValueChanging(object sender, CellValueChangedEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-ReclasificacionSaldosCxP.cs", "gvPagos_CellValueChanging"));
            }
        }
        ...
        private void gvPagos_CellValueChanged(object sender, CellValueChangedEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-ReclasificacionSaldosCxP.cs", "gvPagos_CellValueChanged"));
            }
        }
        ...
        private void gvPagos_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-ReclasificacionSaldosCxP.cs", "gvDocument_FocusedRowChanged"));
            }
        }
        ...
        private void gvPagos_CustomUnboundColumnData(object sender, CustomColumnDataEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-ReclasificacionSaldosCxP.cs", "gvPagos_CustomUnboundColumnData"));
            }
        }
        ...
        private void gvPagos_ShowingEditor(object sender, CancelEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-ReclasificacionSaldosCxP.cs", "gvPagos_ShowingEditor"));
            }
        }
        ...
        private void editBtnGrid_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-ReclasificacionSaldosCxP.cs", "editBtnGrid_ButtonClick"));
            }
        }
        ...
        private void masterCuenta_Leave(object sender, EventArgs e)
        {
            try
            {
                bool isValid = true;
                    ...
                    if (this.masterCuenta.ValidID && this._cuenta == null) //Digita 1ra vez
                    {
                        this._cuenta = (DTO_coPlanCuenta)_bc.GetMasterDTO(AppMasters.MasterType.Simple, AppMasters.tsBancosCuenta, false, this.masterCuenta.Value, true);
                    ...
                    else
                    {
                        ...
                        //bool exist = this._cuenta != null? this._pagosActuales.Any(x => x.BancoCuentaID.Value == this._cuenta.ID.Value) : false;
                        //if (exist && this._cuenta.ID.Value != this.masterCuenta.Value)
                        //{
                        //    string msg = _bc.GetResource(LanguageTypes.Messages, DictionaryMessages.Ts_SeleccionCuentaBancaria);
                        //    if (MessageBox.Show(string.Format(msg, this._cuenta.ID.Value), "Cambiar Cuenta", MessageBoxButtons.YesNo) == DialogResult.Yes)
                        //    {
                        ...
                        //    }
                        //    else
                        //        this.masterCuenta.Value = this._cuenta.ID.Value;
                        //}
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-ReclasificacionSaldosCxP.cs", "masterCuenta_Leave"));
            }
        }
        ...
        private void chkSelectAll_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-ReclasificacionSaldosCxP.cs", "chkSelectAll_MouseClick"));
            }
        }
        ...
        private void dtFecha_EditValueChanged(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-ReclasificacionSaldosCxP.cs", "dtFecha_EditValueChanged"));
            }
        }
        ...
        public override void TBSave()
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-ReclasificacionSaldosCxP.cs", "TBSave"));
            }
        }
        ...
        public override void TBUpdate()
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-ReclasificacionSaldosCxP.cs", "TBUpdate"));
            }
        }
        ...
        public override void TBPrint()
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-ReclasificacionSaldosCxP.cs", "TBPrint"));
            }
        }
        ...
        public void SaveThread()
        {
            try
            {
                ...
                result = _bc.AdministrationModel.ReclasificacionSaldosCxP(this._documentID, this._actFlujoID, programacionesPagos,this.masterCuenta.Value, this.dtFecha.DateTime.Date,this._tc);
                ...
                if (result.Result == ResultValue.OK)
                {
                    ...
                    //reportName = this._bc.AdministrationModel.ReportesTesoreria_PagosFactura(docReporte,Convert.ToInt32(result.ExtraField), ExportFormatType.pdf,isTransferecia);
                    //fileURl = this._bc.UrlDocumentFile(TipoArchivo.Documentos, Convert.ToInt32(result.ExtraField), null, reportName.ToString());
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-ReclasificacionSaldosCxP.cs", "SaveThread"));
            }
            finally
            {
                FormProvider.Master.StopProgressBarThread(this._documentID);
