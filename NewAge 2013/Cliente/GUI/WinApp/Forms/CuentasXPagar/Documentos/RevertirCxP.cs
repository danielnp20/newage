...
namespace NewAge.Cliente.GUI.WinApp.Forms
{
    ...
    /// </summary>
    public partial class RevertirCxP : DocumentReversiones
    {       
        ...
        {
            this.documentID = AppDocuments.RevertirCxP;
            ...
            try
            {
                ...
                else if (temps.Count == 1)
                {
                    ...
                    if (MessageBox.Show(msgDelete, msgTitleDelete, MessageBoxButtons.YesNo) == DialogResult.Yes)
                    {
                        ...
                        DTO_TxResult result = this._bc.AdministrationModel.CuentasXPagar_Revertir(this.documentID, numDoc);
