...
{
    public partial class FacturaEquivalente : ProcessForm
    {
        ...
        /// CONSTRUCTOR
        /// </summary>
        public FacturaEquivalente() : base() { }
        ...
        {
            this.documentID = AppProcess.FacturaEquivalente;
            ...
            string periodoStr = _bc.GetControlValueByCompany(ModulesPrefix.no, AppControl.cp_Periodo);
        ...
        private void ProcesarThread()
        {
            try
            {
                ...
                DTO_TxResult result = this._bc.AdministrationModel.CuentasXPagar_ConsecutivoFactEquivalente(this.uc_Periodo.DateTime);
