...
{
    public partial class DepreciacionMensual : ProcessForm
    {
        ...
        /// CONSTRUCTOR
        /// </summary>
        public DepreciacionMensual() : base() { }
        ...
        {
            this.documentID = AppProcess.DepreciacionMensual;
        ...
        private void ProcesarThread()
        {
            try
            {
                ...
                DTO_TxResult result = this._bc.AdministrationModel.Proceso_GenerarDepreciacionActivos(this.documentID, this.uc_Periodo.DateTime);
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-DepreciacionMensual.cs", "ProcesarThread"));
                this.StopProgressBarThread();
            }
