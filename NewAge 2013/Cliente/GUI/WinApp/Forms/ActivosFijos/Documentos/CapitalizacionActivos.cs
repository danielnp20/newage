...
namespace NewAge.Cliente.GUI.WinApp.Forms
{
    ...
    /// </summary>
    public partial class CapitalizacionActivos : DocumentForm
    {       
        #region Delegados
        /// <summary>
        ...
        {
            this.documentID = AppDocuments.CapitalizacionActivos;
            InitializeComponent();
        ...
        protected override void AddGridCols()
        {
            try
            {
                ...
                plaquetaID.Caption = _bc.GetResource(LanguageTypes.Forms, AppDocuments.AltaActivos + "_PlaquetaID");
                ...
                serialID.Caption = _bc.GetResource(LanguageTypes.Forms, AppDocuments.AltaActivos + "_SerialID");
                ...
                valorP.Caption = _bc.GetResource(LanguageTypes.Forms, AppDocuments.AltaActivos + "_CostoLOC");
                ...
                valorD.Caption = _bc.GetResource(LanguageTypes.Forms, AppDocuments.AltaActivos + "_CostoEXT");
                ...
                turnos.Caption = _bc.GetResource(LanguageTypes.Forms, AppDocuments.AltaActivos + "_Turnos");
                ...
                inReferenciaID.Caption = _bc.GetResource(LanguageTypes.Forms, AppDocuments.AltaActivos + "_inReferenciaID");
                ...
                descripcion.Caption = _bc.GetResource(LanguageTypes.Forms, AppDocuments.AltaActivos + "_Descripcion");
                ...
                clase.Caption = _bc.GetResource(LanguageTypes.Forms, AppDocuments.AltaActivos + "_ActivoClaseID");
                ...
                ActivoTipoID.Caption = _bc.GetResource(LanguageTypes.Forms, AppDocuments.AltaActivos + "_ActivoTipoID");
                ...
                grupo.Caption = _bc.GetResource(LanguageTypes.Forms, AppDocuments.AltaActivos + "_ActivoGrupoID");
                ...
                modelo.Caption = _bc.GetResource(LanguageTypes.Forms, AppDocuments.AltaActivos + "_Modelo");
                ...
                locFisica.Caption = _bc.GetResource(LanguageTypes.Forms, AppDocuments.AltaActivos + "_LocFisicaID");
        ...
        public void InitControls()
        {
            ...
            _bc.InitMasterUC(this.uc_ProyectoInv, AppMasters.coProyecto, true, true, true, true);
        ...
        private void txtValorSalvamentUSG_EditValueChanged(object sender, System.EventArgs e)
        {
            if (!string.IsNullOrWhiteSpace(this.txtValorSalvamentUSG.Text))
            {
                ...
                if (fila < 0)
                    return;
                this._lActivos[fila].ValorSalvamentoUSG.Value = Convert.ToDecimal(this.txtValorSalvamentUSG.EditValue);
            }
        }
