...
namespace NewAge.Cliente.GUI.WinApp.Forms
{
    ...
    /// </summary>
    public partial class AdicionActivos : DocumentForm
    {       
        #region Delegados
        /// <summary>
        ...
        {
            this.documentID = AppDocuments.AdicionActivos;
            InitializeComponent();
        ...
        protected override void AddNewRow()
        {
            ...
            acCtrl.ProyectoID.Value = this.proyecto;
            acCtrl.CentroCostoID.Value = this.centroCosto;
        ...
        public void InitControls()
        {
            ...
            #region Filtros Tipo de Movimientos (Adiones)
            ...
            eg.ValorFiltro = "1"; //Corresponde al tipo de movientos (0) Adiciones
        ...
        {
            FindActivosModal modalActivos = new FindActivosModal(false);
            modalActivos.ShowDialog();
            this._Activo = modalActivos.Activo;
        ...
        private void txtValorRetiro_EditValueChanged(object sender, EventArgs e)
        {
            if (!string.IsNullOrWhiteSpace(this.txtValorRetiro.Text))
            {
                ...
                this.txtIFRSPesos.Text = (this._lActivos[fila].CostoLOC.Value + this._lActivos[fila].ValorRetiroIFRS.Value).ToString();
                this.txtIFRSDolares.Text = (this._lActivos[fila].CostoEXT.Value + (this._lActivos[fila].ValorRetiroIFRS.Value / Convert.ToDecimal(this.txtTCIFRS.EditValue, CultureInfo.InvariantCulture))).ToString();
                this.CalcularTotal();
            }
        }
        ...
        public override void SaveThread()
        {
            try
            {
                ...
                List<DTO_TxResult> results = _bc.AdministrationModel.acActivoControl_AddListActivos(this.documentID, this._Activo.ActivoID.Value.Value, this._actFlujo.ID.Value, this.txtPrefix.Text, listAppr, this.masterMovimientoTipo.Value, Convert.ToDecimal(this.txtTCLoc.EditValue, CultureInfo.InvariantCulture));
