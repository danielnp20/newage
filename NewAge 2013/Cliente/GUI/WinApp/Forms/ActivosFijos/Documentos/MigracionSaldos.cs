...
{
    public partial class MigracionSaldos : DocumentForm 
    {
        #region Variables
        ...
        {
            this.documentID = AppDocuments.MigracionSaldos;
            InitializeComponent();
            ...
            this.format = _bc.GetImportExportFormat(typeof(DTO_MigracionSaldos), this.documentID);
        ...
        public override void SaveThread()
        {
            try
            {
                ...
                if (string.IsNullOrEmpty(this.uc_Revelaciones.Text))
                {
                ...
                List<DTO_TxResult> results = null;// _bc.AdministrationModel.acActivoControl_Deterioro(this.documentID, this._actFlujo.ID.Value, lkpTipoBalance.EditValue.ToString(), this.txtPrefix.Text, this.uc_Revelaciones.Value, this._lActivos);
                FormProvider.Master.StopProgressBarThread(this.documentID);
