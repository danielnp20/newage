...
{
    public class acEquiposArrendados : ReportParametersForm, IFiltrable
    {
        #region Hilos
        /// <summary>
        ...
        protected override void LoadReportMethod_PDF()
        {
            ...
            {
                string fileURl;
                this.result = this._bc.AdministrationModel.ReportesActivos_EquiposArrendados(this._fechaIni, Convert.ToInt32(EstadoInv.Arrendado), this._Tercero, this._Plaqueta, this._Serial, this._TipoRef, this.Rompimiento, this._formatType);
        ...
        private string Rompimiento = "Tercero-TipoRef";
        ...
        protected override void InitReport()
        {
            ...
            {
                new ReportParameterListItem { Key = "Tercero-TipoRef", Desc = this._bc.GetResource(LanguageTypes.Tables,DictionaryTables.Rpt_Tercero)},
                new ReportParameterListItem { Key = "TipoRef-Tercero", Desc= this._bc.GetResource(LanguageTypes.Tables,DictionaryTables.Rpt_TipoReferencia)}
            };

            this.AddMaster("Tercero", AppMasters.ccCliente, true, null);
