...
namespace NewAge.Cliente.GUI.WinApp.Forms
{
    ...
    /// </summary>
    public partial class RecibidoConsumo : FormWithToolbar
    {
        #region Delegados
        ...
        public RecibidoConsumo()
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-RecibidoConsumo.cs.cs", "RecibidoConsumo"));
            }
        }
        ...
        private void SetInitParameters()
        {
            ...
            this.documentID = AppDocuments.RecibidoPlanillaConsumoProy;
        ...
        private void AddDocumentCols()
        {
            try
            {
                ...
                this.gvPreliminar.Columns.Add(ProyectoID);
                ...
                CentroCostoID.VisibleIndex = 4;
                CentroCostoID.Width = 80;
                CentroCostoID.Visible = true;
                CentroCostoID.OptionsColumn.AllowEdit = false;
                this.gvPreliminar.Columns.Add(CentroCostoID);

                GridColumn FechaConsumo = new GridColumn();
                FechaConsumo.FieldName = this.unboundPrefix + "FechaConsumo";
                FechaConsumo.Caption = _bc.GetResource(LanguageTypes.Forms, this.documentID + "_FechaConsumo");
                FechaConsumo.UnboundType = UnboundColumnType.DateTime;
                FechaConsumo.VisibleIndex = 5;
                FechaConsumo.Width = 80;
                FechaConsumo.Visible = true;
                FechaConsumo.OptionsColumn.AllowEdit = false;
                this.gvPreliminar.Columns.Add(FechaConsumo);
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-RecibidoConsumo.cs.cs", "RecibidoConsumo.cs-AddDocumentCols"));
            }
        }
        ...
        {
            this.masterProveedor.Enabled = enable;
        }
        ...
        {
            this._listConsumoRec = this._bc.AdministrationModel.ConsumoProyecto_GetResumen(this.documentID, this._bc.AdministrationModel.User, ModulesPrefix.pr, this.dtFecha.DateTime, this.masterProveedor.Value);
        ...
        public void SaveThread()
        {
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-RecibidoSolicituDespacho.cs.cs", "RecibidoSolicituDespacho.cs-SaveThread"));
            }
            finally
            {
                FormProvider.Master.StopProgressBarThread(this.documentID);
