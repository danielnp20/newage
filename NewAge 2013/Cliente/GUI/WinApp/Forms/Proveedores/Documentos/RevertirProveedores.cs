...
namespace NewAge.Cliente.GUI.WinApp.Forms
{
    ...
    /// </summary>
    public partial class RevertirProveedores : DocumentReversiones
    {       
        ...
        {
            this.documentID = AppDocuments.RevertirProveedores;
        ...
        protected override void InitControls()
        {
            ...
            this.docs.Add(doc);
            doc = (DTO_glDocumento)this._bc.GetMasterDTO(AppMasters.MasterType.Simple, AppMasters.glDocumento, true, AppDocuments.SolicitudDirecta.ToString(), true);
            this.docs.Add(doc);
            ...
            this.docs.Add(doc);
            doc = (DTO_glDocumento)this._bc.GetMasterDTO(AppMasters.MasterType.Simple, AppMasters.glDocumento, true, AppDocuments.Contrato.ToString(), true);
            this.docs.Add(doc);
            doc = (DTO_glDocumento)this._bc.GetMasterDTO(AppMasters.MasterType.Simple, AppMasters.glDocumento, true, AppDocuments.ConsumoProyecto.ToString(), true);
            this.docs.Add(doc);
            doc = (DTO_glDocumento)this._bc.GetMasterDTO(AppMasters.MasterType.Simple, AppMasters.glDocumento, true, AppDocuments.SolicitudDespachoConvenio.ToString(), true);
            this.docs.Add(doc);
            doc = (DTO_glDocumento)this._bc.GetMasterDTO(AppMasters.MasterType.Simple, AppMasters.glDocumento, true, AppDocuments.Recibido.ToString(), true);
            this.docs.Add(doc);
        ...
        public override void SaveThread()
        {
            try
            {
                ...
                else if (temps.Count == 1)
                {
                    ...
                    if (MessageBox.Show(msgDelete, msgTitleDelete, MessageBoxButtons.YesNo) == DialogResult.Yes)
                    {
                        ...
                        DTO_TxResult result = this._bc.AdministrationModel.Proveedores_Reversion(this.documentID, numDoc);
            ...
            {
                MessageBox.Show(_bc.GetResourceForException(ex, "WinApp-RevertirCxP.cs", "SaveThread"));
            }
            finally
            {
                FormProvider.Master.StopProgressBarThread(this.documentID);
