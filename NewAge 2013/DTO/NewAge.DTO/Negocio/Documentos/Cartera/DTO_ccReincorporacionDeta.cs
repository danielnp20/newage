...
namespace NewAge.DTO.Negocio
{
    ...
    public class DTO_ccReincorporacionDeta
    {
        ...
        [DataMember]
        public UDT_PagaduriaID PagaduriaID { get; set; }     //Adicional 

        [DataMember]
        public UDT_Descriptivo PagaduriaDesc { get; set; }   //Adicional 

        [DataMember]
        public UDT_ClienteID ClienteID { get; set; }        //Adicional 

        [DataMember]
        public UDT_Descriptivo Nombre { get; set; }         //Adicional 

        [DataMember]
        public UDT_LibranzaID Libranza { get; set; }        //Adicional 
        ...
        [DataMember]
        public UDT_Valor VlrMora { get; set; }               //Adicional 

        [DataMember]
        public UDT_Valor VlrIncrMora { get; set; }           //Adicional 

        [DataMember]
        public UDT_Valor VlrDtoMes { get; set; }             //Adicional 
