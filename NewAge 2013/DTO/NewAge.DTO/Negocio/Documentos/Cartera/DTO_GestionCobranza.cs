...
namespace NewAge.DTO.Negocio
{
    ...
    public class DTO_GestionCobranza
    {
        ...
        public DTO_GestionCobranza()
        {
            ...
            this.SeleccionaInd.Value = false;
        }
        ...
        public void InitCols()
        {
            ...
            this.SeleccionaInd = new UDT_SiNo();
            ...
            this.FechaConfirmacionHist = new UDTSQL_smalldatetime();
            this.CodConfirmacionHist = new UDT_DescripUnFormat();
            this.ConsecHistorico = new UDT_Consecutivo();
            this.MantenerGestionInd = new UDT_SiNo();
        }
        ...
        [DataMember]
        public UDT_SiNo SeleccionaInd { get; set; }
        ...
        [DataMember]
        public UDTSQL_smalldatetime FechaConfirmacionHist { get; set; }

        [DataMember]
        public UDT_DescripUnFormat CodConfirmacionHist { get; set; }

        [DataMember]
        public UDT_Consecutivo ConsecHistorico { get; set; }

        [DataMember]
        public UDT_SiNo MantenerGestionInd { get; set; }
        #endregion
    }
