...
namespace NewAge.DTO.Negocio
{
    ...
    public class DTO_glMovimientoDeta
    {
        ...
        protected virtual void InitCols()
        {
            ...
            this.EstadoDocCtrl = new UDTSQL_smallint();
            this.FacturaTipoID = new UDT_FacturaTipoID();
            this.TipoTrasladoInv = new UDTSQL_tinyint();
        ...
        [DataMember]
        [AllowNull]
        public UDTSQL_smallint EstadoDocCtrl { get; set; }
        ...
        [DataMember]
        [AllowNull]
        public UDTSQL_tinyint TipoTrasladoInv { get; set; }
