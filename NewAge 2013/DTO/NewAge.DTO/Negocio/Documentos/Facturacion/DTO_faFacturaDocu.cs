    ...
    public class DTO_faFacturaDocu
    {
        ...
        public DTO_faFacturaDocu(IDataReader dr)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrWhiteSpace(dr["Administracion"].ToString()))
                    this.Administracion.Value = Convert.ToDecimal(dr["Administracion"]);
                if (!string.IsNullOrWhiteSpace(dr["Imprevistos"].ToString()))
                    this.Imprevistos.Value = Convert.ToDecimal(dr["Imprevistos"]);
                if (!string.IsNullOrWhiteSpace(dr["Utilidad"].ToString()))
        ...
        [DataMember]
        [NotImportable]
        public decimal PorcImprevistos { get; set; }
