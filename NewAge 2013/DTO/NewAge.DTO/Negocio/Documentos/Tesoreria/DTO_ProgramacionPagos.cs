    ...
    public class DTO_ProgramacionPagos
    {
        ...
        public DTO_ProgramacionPagos(IDataReader dr)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrWhiteSpace(dr["BeneficiarioID"].ToString()))
        ...
        private void InitCols()
        {
            ...
            this.ConceptoCxPDesc = new UDT_DescripTExt();
            this.BeneficiarioID = new UDT_TerceroID();
            this.Beneficiario = new UDT_Descriptivo();
        }
        ...
        [DataMember]
        public UDT_DescripTExt ConceptoCxPDesc { get; set; }

        [DataMember]
        public UDT_TerceroID BeneficiarioID { get; set; }

        [DataMember]
        public UDT_Descriptivo Beneficiario{ get; set; }
