    ...
    public class DTO_tsBancosDocu
    {
        ...
        public DTO_tsBancosDocu(IDataReader dr)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(dr["BeneficiarioID"].ToString()))
                    this.BeneficiarioÌD.Value = dr["BeneficiarioID"].ToString();
        ...
        private void InitCols()
        {
            ...
            this.BeneficiarioÌD = new UDT_TerceroID();
        }
        ...
        [DataMember]
        public UDT_TerceroID BeneficiarioÌD { get; set; }
