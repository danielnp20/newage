...
namespace NewAge.DTO.Negocio
{
    /// <summary>
    /// 
    /// Models DTO_pySolServicioTarea
    /// </summary>
    [DataContract]
    [Serializable]
    public class DTO_pySolServicioTarea
    {
        #region DTO_pySolServicioTarea
        public DTO_pySolServicioTarea(IDataReader dr)
        {
            InitCols();
            try
            {    
