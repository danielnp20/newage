...
namespace NewAge.DTO.Negocio
{
    /// <summary>
    /// 
    /// Models DTO_pyPreProyectoDeta
    /// </summary>
    [DataContract]
    [Serializable]
    public class DTO_pyPreProyectoDeta
    {
        #region pySolServicioDeta

        public DTO_pyPreProyectoDeta(IDataReader dr)
        {
            InitCols();
            try
            {
        ...
        public DTO_pyPreProyectoDeta(IDataReader dr, bool componenteInd)
        {
            InitCols();
            try
            {
        ...
        public void InitCols()
        {
            ...
            this.TrabajoDesc = new UDT_DescripUnFormat();
        ...
        [DataMember]
        public UDT_DescripUnFormat TrabajoDesc { get; set; }
        ...
        [DataMember]
        public UDT_Valor VlrIVAUtil { get; set; }
