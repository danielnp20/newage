...
namespace NewAge.DTO.Negocio
{
    ...
    [DataContract]
    [Serializable]
    public class DTO_pyServicioDeta
    {
       #region pySolServicioDeta

        public DTO_pyServicioDeta(IDataReader dr)
        {
            InitCols();
            try
            {
        ...
        public DTO_pyServicioDeta(IDataReader dr, bool componenteInd)
        {
            InitCols();
            try
            {
        ...
        #region Campos Adicionales Inv

        [DataMember]
        public UDT_Cantidad ExistenciasInv { get; set; }

        [DataMember]
        public UDT_Cantidad Pendientes { get; set; }

        [DataMember]
        public UDT_Cantidad Despacho { get; set; }

        [DataMember]
        public UDT_CodigoGrl TareaIDFilter { get; set; }

        [DataMember]
        public UDT_Descriptivo TareaIDFilterDesc { get; set; } 
