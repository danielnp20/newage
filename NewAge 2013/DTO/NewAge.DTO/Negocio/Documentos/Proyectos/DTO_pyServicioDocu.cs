...
namespace NewAge.DTO.Negocio
{
    /// <summary>
    /// 
    /// Models DTO_pyServicioDocu
    /// </summary>
    [DataContract]
    [Serializable]
    public class DTO_pyServicioDocu
    {
        #region pySolServicioDocu

        public DTO_pyServicioDocu(IDataReader dr)
        {
            InitCols();
            try
            {
                ...
                if (!string.IsNullOrEmpty(dr["DocSolicitud"].ToString()))
                    this.DocSolicitud.Value = Convert.ToByte(dr["DocSolicitud"]);
        ...
        public void InitCols()
        {
            ...
            this.DetalleTareas = new List<DTO_pyServicioTarea>();
        }
        #endregion
        ...
        [DataMember]
        public List<DTO_pyServicioTarea> DetalleTareas { get; set; }
    }
}
