...
{
    /// <summary>
    /// Models DTO_pyProyectoEntregasxMes
    /// </summary>
    [DataContract]
    [Serializable]
    public class DTO_pyProyectoEntregasxMes
    {
        #region DTO_pyProyectoEntregasxMes

        /// <summary>
        /// Constuye el DTO a partir de un resultado de base de datos
        /// </summary>
        /// <param name="?"></param>
        public DTO_pyProyectoEntregasxMes(IDataReader dr)
        {
            InitCols();
            try
            {
        ...
        /// </summary>
        /// <param name="?"></param>
        public DTO_pyProyectoEntregasxMes()
        {
            InitCols();
        }
        ...
        [DataMember]
        public UDT_PeriodoID Fecha { get; set; }
