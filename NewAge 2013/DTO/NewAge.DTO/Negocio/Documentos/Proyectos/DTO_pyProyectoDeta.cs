...
namespace NewAge.DTO.Negocio
{
    ...
    public class DTO_pyProyectoDeta
    {
        ...
        public void InitCols()
        {
            ...
            //Traslados
            this.CantidadConsumoInt = new UDT_Cantidad();
            this.CostoLocalConsumoInt = new UDT_Valor();
            this.CantidadPrestamo = new UDT_Cantidad();
            this.CostoLocalPrestamo = new UDT_Valor();
            this.CantidadTotalTraslados = new UDT_Valor();
            this.CostoTotalTraslados = new UDT_Valor();

            this.CostoTotalFINAL = new UDT_Valor();
            this.CantidadTotalFINAL = new UDT_Valor();
        }
        ...
        #region Campos para Traslados Inv

        [DataMember]
        public UDT_Cantidad CantidadConsumoInt { get; set; }

        [DataMember]
        public UDT_Valor CostoLocalConsumoInt { get; set; }

        [DataMember]
        public UDT_Cantidad CantidadPrestamo { get; set; }

        [DataMember]
        public UDT_Valor CostoLocalPrestamo { get; set; }

        [DataMember]
        public UDT_Valor CantidadTotalTraslados { get; set; }
        ...
        [DataMember]
        public UDT_Valor CantidadTotalFINAL { get; set; }
