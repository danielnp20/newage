    ...
    public class DTO_pyProyectoTarea
    {
        ...
        public DTO_pyProyectoTarea(IDataReader dr)
        {
            ...
            {    
                ...
                if (!string.IsNullOrEmpty(dr["DiasInicioTrabajo"].ToString()))
                    this.DiasInicioTrabajo.Value = Convert.ToInt32(dr["DiasInicioTrabajo"]);
        ...
        public DTO_pyProyectoTarea()
        {
            ...
            //Costos Proyecto
            this.VlrUnitProyecto.Value = 0;
            this.VlrUnitCLIProyecto.Value = 0;
            this.SubTotalLocalEjec.Value =0;
            this.CostoLocalIVATOTEjec.Value = 0;
            this.CostoLocalTOTEjec.Value =0;
            this.CostoTotalTraslados.Value = 0;
            this.CostoTotalFINAL.Value = 0;
        }
        ...
        public void InitCols() 
        {
            ...
            this.FechasEntrega = new List<DTO_pyProyectoPlanEntrega>();
            ...
            //Costos Proyecto
            this.VlrUnitProyecto = new UDT_Valor();
            this.VlrUnitCLIProyecto = new UDT_Valor();
            this.SubTotalLocalEjec = new UDT_Valor();
            this.CostoLocalIVATOTEjec = new UDT_Valor();
            this.CostoLocalTOTEjec = new UDT_Valor();
            this.CostoTotalTraslados = new UDT_Valor();
            this.CostoTotalFINAL = new UDT_Valor();
            #endregion
            #region Actas Entrega
            this.CantActaAnterior = new UDT_Cantidad();
            this.VlrActaAnterior = new UDT_Valor();
            this.CantActaOtroSi = new UDT_Cantidad();
            this.VlrActaOtroSi = new UDT_Valor();
            this.CantActaActual = new UDT_Cantidad();
            this.VlrActaActual = new UDT_Valor();
            this.CantActaAcumulado = new UDT_Cantidad();
            this.VlrActaAcumulado = new UDT_Valor();
            this.PorcentajeAvance = new UDT_PorcentajeID();      
        ...
        [DataMember]
        [NotImportable]
        public UDTSQL_int DiasInicioTrabajo { get; set; }
        ...
        [DataMember]
        [NotImportable]
        public List<DTO_pyProyectoPlanEntrega> FechasEntrega { get; set; }
        ...
        [DataMember]
        public UDT_Cantidad CantidadEjecParcial { get; set; }
        ...
        [DataMember]
        public UDT_Valor VlrEjecutadoParcial { get; set; }
        ...
        [DataMember]
        public UDT_Valor VlrUnitProyecto { get; set; }

        [DataMember]
        public UDT_Valor VlrUnitCLIProyecto { get; set; }
        ...
        [DataMember]
        public UDT_Valor CostoTotalTraslados { get; set; }

        [DataMember]
        public UDT_Valor CostoTotalFINAL { get; set; }
        ...
        [DataMember]
        public UDT_Cantidad CantActaAnterior { get; set; }

        [DataMember]
        public UDT_Valor VlrActaAnterior { get; set; }

        [DataMember]
        public UDT_Cantidad CantActaOtroSi { get; set; }

        [DataMember]
        public UDT_Valor VlrActaOtroSi { get; set; }

        [DataMember]
        public UDT_Cantidad CantActaActual { get; set; }

        [DataMember]
        public UDT_Valor VlrActaActual { get; set; }

        [DataMember]
        public UDT_Cantidad CantActaAcumulado { get; set; }

        [DataMember]
        public UDT_Valor VlrActaAcumulado { get; set; }

        [DataMember]
        public UDT_PorcentajeID PorcentajeAvance { get; set; }
