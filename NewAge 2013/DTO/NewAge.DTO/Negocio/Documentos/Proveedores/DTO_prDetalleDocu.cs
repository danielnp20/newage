...
namespace NewAge.DTO.Negocio
{
    ...
    public class DTO_prDetalleDocu
    {
        ...
        private void InitCols()
        {
            ...
            this.SolicitarInd = new UDT_SiNo();     
        }
        ...
        [DataMember]
        public UDT_Valor VlrLocal02 { get; set; } //Valor ML Factura CxP

        [DataMember]
        public UDT_Valor VlrExtra02 { get; set; } //Valor ME Factura CxP

        [DataMember]
        public UDT_Valor VlrLocal03 { get; set; } //Valor IVA ML Factura CxP

        [DataMember]
        public UDT_Valor VlrExtra03 { get; set; } //Valor IVA ME Factura CxP
        ...
        [DataMember]
        public UDT_SiNo SolicitarInd { get; set; }
