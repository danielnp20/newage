...
namespace NewAge.DTO.Negocio
{
    [DataContract]
    [Serializable]
    public class DTO_noLiquidacionesDetalle
    {
        #region Contructor
        ...
        /// </summary>
        /// <param name="?"></param>
        public DTO_noLiquidacionesDetalle(IDataReader dr)
        {
            this.InitCols();
            try
            {
                ...
                if (!string.IsNullOrEmpty(dr["ConceptoNODesc"].ToString()))
                ...
                if (!string.IsNullOrEmpty(dr["NumeroPagoEmpleado"].ToString()))
                    this.NumeroPagoEmpleado.Value = Convert.ToInt32(dr["NumeroPagoEmpleado"]);
                if (!string.IsNullOrEmpty(dr["NumeroPagoTercero"].ToString()))
                    this.NumeroPagoTercero.Value = Convert.ToInt32(dr["NumeroPagoTercero"]);
        ...
        /// </summary>
        public DTO_noLiquidacionesDetalle()
        {
            this.InitCols();
        }
        ...
        private void InitCols()
        {
            ...
            this.NumeroPagoEmpleado = new UDT_Consecutivo();
            this.NumeroPagoTercero = new UDT_Consecutivo();
        ...
        [DataMember]
        public UDT_Consecutivo NumeroPagoEmpleado { get; set; }

        [DataMember]
        public UDT_Consecutivo NumeroPagoTercero { get; set; }
        ...
        [DataMember]
        public decimal VlrDevengos { get; set; }

        [DataMember]
        public decimal VlrDeducciones { get; set; }
