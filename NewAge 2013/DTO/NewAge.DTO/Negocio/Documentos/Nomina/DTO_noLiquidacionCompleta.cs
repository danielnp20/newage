...
namespace NewAge.DTO.Negocio
{
    [DataContract]
    [Serializable]
    public class DTO_noLiquidacionCompleta : DTO_NominaAprobacion
    {
        /// <summary>
        /// Constructor de la aplicación
        /// </summary>
        public DTO_noLiquidacionCompleta(DTO_glDocumentoControl doc)
            : base(doc)
        {
            this.DocControl = doc;
        ...
        public List<DTO_noLiquidacionesDetalle> Detalle
        {
            get;
            set;
        }

        public List<DTO_noLiquidacionPreliminar> Preliminar
        {
            get;
            set;
        }
