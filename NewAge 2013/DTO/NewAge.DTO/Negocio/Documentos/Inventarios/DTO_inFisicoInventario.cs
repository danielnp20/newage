...
namespace NewAge.DTO.Negocio
{
    ...
    public class DTO_inFisicoInventario : DTO_BasicReport
    {
        ...
        private void InitCols()
        {
            ...
            this.CostoUnitario = new UDT_Valor();
            this.DetalleReporte = new List<DTO_inFisicoInventario>();
        }
        ...
        [DataMember]
        public UDT_Valor CostoUnitario { get; set; }
        ...
        [DataMember]
        [AllowNull]
        public List<DTO_inFisicoInventario> DetalleReporte { get; set; }
