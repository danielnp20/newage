...
{
    /// <summary>
    /// Models DTO_coReclasificaBalance
    /// </summary>
    [DataContract]
    [Serializable]
    public class DTO_coReclasificaBalance
    {
        #region DTO_coReclasificaBalance

        /// <summary>
        /// Constuye el DTO a partir de un resultado de base de datos
        /// </summary>
        /// <param name="?"></param>
        public DTO_coReclasificaBalance(IDataReader dr)
        {
            InitCols();
            try
            {
        ...
        /// </summary>
        public DTO_coReclasificaBalance()
        {
            this.InitCols();
        }
