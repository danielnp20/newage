...
namespace NewAge.DTO.Negocio
{
    ...
    public class DTO_ccCliente : DTO_MasterBasic
    {
            ...
            : base(dr, mp)
        {
            ...
            try
            {
                if (!isReplica)
                {
                    ...
                    this.CiudadActDesc.Value = dr["CiudadActDesc"].ToString();
                ...
                this.DireccionAct.Value = dr["DireccionAct"].ToString();
                this.CiudadAct.Value = dr["CiudadAct"].ToString();
                this.Telefono1Act.Value = dr["Telefono1Act"].ToString();
                this.Telefono2Act.Value = dr["Telefono2Act"].ToString();
                this.Celular1Act.Value = dr["Celular1Act"].ToString();
                this.Celular2Act.Value = dr["Celular2Act"].ToString();
                this.CorreoAct.Value = dr["CorreoAct"].ToString();
            }
            catch (Exception e)
            {                
                throw e;
        ...
        private void InitCols()
        {
            ...
            this.DireccionAct = new UDT_DescripTBase();
            this.CiudadAct = new UDT_BasicID();
            this.CiudadActDesc = new UDT_Descriptivo();
            this.Telefono1Act = new UDTSQL_char(15);
            this.Telefono2Act = new UDTSQL_char(15);
            this.Celular1Act= new UDTSQL_char(15);
            this.Celular2Act = new UDTSQL_char(15);
            this.CorreoAct = new UDTSQL_char(60);
        }
...
//////
        ...
        [DataMember]
        public UDT_DescripTBase DireccionAct { get; set; }

        [DataMember]
        public UDT_BasicID CiudadAct { get; set; }

        [DataMember]
        public UDT_Descriptivo CiudadActDesc { get; set; }
        [DataMember]
        public UDTSQL_char Telefono1Act { get; set; }

        [DataMember]
        public UDTSQL_char Telefono2Act { get; set; }

        [DataMember]
        public UDTSQL_char Celular1Act { get; set; }

        [DataMember]
        public UDTSQL_char Celular2Act { get; set; }

        [DataMember]
        public UDTSQL_char CorreoAct { get; set; }
