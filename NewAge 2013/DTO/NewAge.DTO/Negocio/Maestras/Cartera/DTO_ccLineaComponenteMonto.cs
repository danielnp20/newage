...
namespace NewAge.DTO.Negocio
{
    /// <summary>
    /// Class Error:
    /// Models DTO_ccLineaComponenteMonto
    /// </summary>
    [DataContract]
    [Serializable]
    public class DTO_ccLineaComponenteMonto : DTO_MasterComplex
    {
        #region DTO_ccLineaComponenteMonto
        /// <summary>
        /// Constuye el DTO a partir de un resultado de base de datos
        /// </summary>
        /// <param name="?"></param>
        public DTO_ccLineaComponenteMonto(IDataReader dr, DTO_aplMaestraPropiedades mp, bool isReplica)
            : base(dr, mp)
        {
            InitCols();
            try
        ...
        /// </summary>
        public DTO_ccLineaComponenteMonto()
            : base()
        {
            InitCols();
        }
        ...
        public DTO_ccLineaComponenteMonto(DTO_MasterComplex basic)
            : base(basic)
        {
            InitCols();
        }

        public DTO_ccLineaComponenteMonto(DTO_aplMaestraPropiedades masterProperties)
