...
namespace NewAge.DTO.Negocio
{
    ...
    public class DTO_ccPagaduria : DTO_MasterBasic
    {
            ...
            : base(dr, mp)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(dr["IncorporacionPorc"].ToString()))
                    this.IncorporacionPorc.Value = Convert.ToDecimal(dr["IncorporacionPorc"]);
                ...
                if (!string.IsNullOrEmpty(dr["PeriodoNomina"].ToString()))
                    this.PeriodoNomina.Value = Convert.ToDateTime(dr["PeriodoNomina"]);
                if (!string.IsNullOrEmpty(dr["DiaNovedadIniM"].ToString()))
                    this.DiaNovedadIniM.Value = Convert.ToByte(dr["DiaNovedadIniM"]);
                if (!string.IsNullOrEmpty(dr["DiaNovedadFinM"].ToString()))
                    this.DiaNovedadFinM.Value = Convert.ToByte(dr["DiaNovedadFinM"]);
                if (!string.IsNullOrEmpty(dr["DiaNovedadIniQ"].ToString()))
                    this.DiaNovedadIniQ.Value = Convert.ToByte(dr["DiaNovedadIniQ"]);
                if (!string.IsNullOrEmpty(dr["DiaNovedadFinQ"].ToString()))
                    this.DiaNovedadFinQ.Value = Convert.ToByte(dr["DiaNovedadFinQ"]);
                if (!string.IsNullOrEmpty(dr["DiaRecaudoM"].ToString()))
                    this.DiaRecaudoM.Value = Convert.ToByte(dr["DiaRecaudoM"]);
                if (!string.IsNullOrEmpty(dr["DiaRecaudoQ"].ToString()))
                    this.DiaRecaudoQ.Value = Convert.ToByte(dr["DiaRecaudoQ"]);
            }
            catch (Exception e)
            {
                throw e;
        ...
        private void InitCols()
        {
            ...
            this.PeriodoNomina = new UDTSQL_smalldatetime();
            this.DiaNovedadIniM = new UDTSQL_tinyint();
            this.DiaNovedadFinM = new UDTSQL_tinyint();
            this.DiaNovedadIniQ = new UDTSQL_tinyint();
            this.DiaNovedadFinQ = new UDTSQL_tinyint();
            this.DiaRecaudoM = new UDTSQL_tinyint();
            this.DiaRecaudoQ = new UDTSQL_tinyint();
        ...
        [DataMember]
        public UDTSQL_smalldatetime PeriodoNomina { get; set; }

        [DataMember]
        public UDTSQL_tinyint DiaNovedadIniM { get; set; }

        [DataMember]
        public UDTSQL_tinyint DiaNovedadFinM { get; set; }

        [DataMember]
        public UDTSQL_tinyint DiaNovedadIniQ { get; set; }

        [DataMember]
        public UDTSQL_tinyint DiaNovedadFinQ { get; set; }

        [DataMember]
        public UDTSQL_tinyint DiaRecaudoM { get; set; }

        [DataMember]
        public UDTSQL_tinyint DiaRecaudoQ { get; set; }
    }
}
