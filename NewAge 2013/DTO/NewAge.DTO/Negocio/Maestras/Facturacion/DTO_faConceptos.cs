...
namespace NewAge.DTO.Negocio
{
    ...
    public class DTO_faConceptos : DTO_MasterBasic
    {
            ...
            : base(dr, mp)
        {
            ...
            try
            {
                if (!isReplica)
                {
                    ...
                    this.CuentaAIUDesc.Value = dr["CuentaAIUDesc"].ToString();
                ...
                this.CuentaAIU.Value = dr["CuentaAIU"].ToString();
        ...
        private void InitCols()
        {
            ...
            this.CuentaAIU = new UDT_BasicID();
            this.CuentaAIUDesc = new UDT_Descriptivo();
        ...
        [DataMember]
        public UDT_BasicID CuentaAIU { get; set; }

        [DataMember]
        public UDT_Descriptivo CuentaAIUDesc { get; set; }
