...
namespace NewAge.DTO.Negocio
{
    /// <summary>
    /// Class Error:
    /// Models DTO_rhPruebasxCargo
    /// </summary>
    [DataContract]
    [Serializable]
    public class DTO_rhPruebasxCargo : DTO_MasterComplex
    {
        #region DTO_rhPruebasxCargo
        /// <summary>
        /// Constuye el DTO a partir de un resultado de base de datos
        /// </summary>
        /// <param name="?"></param>
        public DTO_rhPruebasxCargo(IDataReader dr, DTO_aplMaestraPropiedades mp, bool isReplica)
            : base(dr, mp)
        {
            InitCols();
            try
        ...
        /// </summary>
        public DTO_rhPruebasxCargo() : base()
        {
            InitCols();
        }
        ...
        public DTO_rhPruebasxCargo(DTO_MasterComplex comp) : base(comp)
        {
            InitCols();
        }

        public DTO_rhPruebasxCargo(DTO_aplMaestraPropiedades masterProperties)
