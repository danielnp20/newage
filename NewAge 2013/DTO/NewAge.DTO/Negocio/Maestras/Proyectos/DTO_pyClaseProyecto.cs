    ...
    public class DTO_pyClaseProyecto : DTO_MasterBasic
    {
            ...
            : base(dr, mp)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(dr["CalcularValorClienteInd"].ToString()))
                    this.CalcularValorClienteInd.Value = Convert.ToBoolean(dr["CalcularValorClienteInd"]);
            }
            catch (Exception e)
            {
        ...
        private void InitCols()
        {
            ...
            this.CalcularValorClienteInd = new UDT_SiNo();
        }
        ...
        [DataMember]
        public UDT_SiNo CalcularValorClienteInd { get; set; }
    }
