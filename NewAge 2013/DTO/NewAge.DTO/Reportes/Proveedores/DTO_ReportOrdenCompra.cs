    ...
    public class DTO_ReportOrdenCompra
    {
        ...
        public DTO_ReportOrdenCompra(IDataReader dr, bool isDetallado)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(dr["Solicitud"].ToString()))
                    this.Solicitud.Value = dr["Solicitud"].ToString();                
        ...
        private void InitCols()
        {
            ...
            this.Solicitud = new UDTSQL_char(20);
        ...
        [DataMember]
        public UDTSQL_char Solicitud { get; set; }
