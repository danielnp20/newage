...
namespace NewAge.DTO.Reportes
{
    ...
    public class DTO_ReportProveedoresRecibidos
    {
        ...
        private void InitCols()
        {
            ...
            this.Proveedor = new UDTSQL_char(150);
            this.CantidadRec = new UDT_Cantidad();
            this.BodegaDesc = new UDTSQL_char(150);
            this.Elaboro = new UDT_Descriptivo();
            this.Aprobo = new UDT_Descriptivo();
            this.PrefDocInventario = new UDTSQL_char(30);
            ...
            this.Proyecto = new UDT_DescripTExt();
        ...
        [DataMember]
        public UDTSQL_char BodegaDesc { get; set; }
        ...
        [DataMember]
        public UDTSQL_char PrefDocInventario { get; set; }
        ...
        [DataMember]
        public UDT_DescripTExt Proyecto { get; set; }
