    ...
    public class DTO_ReportPagoFactura
    {
        ...
        public DTO_ReportPagoFactura(IDataReader dr)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(dr["TerceroNombre"].ToString()))
                    this.TerceroNombre.Value = dr["TerceroNombre"].ToString();
        ...
        private void InitCols()
        {
            ...
            this.TerceroNombre = new UDT_DescripTBase();            
        ...
        [DataMember]
        public UDT_DescripTBase TerceroNombre { get; set; }
